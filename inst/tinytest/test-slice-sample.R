...
# rejection sampling of a truncated normal from a uniform envelope
...
# that recovery needs the mode, which an explicit width never computes
expect_error(
  dbarts:::sliceSample(
...
# an envelope that never dominates exhausts maxIter
expect_error(
  dbarts:::rejectionSample(
