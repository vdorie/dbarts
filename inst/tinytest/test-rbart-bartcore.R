...
fit <- dbarts::rbart_vi(
  y ~ x, group.by = g,
  n.samples = 6L, n.burn = 4L, n.thin = 1L, n.chains = 2L,
  n.trees = 5L, n.threads = 1L, keepTrees = TRUE,
...
fit.custom <- dbarts::rbart_vi(
  ...
  n.samples = 3L, n.burn = 0L, n.thin = 1L, n.chains = 2L,
