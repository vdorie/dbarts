...
expect_error(sampler$setTestOffset(rep(0.1, n)),
...
expect_error(dbarts:::bartcoreSetTestOffset(bc, rep(0.1, 5L)),
...
expect_error(
  sampler$setControl(dbartsControl(n.chains = 2L, n.threads = 1L,
                                   n.trees = 10L, updateState = FALSE)),
  pattern = "cannot change 'n.chains'")
expect_error(
  sampler$setControl(dbartsControl(n.chains = 1L, n.threads = 1L,
                                   n.trees = 20L, updateState = FALSE)),
  pattern = "cannot change 'n.trees'")
expect_error(
  sampler$setControl(dbartsControl(n.chains = 1L, n.threads = 1L,
                                   n.trees = 10L, useQuantiles = TRUE,
                                   updateState = FALSE)),
