...
expect_equal(
  bartFit$sigma,
  c(
    1.23724513909869, 1.14277060463474, 1.14262103884284,
    1.12976218154258, 1.12824224176549
  )
)
expect_equal(
  bartFit$yhat.train[n.sims,1L:5L],
  c(
    0.165454366580265, 0.165454366580265, 0.165454366580265,
    0.165454366580265, 0.165454366580265
  )
)
