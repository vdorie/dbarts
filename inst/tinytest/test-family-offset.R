...
sampler <- dbarts(z.logit ~ x, family = "logistic", offset = o,
                  control = control)
...
sampler.probit <- dbarts(z.probit ~ x, family = "probit", offset = o,
                         control = control)
...
rm(sampler, sampler.probit, samples, samples.up, samples.dn, samples.probit,
   samples.probit.up, p.hat, p.hat.up, p.hat.dn, p.hat.probit, latents,
   control, x, f, o, z.logit, z.probit, n)
