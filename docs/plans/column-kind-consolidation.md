...
`cscDensified` ([src/bartcore/data.hpp:246-259](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L246-L259)), so the renaming that section
...
`ORDINAL_VARIABLE` ([R/utility.R:510-514](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L510-L514)), which is `0L`
([R/data.R:1](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/data.R#L1)), the same value a numeric column gets ([R/utility.R:530-532](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L530-L532)).
...
rather than categories" ([src/R_interface_bartcore.cpp:903-905](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L903-L905)). The engine's
`ColumnType` has two values ([src/bartcore/data.hpp:93](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/data.hpp#L93)), so nothing below the
...
([R/A_class.R:500-505](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/A_class.R#L500-L505)), whose comment gives the reason verbatim: "0/1/2 codes
are indistinguishable from integer data".

The splitting *mechanic* is deliberate and correct -
[docs/design/public-surface.md:123-126](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/public-surface.md#L123-L126) rules that ordered factors ingest as
...
missing marker costs is four concrete things:
  ...
  - *A silent data defect.* An ordered factor's grid is built by
    `fillCutsUniformly` -> `fillCutsOverRange` ([src/bartcore/data.hpp:987-1005](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L987-L1005)) with
    `numCuts[j] = maxNumCuts[j]` ([src/bartcore/data.hpp:1100](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1100)), over the observed range
    `[0, K-1]`. That cap is `n.cuts`, default `100L`
    ([R/A_class.R:258](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/A_class.R#L258), [R/data.R:15](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/data.R#L15)), recycled per column with no
    cardinality clamp ([R/data.R:38](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/data.R#L38), [R/dbarts.R:684](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/dbarts.R#L684)), passed through
    `options.maxNumCutsPerVariable` ([src/R_interface_bartcore.cpp:1832](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1832)) into
    `maxNumCuts` ([src/bartcore/data.hpp:1417-1419](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1417-L1419)) and reduced only by the
    representability cap ([src/bartcore/data.hpp:1248-1250](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1248-L1250)). Codes come from `lower_bound` over
    those cuts ([src/bartcore/data.hpp:882-885](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L882-L885)). With K distinct level codes and only
    ...
    the cap ([R/utility.R:540-558](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L540-L558)); the ordered one does not, because the cap
  ...
  - *A split-prior distortion, not merely wasted work.* Below that threshold
    ...
    `scanOrdinalCuts` scores every candidate ([src/bartcore/scan.hpp:89-98](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/scan.hpp#L89-L98)),
    ...
    range ([src/bartcore/grow.hpp:270](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L270), [src/bartcore/grow.hpp:283-296](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L283-L296)). Each distinct partition
  ...
  - *No test-side level check.* `validateCategoricalPredictors` gates on
    `columnTypes[j] != categorical` ([src/R_interface_bartcore.cpp:1761](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1761),
    [src/R_interface_bartcore.cpp:1728](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1728)), and `validateTestContainerAgainstStore` on
    `store.types[j] != categorical` ([src/R_interface_bartcore.cpp:3028](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L3028)), so an ordered-factor test column
  ...
  - *Degraded reporting.* `decodeCategoricalSplits` maps split values back to
    level names only for categorical columns ([R/plotTree.R:7-25](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/plotTree.R#L7-L25)), which it
    selects via `which(varTypes == CATEGORICAL_VARIABLE)` ([R/plotTree.R:10](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/plotTree.R#L10), [R/plotTree.R:25](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/plotTree.R#L25)). A
...
([src/bartcore/data.hpp:508-510](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L508-L510), field at [src/bartcore/data.hpp:538](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L538), written at [src/bartcore/data.hpp:872](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L872)). There are exactly 62
`numCuts[...]` references in `src/bartcore/*.hpp` and
`src/R_interface_bartcore.cpp`; TWENTY-SEVEN of them read it as a category
count: [src/bartcore/data.hpp:555](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/data.hpp#L555), [src/bartcore/data.hpp:710](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/data.hpp#L710), [src/bartcore/data.hpp:723](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/data.hpp#L723), [src/bartcore/data.hpp:1466](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/data.hpp#L1466); [src/bartcore/tree.hpp:320](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L320), [src/bartcore/tree.hpp:330](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L330),
[src/bartcore/tree.hpp:445](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L445), [src/bartcore/tree.hpp:473](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L473), [src/bartcore/tree.hpp:503](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L503), [src/bartcore/tree.hpp:650](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L650), [src/bartcore/tree.hpp:1178](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L1178), [src/bartcore/tree.hpp:1181](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L1181), [src/bartcore/tree.hpp:1475](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L1475), [src/bartcore/tree.hpp:1536](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L1536), [src/bartcore/tree.hpp:1561](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L1561),
[src/bartcore/tree.hpp:1611](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L1611), [src/bartcore/tree.hpp:2069](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L2069), [src/bartcore/tree.hpp:2083](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L2083), [src/bartcore/tree.hpp:2148](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/tree.hpp#L2148); [src/bartcore/scan.hpp:303](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/scan.hpp#L303), [src/bartcore/scan.hpp:304](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/scan.hpp#L304);
[src/R_interface_bartcore.cpp:1521](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L1521), [src/R_interface_bartcore.cpp:3029](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L3029), [src/R_interface_bartcore.cpp:5483](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L5483), [src/R_interface_bartcore.cpp:5663](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L5663), [src/R_interface_bartcore.cpp:7620](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L7620), [src/R_interface_bartcore.cpp:7624](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L7624),
plus the WRITE at [src/bartcore/data.hpp:872](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L872) and one test-side read,
[tests/cpp/test_grow.cpp:860](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/tests/cpp/test_grow.cpp#L860), which sizes a category histogram from it and
so must move with them. (An earlier draft of this list named [src/bartcore/moves.hpp:404](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/moves.hpp#L404),
[src/bartcore/moves.hpp:708](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/moves.hpp#L708), [src/bartcore/model.hpp:2158](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L2158), [src/bartcore/model.hpp:2349](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L2349), [src/bartcore/grow.hpp:84](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L84) and [src/bartcore/grow.hpp:230](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L230); those lines hold
...
attention: [src/bartcore/scan.hpp:303-304](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/scan.hpp#L303-L304) sizes the categorical scan's histogram and is on
the **hot path**, [src/bartcore/data.hpp:1466](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/bartcore/data.hpp#L1466) is inside `buildFromParent`, which section 1
returns to, and [src/R_interface_bartcore.cpp:1521](https://github.com/vdorie/dbarts/blob/2da4f1017c2922749338664eca8d637fa10d844b/src/R_interface_bartcore.cpp#L1521) is the verbose printer's
...
unchecked `static_cast<xint_t>(value)` for a categorical ([src/bartcore/data.hpp:828-831](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L828-L831)),
and the flat replay reads the raw double and casts it to a category index
([src/bartcore/tree.hpp:1768-1769](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1768-L1769) pooled, [src/bartcore/tree.hpp:1783-1784](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1783-L1784) inline). The bridge widens R's
`INTEGER` factor codes to doubles a cell at a time
([src/R_interface_bartcore.cpp:553-565](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L553-L565)) so that the engine can narrow them back.

**4. `FlatKind` duplicates type-plus-pooled** ([src/bartcore/tree.hpp:171-176](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L171-L176)), and both
`buildFromFlatBelow` ([src/bartcore/tree.hpp:1530-1574](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1530-L1574)) and `flatSubtreeIsWellFormed`
([src/bartcore/tree.hpp:2065-2088](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L2065-L2088)) re-derive the same thing from the store and refuse a
...
takes SEXPs ([inst/include/dbarts/dbarts.h:523](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/include/dbarts/dbarts.h#L523); the header states
"control/model/data/state cross as SEXP" at [inst/include/dbarts/dbarts.h:199-200](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/include/dbarts/dbarts.h#L199-L200)) and forwards to the
same `bartcore_bridge::createHolder` the R entry uses
([src/C_interface.cpp:598](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L598)), so it inherits `validateCategoricalPredictors`
...
`validateColumnValues` ([src/C_interface.cpp:810-812](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L810-L812), [src/C_interface.cpp:843-845](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L843-L845), the function defined at
[src/R_interface_bartcore.cpp:3163](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L3163)); `setTestPredictors` and `predict` go
through `validateTestSource` ([src/C_interface.cpp:324](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L324)); `setState`
re-quantizes only creation-validated values; the `getTrees` replay clamps
defensively ([src/bartcore/tree.hpp:1808-1815](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1808-L1815)); and `translateSource` bounds any declared
`categoryCounts` and `referenceCodes` ([src/C_interface.cpp:166-176](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L166-L176)). The residual
...
recorded-draw count, and nothing else ([src/bartcore/sampler.hpp:89-97](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L89-L97)); neither `types` nor
`numCuts` is ever written. [docs/design/data-store.md:465-467](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/data-store.md#L465-L467) states why:
...
data object first - R's `getPointer`/`setState` ([R/dbarts.R:1927-1948](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/dbarts.R#L1927-L1948),
[R/dbarts.R:1959-1973](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/dbarts.R#L1959-L1973)), the flat C `dbarts_sampler_setState` ([src/C_interface.cpp:1009](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L1009)),
and stan4bart's own re-creation (`~/Repositories/stan4bart/src/init.cpp` lines 373-376)
- so the kind rides `dbartsData@varTypes` ([R/A_class.R:487](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/A_class.R#L487)), an S4 slot R
...
splitting ([src/bartcore/tree.hpp:648-658](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L648-L658), [src/bartcore/tree.hpp:1573-1583](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1573-L1583), [src/bartcore/tree.hpp:2086-2088](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L2086-L2088);
[src/bartcore/grow.hpp:267-296](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L267-L296); [src/bartcore/sampler.hpp:903-909](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L903-L909), [src/bartcore/sampler.hpp:924-933](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L924-L933)).
...
consolidation already settled - [docs/design/data-store.md:482](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/data-store.md#L482) records
...
monotone directions ([src/bartcore/facade.hpp:775-778](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L775-L778)), leaf-covariate designation from a
predictor source ([src/bartcore/facade.hpp:832-836](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L832-L836)), and the same from a pre-built store
([src/bartcore/facade.hpp:872-873](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L872-L873)). Under `splitsBySubset(j)` all three keep an
**orderedFactor column admissible**, exactly as today. For monotonicity that is
right and already ruled: [docs/design/monotone.md:117-121](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/monotone.md#L117-L121) says in as many
...
`standardizationMomentsForColumn` ([src/bartcore/data.hpp:100-121](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L100-L121)), i.e. treated as
...
needs new logic. Three sites need more than a rename:
  ...
  - [src/bartcore/data.hpp:785](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L785) (`columnIsPooled`), which must read the category count to
    decide the mask tier.
  - [src/R_interface_bartcore.cpp:1671](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1671), [src/R_interface_bartcore.cpp:1677](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1677), the verbose printer's "Number of
    ...
    listing further down is already safe: [src/R_interface_bartcore.cpp:1684](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1684) skips categoricals before
    [src/R_interface_bartcore.cpp:1688](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1688) tests `numCuts[j] == 0`.) The printer needs a kind-aware line -
  ...
  - `ColumnStore::buildFromParent` ([src/bartcore/data.hpp:1972](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1972)), which copies
    ...
    [src/bartcore/data.hpp:789](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L789) reads the count to set the pooled tier, and the gather loop at
    [src/bartcore/data.hpp:2045-2053](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L2045-L2053) computes `missingCategoryCode(numCuts[j])` per column. A view
...
([src/bartcore/data.hpp:997](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L997)) at consecutive midpoints ([src/bartcore/data.hpp:992](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L992)). So
`buildCutsForColumn` ([src/bartcore/data.hpp:1192](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1192)) gains a third arm that runs the
...
`finishQuantileGrid` has a third arm ([src/bartcore/data.hpp:1014-1024](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1014-L1024)) that fires when
...
maxNumCuts[j] = numCutPoints;` ([src/bartcore/data.hpp:1295](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1295)). Raising the cap rather than
...
ceiling, which is the invariant `build`'s clamp ([src/bartcore/data.hpp:1564-1565](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1564-L1565))
...
dispatch on kind too.** Neither `refreshCutsForColumn` ([src/bartcore/data.hpp:1254](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1254)) nor
`cutsWouldRemainValid` ([src/bartcore/data.hpp:1271](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1271)) reads `maxNumCuts[j]` at all. Both branch on
...
reaches `fillCutsUniformly` ([src/bartcore/data.hpp:1087](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1087)) and replaces the midpoint grid with K-1
...
the serious one:
  ...
  - The cut *values* change - midpoints at `k + 0.5` become
    ...
    **exactly** (`cuts[k] != flat.value` refuses, [src/bartcore/tree.hpp:1578-1580](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1578-L1580)), so a
  ...
  - On a `useQuantiles = TRUE` store the other arm rebuilds from observed
    uniques ([src/bartcore/tree.hpp:927](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L927)), silently degrading a declared-level grid to an
...
the categorical arm's `categoricalValueIsValid` sweep ([src/bartcore/data.hpp:982](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L982)) - rather than
...
`maxNumCutsRepresentable = 0xFFFD` = 65533 ([src/bartcore/data.hpp:36](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L36), applied at
[src/bartcore/data.hpp:1564-1565](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1564-L1565)), so a grid of K-1 cuts is representable exactly while
...
factor's refusal above 65535 levels ([R/utility.R:540-558](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L540-L558)), which is where the
...
scratch ([src/bartcore/grow.hpp:276](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L276)), and an O(K) scoring tail per (node, variable) in
...
pooled masks cost `maskWordsForCount(K)` words per rule ([src/bartcore/data.hpp:70](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L70)) and
the category histogram is O(K) per node ([src/bartcore/scan.hpp:301-304](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/scan.hpp#L301-L304)) - so this does not
...
values only ([src/bartcore/data.hpp:992](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L992)). So a level that appears in the training data
...
([R/utility.R:567](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L567), filled for ordered factors too). That table does not reach
...
only on `numeric` ([src/R_interface_bartcore.cpp:1001](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1001)), so an ordered factor's
declared count is read same as a categorical one's.

That function has a **second** early-continue worth naming: [src/R_interface_bartcore.cpp:1002](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1002) skips any
...
*categorical* column ([R/utility.R:531-533](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L531-L533)) - but the flat C API and
...
declared count becomes the grid:
  ...
  - **Which channel wins for a hand-built CSC-backed ordered factor** that
    ...
    ([R/utility.R:531-533](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L531-L533)) - so for anything R produces the two are the same
...
With the cap treatment specified, three consequences follow:
  ...
  - **The prior-multiplicity tilt disappears.** Each distinct threshold gets
    exactly one index slot, so `logCut` ([src/bartcore/grow.hpp:270](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L270)) normalizes over the
  ...
  - **`n.cuts` no longer applies to an ordered factor** - it is overridden, not
    ...
    cut grid exists at all ([src/bartcore/data.hpp:1192](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1192)). A factor's grid is determined
    by its levels; a numeric column's by `n.cuts`.

**What this does to the "never cap" test invariant.**
[inst/tinytest/test-data-categorical.R:40-41](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/tinytest/test-data-categorical.R#L40-L41) carries the comment "ordered
factors are ordinal and never cap" over a 54-level ordered-factor case at
[inst/tinytest/test-data-categorical.R:47-51](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/tinytest/test-data-categorical.R#L47-L51). The **assertion survives**, but not for the arithmetic reason: it
...
check that would sit beside [R/utility.R:540-558](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L540-L558), and 54 levels is far below
...
([src/R_interface_bartcore.cpp:6960-6962](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L6960-L6962)), and both readers test emptiness against
the live store's type ([src/bartcore/sampler.hpp:912](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L912) in `setState`, [src/bartcore/sampler.hpp:995](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L995) in
...
carries its own cut vector and `setState` installs it ([src/bartcore/sampler.hpp:943-947](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L943-L947)),
so a state written under either grid restores onto its own cuts.

Therefore neither `stateFormatVersion` ([src/R_interface_bartcore.cpp:6706](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L6706)) nor
`minReadableStateFormatVersion` ([src/R_interface_bartcore.cpp:6715](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L6715)) moves.

The silent-misread hazard is real but applies to a different move. The registry
rule at [src/R_interface_bartcore.cpp:6687](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L6687), [src/R_interface_bartcore.cpp:6767](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L6767) (restated at
[docs/design/public-surface.md:169-188](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/public-surface.md#L169-L188)) says a *new named* block or top-level
...
vector for a categorical column and refuse at [src/bartcore/sampler.hpp:902](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L902), and a new
...
`bcf` -> `glue` bump was for ([docs/design/multiplier-combiner.md:44-48](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/multiplier-combiner.md#L44-L48)). So:
...
fallback. That would bump nothing either. [docs/design/data-ownership.md:235](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/data-ownership.md#L235)
...
makes the feature silently wrong rather than merely absent.
  ...
  - [R/data.R:1-2](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/data.R#L1-L2) gains a third constant.
  - [R/A_class.R:579-583](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/A_class.R#L579-L583) currently refuses any `varTypes` value that is not 0
    or 1; it must admit the third.
  - **[src/R_interface_bartcore.cpp:1208-1219](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1208-L1219) parses `varTypes` as "zero is
    ...
    **categorical** - subset splits over identity codes - which is the exact
    opposite of the settled ruling at [docs/design/public-surface.md:123-126](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/public-surface.md#L123-L126), and it is a
    silent draw change rather than an error. This is the single highest-risk
    edit in the proposal.
  - **[src/R_interface_bartcore.cpp:1220-1221](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1220-L1221) publishes the typing channel only
    ...
    channel is null, `build` falls back to all-ordinal ([src/bartcore/data.hpp:1408-1412](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1408-L1412)),
  ...
  - [inst/tinytest/test-data-categorical.R:25](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/tinytest/test-data-categorical.R#L25) asserts
    `varTypes == c(1L, 0L, 0L, 0L, 1L)` where the second column is the ordered
    factor `o` ([inst/tinytest/test-data-categorical.R:8-12](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/tinytest/test-data-categorical.R#L8-L12)); it becomes `c(1L, 2L, 0L, 0L, 1L)`.
...
distinguishes the two. (`factor.levels` is *nearly* a marker - [R/utility.R:567](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L567)
...
([inst/include/dbarts/dbarts.h:286-288](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/include/dbarts/dbarts.h#L286-L288)) is a list macro built for exactly this - its comment at
[inst/include/dbarts/dbarts.h:281-285](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/include/dbarts/dbarts.h#L281-L285) explains that enumerators are added to the list rather than the enum
...
[src/C_interface.cpp:158-163](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L158-L163), which rejects any `columnTypes[j]` that is neither
...
([src/C_interface.cpp:572](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L572), alongside the struct layouts at [src/C_interface.cpp:535-560](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/C_interface.cpp#L535-L560)), so the
...
state is:
  ...
  - **No double representation anywhere in the store.** The authoritative
    ...
    `test.codes` (`xint_t`, 2 bytes, [src/bartcore/data.hpp:22](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L22)). For a `categorical` column
    that code *is* the level index by construction, unconditionally: `codeFor`
    is the identity cast ([src/bartcore/data.hpp:968-978](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L968-L978)). For an `orderedFactor` column
    ...
    `lower_bound` ([src/bartcore/data.hpp:882-885](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L882-L885)) - and it degrades to a rank among
  ...
  - **`ColumnSource` carries a typed source, not a `double*`.** Today
    `denseRaw` is a bare `double*` ([src/bartcore/data.hpp:201-203](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L201-L203)). In the end state the
  ...
  - **`ownedDenseValues` shrinks to the real-valued columns.** Today it is a
    ...
    copied wholesale from the caller ([src/bartcore/data.hpp:854](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L854)), covering factor and
    ...
    ([src/bartcore/data.hpp:805](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L805)), which today owns every dense test column as doubles
  ...
  - **`rawColumn` / `rawTestColumn` return null for factor columns, by
    ...
    are the linear- and GP-leaf covariate gathers ([src/bartcore/model.hpp:1017](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1017), [src/bartcore/model.hpp:1039](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1039),
    [src/bartcore/model.hpp:1059](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1059), [src/bartcore/model.hpp:1384](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1384), [src/bartcore/model.hpp:1409](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1409), [src/bartcore/model.hpp:1423](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1423)), the view gather
    ([src/bartcore/data.hpp:1769](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1769)), and the designation validity check ([src/bartcore/facade.hpp:768-780](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L768-L780)) -
    and a categorical column is refused as a leaf covariate at the factory
    ([src/bartcore/facade.hpp:768-780](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L768-L780)). The one live question the grid fix
    ...
    covariate is - gathered into `gatheredRawValues` ([src/bartcore/data.hpp:832](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L832)) by
  ...
  - **`rawColumnForRequantize` returns null for factor columns.** Also already
    ...
    ([src/bartcore/sampler.hpp:943-947](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L943-L947)), `buildCutsForColumn` clears their cuts
    ([src/bartcore/data.hpp:1207-1209](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1207-L1209)), and `refreshCutsForColumn` returns immediately
    ([src/bartcore/data.hpp:1254](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1254)). Under the midpoint grid an `orderedFactor`'s cuts are a
  ...
  - **The double-typed ingestion paths gain code-typed arms**, and the arms are
    selected by kind, not by a nullness accident:
      * `build`'s per-column loop selects `const double* column` and hands it to
        both `buildCutsForColumn` and `quantizeColumn` ([src/bartcore/data.hpp:1610-1690](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1610-L1690)).
        This becomes a kind-dispatched pair.
      * `inferredCategoryCount` scans doubles for a max ([src/bartcore/data.hpp:1128](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1128));
        its code-typed sibling scans `int32_t` skipping `NA_INTEGER`.
      * `quantizeDenseObserved` takes `const double* raw` and detects
        missingness with `isNA` on a NaN ([src/bartcore/data.hpp:1306-1320](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1306-L1320)); its code-typed
        sibling narrows `int32_t` to `xint_t` and detects `NA_INTEGER`.
      * `buildCutsForColumn` ([src/bartcore/data.hpp:1192](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1192)) needs no double at all for a
        ...
        count.
      * `writeOwnedDenseColumn` / `writeOwnedDenseCell` ([src/bartcore/data.hpp:2092](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L2092), [src/bartcore/data.hpp:2100](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L2100)),
  ...
  - **CSC columns are the one place doubles survive for a factor.** A
    ...
    side *borrows* it ([src/bartcore/data.hpp:1482-1483](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1482-L1483)) rather than copying - the borrow is
    ...
    **owned** copies can be typed: `ownedTestCscValues`
    ([src/bartcore/data.hpp:819](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L819), [src/bartcore/data.hpp:1861-1899](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1861-L1899)) and the post-mutation
    `ownedCscValues` ([src/bartcore/data.hpp:865](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L865)) are the store's own buffers, and a factor
...
`partitionChildren` ([src/bartcore/tree.hpp:878](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L878)) reads `data.column(variable)`, a
`const xint_t*`, on every arm ([src/bartcore/tree.hpp:900](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L900), [src/bartcore/tree.hpp:925](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L925)) or the `SparseColumnData` rank
storage ([src/bartcore/tree.hpp:891](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L891), [src/bartcore/tree.hpp:912](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L912)); `scanOrdinalCuts` and the categorical histogram scan
read the same codes ([src/bartcore/scan.hpp:310](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/scan.hpp#L310)). Recorded test fits during `run` route by
the `test` code block ([src/bartcore/data.hpp:811](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L811)), also codes. So the doubles this section
...
([src/bartcore/tree.hpp:1734-1740](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1734-L1740)), and there are two implementations:
`DenseColumns`/`DenseColumnReader` for a plain block ([src/bartcore/tree.hpp:1734-1753](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1734-L1753)) and
...
pointer and a sparse rank lookup ([src/bartcore/data.hpp:594-607](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L594-L607), built at [src/bartcore/data.hpp:623-641](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L623-L641)). Its
...
conventions, and the distinction has to be explicit:
  ...
  1. **A caller's integer source** (what an int-backed `PredictorSource`
     ...
     ([src/bartcore/tree.hpp:1766](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1766), [src/bartcore/tree.hpp:1781](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1781), [src/bartcore/tree.hpp:1796](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1796)) and the categorical arms cast to an
     index ([src/bartcore/tree.hpp:1768-1769](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1768-L1769), [src/bartcore/tree.hpp:1783-1784](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1783-L1784)). No knowledge of the column is needed,
  ...
  2. **The store's own codes** use the reserved missing code, which is *not*
     ...
     `missingCategoryCode(numCuts[j])` ([src/bartcore/data.hpp:970](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L970)), which is `K` for a
     pooled column (K >= 64) and the fixed position `63` otherwise
     ([src/bartcore/data.hpp:75](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L75)). The inverse is therefore
     ...
     with 63 free, a pooled one has 0..K-1 with K free ([src/bartcore/data.hpp:47-51](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L47-L51)) - but
     it is not a cast.
...
today ([src/bartcore/data.hpp:805](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L805)) and points each column's `denseRaw` into that block
([src/bartcore/data.hpp:1874-1875](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1874-L1875)), then quantizes into `test.codes`. In the end state a factor test
...
(`build`'s unmapped arm packs code offsets and moves on, [src/bartcore/data.hpp:1697-1730](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1697-L1730));
a later re-quantize reads whatever matrix the caller supplies
(`rawColumnForRequantize`, [src/bartcore/data.hpp:909](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L909)). **This is the common
factor-data-frame path** ([src/R_interface_bartcore.cpp:1100-1180](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1100-L1180)), so the retained
...
`codeDenseColumn` ([src/R_interface_bartcore.cpp:564](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L564)). Per factor
...
routing ([src/bartcore/data.hpp:1782-1790](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1782-L1790), [src/bartcore/data.hpp:1579-1584](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1579-L1584)) and raw only for designated leaf
covariates ([src/bartcore/data.hpp:1543-1552](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1543-L1552)), which cannot be categorical. No change.
...
verification burden beyond recompiling:
  ...
  - `partitionChildren`, every arm ([src/bartcore/tree.hpp:878](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L878)): codes and rank
    storage only.
  - `scanOrdinalCuts` and the categorical histogram ([src/bartcore/scan.hpp:301-310](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/scan.hpp#L301-L310)): codes
    only. ([src/bartcore/scan.hpp:301-304](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/scan.hpp#L301-L304) reads the category count, so it changes *spelling*
    under section 1's `categoryCounts` field, not type.)
  - The leaf-covariate loads ([src/bartcore/model.hpp:1017](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1017), [src/bartcore/model.hpp:1039](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1039), [src/bartcore/model.hpp:1059](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1059), [src/bartcore/model.hpp:1384](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1384),
    [src/bartcore/model.hpp:1409](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1409), [src/bartcore/model.hpp:1423](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/model.hpp#L1423)): doubles, and never a factor column.
...
`PredictorSourceColumnReader::at` ([src/bartcore/data.hpp:594-607](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L594-L607)) is free - the reader is
...
four of these produce correct-looking output and wrong draws:
  ...
  1. **`hasMissing[j]` flipping.** `quantizeDenseObserved` sets `anyMissing`
     from `isNA(raw[i])` ([src/bartcore/data.hpp:1313](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1313)). A code-typed arm must set it from
     `raw[i] == NA_INTEGER`. If it does not, a column with missing values goes
     from flagged to unflagged, and the invariant at [src/bartcore/data.hpp:761-764](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L761-L764) is
  ...
  2. **The NA code itself.** `NA_INTEGER` is `INT_MIN`; narrowed without a
     ...
     `NA_REAL` produces today ([src/bartcore/data.hpp:970](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L970)).
  3. **`inferredCategoryCount` on the code path.** The double version skips NaN
     and takes a max ([src/bartcore/data.hpp:1128](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1128)). A signed int version skipping
     `NA_INTEGER` is correct; an unsigned one would let `INT_MIN` become a huge
     maximum and inflate K, which changes the mask tier
     (`maskWordsForCount`, [src/bartcore/data.hpp:70](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L70)) and therefore the rule encoding.
  4. **The CSC implicit-row rule.** A CSC categorical column's absent rows read
     the reference code ([src/bartcore/data.hpp:1363](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1363), mirrored in
     `materializePredictorSource` at [src/bartcore/data.hpp:505](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L505) and in the replay reader at
     [src/bartcore/data.hpp:615-621](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L615-L621)). Any typed variant must apply the same rule in all
...
`uint16_t` and `maxCategories` is `0xFFFF` ([src/bartcore/data.hpp:22](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L22), [src/bartcore/data.hpp:168](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L168)), so the store
...
precedent at [inst/include/dbarts/dbarts.h:343](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/include/dbarts/dbarts.h#L343), [inst/include/dbarts/dbarts.h:346](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/include/dbarts/dbarts.h#L346).
...
Seven slices. S0-S3 are section 1, 3 and the gate work; S4a-c are this section.
  ...
  - **S4a - the code channel, end to end through the bridge's validation.**
    ...
    ([src/R_interface_bartcore.cpp:1784](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1784)) returned a `const double*` off
    `view.denseValues`, and `trainingCategoryBound` ([src/R_interface_bartcore.cpp:1861](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1861)),
    `validateCategoricalPredictors` ([src/R_interface_bartcore.cpp:1891](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1891)) and
    `validateTestContainerAgainstStore` ([src/R_interface_bartcore.cpp:3229](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L3229)) all scanned through it -
    as does `materializePredictorSource` ([src/bartcore/data.hpp:505](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L505)) for the non-dense
...
### Risks, and the honest case against doing this now
  ...
  - **The retained saving is narrower than the headline.** The common
    ...
    today ([src/bartcore/data.hpp:1697-1730](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1697-L1730)). S4b's `-8n` applies to mixed and CSC
  ...
  - **S4b is a data-ownership rework, not a field addition.** It touches
    ...
    **Two exceptions where the failure is silent, and they are the two sites
    ...
    ([src/bartcore/data.hpp:2092](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L2092), [src/bartcore/data.hpp:2100](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L2100)) both open with a guard that returns quietly when the
  ...
  - **Where it meets the backlogged dispatch reshape.**
    [docs/design/data-layout.md:319-354](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/data-layout.md#L319-L354) names `partitionChildren`
    ([src/bartcore/tree.hpp:878](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L878)) as "the one shared touchpoint" of the layout and dispatch
    ...
    rank storage ([src/bartcore/tree.hpp:900](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L900), [src/bartcore/tree.hpp:912](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L912)) and never a double. The
    contact point is elsewhere - `PredictorSourceColumnReader`
    ([src/bartcore/data.hpp:594-607](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L594-L607)), where S4c adds a third arm and where a dispatch
...
[docs/design/data-store.md:435](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/data-store.md#L435) assigns it to the host: "You own container
assembly and the ingestion checks the engine cannot." `ColumnStore::build`'s
own comment restates it ([src/bartcore/data.hpp:1501-1506](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1501-L1506)), and
`codeFor` acts on that trust with a bare `static_cast<xint_t>(value)`
([src/bartcore/data.hpp:968-978](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L968-L978)). An out-of-range double-to-integer conversion is undefined
behavior in C++, and a code past K shifts past an inline mask
([src/bartcore/tree.hpp:153-155](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L153-L155)) or over-reads a pooled one - the replay path clamps
defensively ([src/bartcore/tree.hpp:1808-1815](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1808-L1815)) but `ColumnStore::codeAt` does not
([src/bartcore/data.hpp:2397](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L2397)).
...
([src/bartcore/data.hpp:1312](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1312), [src/bartcore/data.hpp:1347](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1347), [src/bartcore/data.hpp:1363](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1363), [src/bartcore/data.hpp:1375](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1375), [src/bartcore/data.hpp:1383](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1383); [src/bartcore/sampler.hpp:1887](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L1887)), all on
...
throw, and `Rf_error` longjmps past destructors ([src/bartcore/data.hpp:429-433](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L429-L433) documents
...
([src/bartcore/data.hpp:1160](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1160)); making it refuse a negative, non-integral or
unrepresentable value costs nothing extra. On the mutation side
`cutsWouldRemainValid` ([src/bartcore/data.hpp:1271](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1271)) already runs the correct per-cell
test via `categoricalValueIsValid` ([src/bartcore/data.hpp:982](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L982)) and is already called by
the mutation transaction ([src/bartcore/sampler.hpp:1838](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L1838)); the gap is that `build`,
...
([src/bartcore/sampler.hpp:945-955](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L945-L955)) and the mutation transaction depend on. Message quality
for R users does not change, because the bridge still fires first with its own
wording ([src/R_interface_bartcore.cpp:1838](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1838)) - but only for CODES. **The
...
K > 65534 refusal specified in section 1 sits beside [R/utility.R:540-558](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/R/utility.R#L540-L558),
...
([src/bartcore/data.hpp:1564-1565](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1564-L1565)) - a merge, which is the defect S2 removes. `build` must
...
Its declaration says why it exists ([src/bartcore/tree.hpp:169-170](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L169-L170)): "kept in flags so the
...
`FlatNode` and no `ColumnStore` ([src/bartcore/tree.hpp:1863](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1863)). Storeless replay is a
...
([src/bartcore/tree.hpp:1512](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L1512)) and `flatSubtreeIsWellFormed` ([src/bartcore/tree.hpp:2118](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L2118)) each
...
accepts hand-built states - [src/bartcore/sampler.hpp:1003-1013](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/sampler.hpp#L1003-L1013) shows the codebase already
...
([src/bartcore/tree.hpp:202-203](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L202-L203)), three of four values are used, and bits 3-7 are
...
([src/R_interface_bartcore.cpp:5650](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L5650)), so widening the tag inside the byte
would be additive and would not move the state version -
[docs/design/public-surface.md:154-156](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/public-surface.md#L154-L156) makes exactly that argument for the
MIA flags field.
...
`ColumnSourceKind::denseBorrowed` ([src/bartcore/data.hpp:201-203](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L201-L203)) names the case where
`denseRaw` points into the store's **own** `ownedDenseValues`: the block is
assigned by the store at [src/bartcore/data.hpp:854](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L854) and the descriptor is pointed at
it at [src/bartcore/data.hpp:1293-1296](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1293-L1296) (and at [src/bartcore/data.hpp:1431-1435](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1431-L1435) for the test side). The field comment
already concedes it - "denseBorrowed: the store's own dense column ... writable
so a mutation keeps the raw current" ([src/bartcore/data.hpp:201-203](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L201-L203)). `denseOwned`
([src/bartcore/data.hpp:152-154](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L152-L154)) names the opposite case, where the store owns nothing and
re-quantizes from whatever matrix the caller supplies
(`rawColumnForRequantize`, [src/bartcore/data.hpp:909](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L909)). Twenty-one references across
`src/`.
...
`rawColumnForRequantize` asks ([src/bartcore/data.hpp:909](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L909)) and exactly what
`hasRequantizeSource`/`acceptsNewRawPredictors` ([src/bartcore/data.hpp:893](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L893)/[src/bartcore/data.hpp:899](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L899)) are about. Neither
...
### Draw-preserving by construction
  ...
  - **S1**, the kind axis, *provided* the bridge's `varTypes` parse
    ([src/R_interface_bartcore.cpp:1208-1219](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1208-L1219)) is rewritten in the same commit as
...
column changes, `splitInterval`'s range changes ([src/bartcore/tree.hpp:429](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L429)),
`logCut = -log(right - left + 1)` changes ([src/bartcore/grow.hpp:270](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/grow.hpp#L270)), and
...
### The bill, and a gate that currently cannot see it
  ...
  - **`benchmarks/R/equivalence.R` did not move, and that was the problem.** Its
    factor cases were all built with plain `factor(...)` ([benchmarks/R/equivalence.R:185-186](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/benchmarks/R/equivalence.R#L185-L186), [benchmarks/R/equivalence.R:195-204](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/benchmarks/R/equivalence.R#L195-L204),
    [benchmarks/R/equivalence.R:871](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/benchmarks/R/equivalence.R#L871), [benchmarks/R/equivalence.R:899](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/benchmarks/R/equivalence.R#L899)); the only `ordered` occurrences were `ordered_result = TRUE`
    at [benchmarks/R/equivalence.R:351](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/benchmarks/R/equivalence.R#L351) and [benchmarks/R/equivalence.R:523](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/benchmarks/R/equivalence.R#L523), which is the *response*. There was no ordered-factor
  ...
  - **tinytest replay-regeneration - one file, not two.** The relevant question
    ...
    ([src/R_interface_bartcore.cpp:2080-2085](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L2080-L2085)), and the comment there states it
    outright - "sampling itself never advances R's stream" ([src/R_interface_bartcore.cpp:2060](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L2060)), with
    the run entry restating it at [src/R_interface_bartcore.cpp:4748](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L4748). The number of creation draws is one
    ...
    **invariant** to S2.
      * `inst/tinytest/test-data-categorical.R` **does** need replaying. Not for
        ...
        feeds the samplers at [src/R_interface_bartcore.cpp:165](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L165) and [src/R_interface_bartcore.cpp:193](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L193), so the fits asserted after
        `sampler$run(150L, 300L)` ([src/R_interface_bartcore.cpp:172](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L172)) and `sampler.keep$run(50L, 5L)`
        ([src/R_interface_bartcore.cpp:199](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L199)) change because the model changes. S1 separately changes the
        `varTypes` assertion at [src/R_interface_bartcore.cpp:25](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L25) to `c(1L, 2L, 0L, 0L, 1L)`, and S2's cap
        rule changes the comment at [src/R_interface_bartcore.cpp:40-41](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L40-L41) and wants two new cases beside the
        54-level one at [src/R_interface_bartcore.cpp:47-51](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L47-L51).
      * `inst/tinytest/test-sparse-factor.R` does **not**. Its ordered-factor
        block ([src/R_interface_bartcore.cpp:1043-1075](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1043-L1075)) runs `sampler.ord$run(50L, 1L)` but asserts only
        error patterns from `predict`/`setTestPredictor`, never a fit. The
        file's own comment at [src/R_interface_bartcore.cpp:1101-1103](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1101-L1103) - "a new `rnorm()` call here would
        ...
        regeneration for it.
      ([inst/tinytest/test-argument-surface.R:31](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/tinytest/test-argument-surface.R#L31) and [inst/tinytest/test-calibration-prior-draws.R:217](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/inst/tinytest/test-calibration-prior-draws.R#L217) use
...
read K, not "the cut count" - and [src/bartcore/scan.hpp:301-304](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/scan.hpp#L301-L304) sizes its histogram from
...
[docs/design/data-layout.md:319-354](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/data-layout.md#L319-L354) names `partitionChildren` ([src/bartcore/tree.hpp:878](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L878))
as the shared touchpoint of the layout and dispatch axes. **Nothing in this
proposal touches it** - it reads codes and rank storage only ([src/bartcore/tree.hpp:900](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L900),
[src/bartcore/tree.hpp:912](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/tree.hpp#L912)). The contact point is the replay reader
(`PredictorSourceColumnReader`, [src/bartcore/data.hpp:594-607](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L594-L607)), where S4c adds a third arm;
...
2. **Ordered factors REMAIN ADMISSIBLE as leaf covariates and as monotone
   ...
   [src/bartcore/facade.hpp:788-797](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L788-L797), [src/bartcore/facade.hpp:768-780](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/facade.hpp#L768-L780) already do; the ruling makes
   ...
   in favour ([docs/design/monotone.md:117-121](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/docs/design/monotone.md#L117-L121)). Consequence for section 2:
   ...
   - gathered into `gatheredRawValues` ([src/bartcore/data.hpp:832](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L832)) by designation - not
...
4. **Grid levels: DECLARED.** DECIDED (2026-09-01, at orchestrator discretion
   ...
   `readDeclaredCategoryCounts` ([src/R_interface_bartcore.cpp:994](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L994)) is extended
   past **both** of its gates - the type gate at [src/R_interface_bartcore.cpp:1001](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1001) and the
   count-already-declared gate at [src/R_interface_bartcore.cpp:1002](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1002), so a CSC-backed ordered factor takes its
...
5. **Test-side level check: STRICT REFUSAL, matching categorical.** DECIDED
   ...
   ([src/R_interface_bartcore.cpp:1797-1800](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1797-L1800), gates at [src/R_interface_bartcore.cpp:1838](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1838), [src/R_interface_bartcore.cpp:1891](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1891), [src/R_interface_bartcore.cpp:3229](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L3229)).
...
6. **`numCuts` de-overload: YES.** DECIDED (2026-09-01, at orchestrator
   ...
   `buildFromParent` ([src/bartcore/data.hpp:1972](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/bartcore/data.hpp#L1972)), and the verbose printer's "Number
   of cutoffs" line ([src/R_interface_bartcore.cpp:1671](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1671), [src/R_interface_bartcore.cpp:1677](https://github.com/vdorie/dbarts/blob/3c81d6df3535092fc54e6d1c907297652c7f166e/src/R_interface_bartcore.cpp#L1677)) made kind-aware -
...
[src/bartcore/data.hpp:594-607](https://github.com/vdorie/dbarts/blob/5553802adfb3fb8492b12ff32bd511603feb4194/src/bartcore/data.hpp#L594-L607), built at [src/bartcore/data.hpp:623-641](https://github.com/vdorie/dbarts/blob/5553802adfb3fb8492b12ff32bd511603feb4194/src/bartcore/data.hpp#L623-L641) - the address the interaction
