...
Manifest of every `docs/plans/*.md` implementation plan (41 files; `README.md`
...
| file | STATUS | purpose |
|---|---|---|
| front-door-formals.md | S1 LANDED 2026-09-10 (1a6da4d8), S2 open | Sheds the seven `bart` scalars that mirror prior-object slots, moves `proposal.probs` onto `dbartsControl`, and gives `bart` and `xbart` a `control =` formal under a flat-wins precedence rule with fit-state controls refused. |
