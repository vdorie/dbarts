...
- No external reference implementation: BayesTree 0 hits in benchmarks/R, absent from Suggests. NUANCE the ledger
  ...
  one 25L override ([benchmarks/R/sbc.R:2175](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/benchmarks/R/sbc.R#L2175)).
...
- "rchk run once". Two campaigns on 08-19: on MAIN for the CRAN patch (48 [UP] -> zero real findings at cb290550,
  rc-review:731-745) and on bartcore (11 [UP] -> 69de27ac -> 8dbc0ce9 clean, [benchmarks/R/sbc.R:1138-1172](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/benchmarks/R/sbc.R#L1138-L1172)).
...
- A. THE FLAT C API HAS THE BRANCH'S STRONGEST GATE AND THE LEDGER HAS NO ROW FOR IT. [src/C_interface.cpp:461](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/C_interface.cpp#L461),[src/C_interface.cpp:465](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/C_interface.cpp#L465) are
  ...
  crossing structs - checked against DBARTS_C_API_HASH ([inst/include/dbarts/dbarts.h:142](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/inst/include/dbarts/dbarts.h#L142)), beside offsetof asserts at [inst/include/dbarts/dbarts.h:331](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/inst/include/dbarts/dbarts.h#L331). Any covered
...
- F. PROSE-ONLY GATES (a one-time agent run is not a gate), instrumentation confirmed absent from src/: (1) the
  ...
  [docs/plans/monotone-prior-draw.md:73-98](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/docs/plans/monotone-prior-draw.md#L73-L98), instrumentation "removed before landing" giving the P(cap exhausted)~2e-11 that
  justifies the 1e6 retry cap; (3) [docs/plans/setpredictor-leafof-rebuild.md:74-98](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/docs/plans/setpredictor-leafof-rebuild.md#L74-L98), an rdtsc + md5 probe absent from the tree;
...
- J. TESTS/CPP IS NOT "ANCHOR NONE" EITHER: [tests/cpp/main.cpp:1](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/tests/cpp/main.cpp#L1) declares testing "against independently coded reference math",
