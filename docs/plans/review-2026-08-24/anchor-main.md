...
([benchmarks/R/equivalence.R:1830-1841](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/benchmarks/R/equivalence.R#L1830-L1841); |z| > 4 = FAIL) plus the parameter-free disjoint-seed-range complement
([benchmarks/R/equivalence.R:1821-1829](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/benchmarks/R/equivalence.R#L1821-L1829)). Summaries per fit: per-observation posterior mean and sd of yhat.train/yhat.test,
...
- BINARY k HYPERPRIOR, the one non-obvious mapping: classic draws k^2 with shape 0.5*(M + 2*nu - 1)
  (main:[src/dbarts/parameterPrior.cpp:166](https://github.com/vdorie/dbarts/blob/edcdf735855ad331f785c3577f0305d7b2dc224f/src/dbarts/parameterPrior.cpp#L166)) where bartcore uses 0.5*(M + nu)
  ([src/bartcore/model.hpp:2521](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/model.hpp#L2521), the dropped-Jacobian fix bcdcc07/14bd6b52), and the rate term
...
correction ([docs/design/change-move-balance.md:18-77](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/docs/design/change-move-balance.md#L18-L77), [inst/NEWS.Rd:1154-1163](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/inst/NEWS.Rd#L1154-L1163); exact gate
benchmarks/R/change-balance.R, defect z +255 -> repair z -1.2,
[docs/plans/change-move-fix.md:200-207](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/docs/plans/change-move-fix.md#L200-L207)). The doc's bias factor, [p_var(v')/p_var(v)] *
...
(main:[src/dbarts/parameterPrior.cpp:109](https://github.com/vdorie/dbarts/blob/edcdf735855ad331f785c3577f0305d7b2dc224f/src/dbarts/parameterPrior.cpp#L109)) though zero-weight rows contribute nothing to the sum of
squares; 1.0-0 counts positive-weight rows only (cf99a00, [inst/NEWS.Rd:1164-1172](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/inst/NEWS.Rd#L1164-L1172)). With 80 of 400 weights
...
[docs/design/grouped-random-effects.md:212-219](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/docs/design/grouped-random-effects.md#L212-L219) ([inst/NEWS.Rd:521-537](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/inst/NEWS.Rd#L521-L537)). Reproduced with the right
...
([inst/NEWS.Rd:618-638](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/inst/NEWS.Rd#L618-L638)). 5-fold rmse over 20 reps: 0.9-34 1.5537 against 1.0-0 1.7170, i.e. 0.9-34 reports
...
1.2-1.7: the runaway inflates across-seed variance, the degeneracy [benchmarks/R/equivalence.R:1815-1820](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/benchmarks/R/equivalence.R#L1815-L1820) warns
about.
