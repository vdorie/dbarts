...
- **E1. `extract(fit, type="trees", sample=<numeric>)` silently returns a FILTERED
  tree table; `sample="train"/"test"` dies on an NA.** [R/generics.R:363-382](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L363-L382)
  (`extract.bart`) rewrites the call onto `object$fit$getTrees` and strips `object`
  ([R/generics.R:379](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L379)) and `type` ([R/generics.R:380](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L380)) but NOT `sample`; `getTrees`'s formals are
  `(treeNums, chainNums, sampleNums, ...)`, so R partial-matches `sample` ->
  `sampleNums`. [R/generics.R:1851-1866](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L1851-L1866) (`extract.rbart`) has the same rewrite.
  ...
  so the tree table is wrong output on a call [man/bart.Rd:258](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L258) describes ("extract
...
- **E2. [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174) claims all ten non-`bart` family tokens are refused BY
  ...
  the literal contents of `bartOwnClassFamilies` ([R/bart.R:2587-2592](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2587-L2592)).
  ...
  right; [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174)'s first sentence is the wrong one.
- **E3. `"twopart"` is the tenth token and is missing from BOTH the Rd's
  enumeration and `bartOwnClassFamilies`.** [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174) lists nine tokens across
  its three reason-groups; `twopart` appears in none. [R/bart.R:2587-2592](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2587-L2592) is
  ...
  two spellings being documented as the same family ([man/dbarts.Rd:111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L111),
  [man/bart2.Rd:237](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L237)). CONFIRMS F9. Fix: **agent-fix** (add `"twopart"` to
...
- **E4. `dbartsData()` mis-reports EVERY multi-column response with a factually
  false row-count message; four surfaces inherit it.** [R/data.R:1179-1181](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L1179-L1181) and
  [R/data.R:1238-1241](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L1238-L1241) compare `NROW(formula)` against `NROW(codeResponse(data)$y)`,
  ...
  **VD-judgement** (G-B) for whether the ingest should name a survival/matrix
  response - [man/rbart.Rd:95](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/rbart.Rd#L95) already says survival "enter[s] only through the
  formula interface", the shape of refusal the Rd implies.
- **E5. [man/bart.Rd:153](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L153) states the `combinechains = TRUE` result shape
  ...
  \value at [man/bart.Rd:277](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L277) and [man/bart2.Rd:164](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L164) state it correctly. Fix: **agent-fix**.
- **E6. [man/bart.Rd:165](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L165) transposes the `proposalprobs` defaults.** Rd lists
  ...
  [man/bart2.Rd:200](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L200) states. Fix: **agent-fix**.
- **E7. [man/dbartsSpec.Rd:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L40)'s "a family can never resolve two ways" is falsified,
  and [man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48) contradicts the function's own signature.** CONFIRMS F1.
  ...
  [man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48) calls `"multinomial"` unavailable because it describes "more than one
  sampler" - false (one K-forest sampler), and the token IS in dbartsSpec's
  vocabulary. [man/dbartsSpec.Rd:25](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L25) documents the counts route correctly.
  Fix: **agent-fix** - [man/dbartsSpec.Rd:25](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L25) is right; [man/dbartsSpec.Rd:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L40) and [man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48) are wrong.
- **E8. The per-category offset has three spellings and `dbarts()`'s own matrix
  ...
  [man/dbarts.Rd:103](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L103) says "the per-category shift is `offset.category`" without
...
- **E11. `n.samples = 0` gets three different answers across five entries.**
  ...
  [man/dbartsControl.Rd:33](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsControl.Rd#L33) (a per-`run()` return count) and [man/bart2.Rd:152](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L152) (a sweep
  budget) are both silent on zero. Fix: **VD-judgement** (G-E).
- **E12. `monotone` accepts three undocumented spellings and is case-folded.**
  [R/model.R:548-570](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L548-L570) (`parseMonotoneSign`) switches on `tolower(value)` and accepts
  `"inc"`, `"dec"`, `"0"`; its own refusal at [R/model.R:559-562](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L559-L562) enumerates only the
  ...
  [man/dbarts.Rd:72](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L72) and [man/bart2.Rd:203](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L203) document only `"+"`/`"increasing"`/1 and
...
- **E13. `dbartsDrawLatents()` refuses its own formal default when written out.**
  [R/augmentation.R:65](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/augmentation.R#L65) declares `sigma = 1`; [R/augmentation.R:79-81](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/augmentation.R#L79-L81) guards with
...
- **E14. `makeind(x, all=TRUE)` is a live formal that does nothing.**
  [R/bart.R:2833-2836](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2833-L2836) binds `all` to `ignored` and calls
  ...
  [man/makeind.Rd:26](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/makeind.Rd#L26) DOES document it, as "Not currently implemented" - inert but
...
- **E19. Two sibling R helpers 42 lines apart disagree on unknown-family policy.**
  [R/model.R:400-414](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L400-L414) `defaultNodeScale` has NO default arm, so
  `dbarts:::defaultNodeScale("hazard")` and `("student")` return **NULL** silently,
  while [R/model.R:442-453](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L442-L453) `defaultAmplitudePriorScale` `stop()`s by name. The C++
  mirror at [src/R_interface_bartcore.cpp:2291-2306](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2291-L2306) claims in comment to mirror the R
...
- **E20. The four C++ `default:` arms on a family switch - what each absorbs, and
  none is R-reachable.** [src/bartcore/chain.hpp:756](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L756) (K-forest ctor) -> `GaussianResponse`,
  absorbing aft/ordinal/nbinom and any 7th enumerator; [src/bartcore/chain.hpp:5026](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L5026)
  (`latentScaleAnchor`) -> `scaledResponseSd()`, deliberate for gaussian (comment
  says why), also absorbing aft/ordinal/nbinom; [src/R_interface_bartcore.cpp:2291](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2291)
  (`defaultNodeScale`) -> 0.5 (gaussian's), absorbing gaussian and aft;
  [src/R_interface_bartcore.cpp:2812](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2812) (`validateResponseSupport`) -> `default: break`,
  deliberate. All three K-forest arms sit behind `refusedAmplitudeFamilyReason`
  ([src/R_interface_bartcore.cpp:2266](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2266)), called from both creation routes ([src/R_interface_bartcore.cpp:2313](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2313), [src/R_interface_bartcore.cpp:3150](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L3150))
  and the factory ([src/bartcore/facade.hpp:809-826](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L809-L826)). The grid confirms by execution:
...
- **E21. `resolveFamily` vs `augmentationFamily` DO have disjoint vocabularies, but
  the gap is unreachable from R.** [src/R_interface_bartcore.cpp:1582](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L1582) takes
  `""`/gaussian/probit/logistic/ordinal/nbinom/aft; [src/R_interface_bartcore.cpp:6151](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L6151) takes
  probit/logistic/ordinal/aft/nbinom/student and refuses gaussian. CONFIRMS the
  memo. But [R/augmentation.R:7](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/augmentation.R#L7)'s `augFamilies` is byte-identical to
  ...
  Only the flat `dbarts_drawLatents` ([src/C_interface.cpp:1090](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/C_interface.cpp#L1090)) reaches the C++
...
- **E22. `defaultAmplitudePriorScale` has no multinomial arm - confirmed, inert.**
  It errors by name, but both call sites ([R/bartcore.R:777](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bartcore.R#L777), [R/model.R:1146](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L1146)) sit
...
- **G1, bare `match.arg` on a token outside the entry's vocabulary** - 70 cells
  ...
  on each entry, the shape `refuseBartOwnClassFamily` already has. [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174)
...
- **Options audit `makeind(all=)`: CONFIRMED inert, framing PARTLY REFUTED** -
  [man/makeind.Rd:26](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/makeind.Rd#L26) documents it as "Not currently implemented." **Monotone
...
- **Options audit `family="probit"` unspellable on bart()/rbart_vi(): CONFIRMED** -
  both give bare `match.arg`; feature-matrix [f1] and [man/rbart.Rd:95](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/rbart.Rd#L95) make the
...
- [man/bart2.Rd:306](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L306) "gaussian, probit, and logistic are the only families a term can
...
- [man/rbart.Rd:95](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/rbart.Rd#L95) survival "do not support `weights` or `subset` ... and enter only
...
- [man/dbartsSpec.Rd:25](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L25) counts data resolves to multinomial from `"auto"`, refused
  under any other family; [man/dbartsSpec.Rd:31](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L31) `survival=` is aft-only AND aft requires it (both by
  name); [man/dbartsSpec.Rd:43](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L43) the empty-string C-API dispatch set matches `resolveFamily`'s shape
  gates exactly; [man/dbartsSpec.Rd:56](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L56) `family` never `"auto"`. [man/dbartsData.Rd:24](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsData.Rd#L24)/[man/dbartsData.Rd:27](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsData.Rd#L27) counts
  needs >= 2 categories and offset.category is refused without counts - by name.
- [man/bart.Rd:114](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L114)/[man/dbarts.Rd:42](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L42) weight policy (probit refuses, logistic requires
  positive integer counts, unit counts accepted) holds on all four entries taking
  `weights`, across all 13 tokens. [man/bart2.Rd:188](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L188) `predict` requires `keepTrees` - by
  name on all seven families probed; [man/dbarts.Rd:103](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L103) flat `offset` refused for
