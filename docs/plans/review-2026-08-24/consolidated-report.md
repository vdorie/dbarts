...
- **B1. `extract(fit, type = "trees", ...)` corrupts its own call.** Asking for the trees of one posterior
  ...
  R's raw `unused argument`. EVIDENCE [R/generics.R:363-382](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L363-L382) rewrites `match.call()` onto
  `object$fit$getTrees` and strips only `object` ([R/generics.R:379](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L379)) and `type` ([R/generics.R:380](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L380)), so `sample` partial-matches
  `getTrees`'s `sampleNums` ([R/dbarts.R:1917](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L1917)); `extract.rbart` ([R/dbarts.R:1851-1866](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L1851-L1866)) repeats it. REPRO (3 trees, 5
  ...
  [man/bart.Rd:203-205](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L203-L205) and [man/bart.Rd:219](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L219). LEGS F3, E1, G2 (33 grid cells + 102 on the combineChains axis).
...
- **B2. `survivalProbabilities()` is dead on every hazard fit whose training predictors carry column
  names.** Hazard fits are matrix-interface only and [man/bart.Rd:75](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L75) says column names are honoured, so the
  named design is the normal spelling - and the broken one. EVIDENCE [R/bart.R:2421-2424](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2421-L2424) (training) and
  [R/bart.R:2432-2435](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2432-L2435) (matrix `newdata`) build `cbind(<named covariates>, rep(seq_len(K), each=n))`, leaving the
  ...
  [man/survivalProbabilities.Rd:45-47](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/survivalProbabilities.Rd#L45-L47),[man/survivalProbabilities.Rd:87-96](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/survivalProbabilities.Rd#L87-L96), [man/bart.Rd:328](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L328). WHY NO TEST: [inst/tinytest/test-hazard.R:12](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-hazard.R#L12)
...
- **B3-B7. Five reach gaps.** Each was re-planted by this pass, alone, in a staged copy; R-side mutations
  ...
  - B3 [R/dbarts.R:1025](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L1025) `$growFromRoot(n.sweeps)` can discard `n.sweeps` [mutation-A 1].
  - B4 [src/bartcore/combiner.hpp:906-913](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/combiner.hpp#L906-L913) the BCF near-zero multiplier snap can go [mutation-A 2, and mutation-B B5, the
    same site seen from the C++ side]. B5 [src/bartcore/combiner.hpp:1818-1825](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/combiner.hpp#L1818-L1825) the multinomial veto's active-row mask
  ...
  - B6 [src/bartcore/chain.hpp:1518](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L1518) the latent refresh's vector-leaf cache invalidation can go - R GREEN and C++
    SURVIVED (planted twice); every Linear/GP-leaf fixture in tests/cpp is gaussian so the branch is never
    entered, while [src/bartcore/facade.hpp:816](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L816) has no family gate and no tinytest pairs a vector leaf with a latent
    family [mutation-B 1].
  - B7 `facade.hpp` 5 of 7 forwarding defects survive ([src/bartcore/facade.hpp:429](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L429) `filledSavedDraws` -> `savedTreeCapacity`;
    [src/bartcore/facade.hpp:455](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L455) `setResponse(y,!updateScale)`; [src/bartcore/facade.hpp:515](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L515) `savedSlotForDraw` -> identity; [src/bartcore/facade.hpp:621](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L621) `setForestWeights`
    on forest 0 regardless; [src/bartcore/facade.hpp:520](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L520) `savedTree` on forest 0 regardless). Every other test drives `Sampler<L>`
...
- **M1. `dbartsData()` mis-reports EVERY multi-column response; four surfaces inherit it.**
  [R/data.R:1179-1181](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L1179-L1181),[R/data.R:1238-1241](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L1238-L1241) compare `NROW(formula)` against `NROW(codeResponse(data)$y)` and
  ...
  lines.
- **M2. `bart()`'s by-name family redirect covers 4 of 10 tokens; [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174) asserts all ten and
  ...
  ([R/bart.R:2587-2592](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2587-L2592)) is exactly those four and is checked against the RAW token before `bart2`'s alias
  fold, so `"hurdle.lognormal"` redirects and its documented alias `"twopart"` ([man/dbarts.Rd:111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L111),
  [man/bart2.Rd:237](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L237)) does not. LEGS F9, E2, E3, reading-R 3.3. CONFIRMED. AGENT-FIX for the `twopart` half (1
...
- **M3. `dbartsSpec()` and `dbarts()` resolve `family="multinomial"` differently for the same input; two
  ...
  [man/dbartsSpec.Rd:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L40) ("a family can never resolve two ways") is falsified; [man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48) calls `"multinomial"`
  unavailable as describing "more than one sampler" - false, and the token IS in its own vocabulary
  (verified: auto, gaussian, probit, logistic, aft, multinomial, ordinal, nbinom). [man/dbartsSpec.Rd:25](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L25) is right. LEGS F1,
  E7. CONFIRMED. AGENT-FIX (Rd).
- **M4. [man/bart.Rd:153](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L153) states the `combinechains=TRUE` shape backwards.** REPRO (2 chains x 6 draws x 60
  obs): TRUE -> `yhat.train` 12x60 (collapsed matrix), FALSE -> 2x6x60; identical on `bart()`. Its own
  `\value` at [man/bart.Rd:277](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L277) and [man/bart2.Rd:164](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L164) are correct. LEG E5. CONFIRMED. AGENT-FIX (Rd).
- **M5. [man/bart.Rd:165](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L165) transposes the `proposalprobs` defaults** ("birth_death, change, and swap ...
  ...
  [man/bart2.Rd:200](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L200) writes correctly. LEG E6. CONFIRMED. AGENT-FIX (Rd).
- **M6. `$n.chains` is absent from every fit that keeps a sampler, which [man/bart.Rd:315-317](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L315-L317) and
  [man/bart2.Rd:164](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L164) promise unconditionally.** [R/bart.R:390-394](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L390-L394): `if (keepSampler) result$fit <- fit else
...
- **M7. A saved `bartHurdle` fit cannot `predict` after reload and no Rd names the recipe.** REPRO:
  `names(fH)` is `call, family, y, occupancy, positive` - no `$fit` - so [man/bart.Rd:248](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L248)'s
  `bartFit$fit$storeState()` does not apply, and [man/bart.Rd:248](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L248) names only multinomial/ordinal/nbinom. After
  ...
  replay. LEG G9. CONFIRMED. AGENT-FIX (extend [man/bart.Rd:248](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L248)).
- **M8. [man/dbartsSampler-class.Rd:328](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L328) "Reading it forces the sampler's *current* state" is false, and the
  ...
  sampler`; with `storeState()` first it is ACCEPTED. The behavior follows the documented opt-in at [man/dbartsSampler-class.Rd:116](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L116);
  [man/dbartsSampler-class.Rd:328](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L328) is the wrong sentence. LEG G10. CONFIRMED. AGENT-FIX (Rd).
- **M9. `dbartsDrawLatents()` refuses its own formal default when written out.** REPRO:
  ...
  -> `'sigma' applies only to family "aft" and "student", not "probit"`. [R/augmentation.R:65](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/augmentation.R#L65) declares
  `sigma = 1`, [R/augmentation.R:79-81](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/augmentation.R#L79-L81) guards on `!missing(sigma)`. LEG E13. CONFIRMED. AGENT-FIX (default NULL, or guard
...
- **M11. Three engine divergences where one rule has two implementations that answer differently.** Verified
  by reading here, exactly as the engine leg states. [src/bartcore/sampler.hpp:891](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/sampler.hpp#L891) installs a LIVE-sourced donor's
  variance trees with NO positivity check where the slot-sourced arm at [src/bartcore/sampler.hpp:919-923](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/sampler.hpp#L919-L923) applies one and says why,
  and `rebuildVarianceForest` ([src/bartcore/chain.hpp:4356-4368](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L4356-L4368)) then scatters a non-positive leaf into a divisor
  (reachable from a `.Call` with a hand-built state). [src/bartcore/chain.hpp:2421](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L2421) (`recoverTreeParameters`) and [src/bartcore/chain.hpp:2453](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L2453)
  (`applyNewData`) hard-code `forests_[0]` where siblings at [src/bartcore/chain.hpp:2329](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L2329),[src/bartcore/chain.hpp:2401](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L2401),[src/bartcore/chain.hpp:2526](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L2526),[src/bartcore/chain.hpp:2540](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L2540) loop `forests_`, so a
  whole-data replacement on a BCF/multinomial chain leaves forests 1..K-1 on the old grid - guarded two
  layers away by `refuseMultiForestMutation`, no engine assert. [src/bartcore/combiner.hpp:986](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/combiner.hpp#L986) routes `drawGlue` on
  `shippedShape()` ([src/bartcore/combiner.hpp:1474](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/combiner.hpp#L1474)), which tests basis widths and canonicality but NOT the half-Cauchy flag; the
  shipped path refreshes only `prior[0].variance` ([src/bartcore/combiner.hpp:1171](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/combiner.hpp#L1171)) where the general path loops every forest with
  `halfCauchyScale > 0` ([src/bartcore/combiner.hpp:1213](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/combiner.hpp#L1213)), so two admissible specs get two different MODELS. LEGS reading-engine D2,
...
- **M12. Three shipped comments say a feature is "Not yet exposed through the R surface" when R reaches all
  three today.** VERIFIED: [src/bartcore/chain.hpp:88](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L88) (monotone) vs [R/model.R:99](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L99); [src/bartcore/chain.hpp:141-142](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L141-L142) (interaction
  constraints) vs [R/spec.R:111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/spec.R#L111); [src/bartcore/chain.hpp:166](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L166) (variance forest) vs [R/spec.R:113](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/spec.R#L113). LEG reading-engine C1
...
- **M13. Two CI gates are mis-wired so a green check means less than it looks, and five declared gates have
  ...
  stop at the merge to main; [.github/workflows/rchk.yaml:57-59](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/.github/workflows/rchk.yaml#L57-L59) fails only on a NON-EMPTY `grep -E '[PB]|[UP]' ... || true`,
  so an OOM-killed analyzer leaving no `.bcheck` is a GREEN job - the cure is already recorded at
  [docs/plans/release-candidate-review.md:1170](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/docs/plans/release-candidate-review.md#L1170); `lint.yaml` and `pkgdown.yaml` declare a BARE
...
- A4 [src/bartcore/model.hpp:3415](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/model.hpp#L3415) ordinal `updateCutpoints` freezes the last free cutpoint (at K=3, every free cutpoint)
  -> R GREEN, C++ KILLED (`ordinal gamma_2 posterior variance (actual 0, expected 0.1334)`).
  [inst/tinytest/test-ordinal.R:356](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-ordinal.R#L356)'s only gamma_2 assertion is a mean-within-0.35 band the frozen cold start sits
  inside. FIX `sd(cutpoints[,2]) > 0.02`.
- A5 [src/bartcore/grow.hpp:186](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/grow.hpp#L186) `growth <= 0.0` -> `< 0.0` kills the depth/availability veto -> R GREEN, C++ KILLED (`a
  growth-vetoed node draws nothing`). `test-grow-from-root.R` is 11 of 18 smoke.
- A6-A9 four R-side refusals/constants with no behavioral cover, all R GREEN: [R/data.R:1495](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L1495) precision
  threshold `1e-10` -> `1e-30` (both warn-cases have `diff(range(y))` EXACTLY 0, so the constant the file
  exists to defend is never exercised); [R/data.R:627](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L627) the `family="ordinal"` minimum-category refusal
  deleted; [R/xbart.R:608](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/xbart.R#L608) the mcr loss ignoring case weights (the rmse arm IS covered); [R/rbart.R:270](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/rbart.R#L270) the
  "survival (aft) fits do not support 'weights'" refusal deleted.
- A10-A12 three more, all R GREEN: [R/dbarts.R:1929](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L1929) `getTrees(current=TRUE)` ignored, reading the saved
  store, though `test-empty-leaf-veto-weights.R`'s entire structural oracle is `getTrees(current=TRUE)`;
  [R/generics.R:2364](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L2364) `print.bart` always printing family "gaussian", where [inst/tinytest/test-plot-generics.R:103-104](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-plot-generics.R#L103-L104)
  are `expect_true(is.character(capture.output(print(x))))`, which CANNOT FAIL; and (MINOR) [R/data.R:735](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L735)
  predict-path basis finiteness deleted.
- B3 [src/bartcore/chain.hpp:4207](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L4207) the variance forest binds `y + meanFits` for `y - meanFits` -> C++ SURVIVED (the only
  value-level variance assertion uses data with NO mean function). MAJOR not BLOCKER: tinytest backstops it.
- B4 [src/bartcore/sampler.hpp:575](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/sampler.hpp#L575) predict writes at the CAPACITY stride, reads at the draw count -> C++ SURVIVED;
...
- B5 [src/bartcore/moves.hpp:635](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/moves.hpp#L635) and [src/bartcore/moves.hpp:659](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/moves.hpp#L659), the descendant-interval and categorical-gauge rule-validity predicates ->
  C++ SURVIVED (both); neither has a direct caller in tests/cpp.
- B6 [src/bartcore/grow.hpp:222](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/grow.hpp#L222) `-log(numPredictors)` for `-log(numAvailable)` - identical at a root, wrong below it ->
  C++ SURVIVED; all three grow-from-root law tests measure ROOT rules only.
- B7 [src/bartcore/model.hpp:3314](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/model.hpp#L3314) the ordinal log-likelihood loses its lower tail -> C++ SURVIVED. This is the EXPORTED
  per-observation loglik channel of every ordinal fit.
- B8 [src/bartcore/model.hpp:2185](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/model.hpp#L2185) the `+ log 2` a missing-bearing ordinal column owes -> C++ SURVIVED; it cancels on a
  same-variable redraw, which is why the grow-side twin IS caught.
- B9 [src/bartcore/model.hpp:3603](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/model.hpp#L3603) `LogisticResponse::setWeights`' cold start of INACTIVE rows deleted -> C++ SURVIVED -
...
- **VD-E. Which fit classes carry which generics, and what does an absent one do?** DECIDES `plot` on
  ...
  loo/WAIC channel [man/bart.Rd:201](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L201) documents unscoped) [G8]; `extract(type="trees")` on a keepSampler-only fit
  (verified: an 11x4 frame of the CURRENT trees, no `sample` column, no warning, where [man/bart.Rd:257](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L257) scopes
  the feature to keepTrees while [man/plotTree.Rd:39-42](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/plotTree.Rd#L39-L42) documents exactly that fallback for plotTree) [G6]; and
...
- **VD-A. May every entry SPELL every family its siblings spell, and does a refusal echo the token TYPED or
  ...
  `bart(keepevery=-1)` refused as `n.thin`, an argument `bart()` lacks). [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174) asserts the
  redirects as done; `feature-matrix.md` [f1] says the opposite and the code follows the design doc.
  ALTERNATIVES (a) write the redirects on all four entries, ~40 R lines, and [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174) becomes true; (b)
  rewrite [man/bart.Rd:174](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L174) to match the design doc, 3 Rd lines, narrow vocabularies kept. RECOMMEND (a) for
...
- **VD-D. Do the own-class generics carry the bart-family argument vocabulary, or refuse it by name?**
  ...
  [man/bart2.Rd:38-49](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L38-L49) is silent, so nothing constrains the call.
...
- **VD-H. Deletions and seams.** DECIDES `R/bartcore.R`'s low-level handle API (31 functions, leg-counted;
  ...
  file is a COMMENT at [R/model.R:434](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L434), and `bartcorePredictPerForest` has none anywhere);
  `adoptPointer`/`reapplyForestWeights` (0 `man/` hits each); `dataSlotOrNULL` ([R/data.R:11-21](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L11-L21)), whose own
  comment claims every internal read of `counts`/`offset.category`/`offset.category.test` goes through it -
  verified FALSE (5 bare `@counts` reads elsewhere in `R/`, a bare `@offset.category` at [R/generics.R:992](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L992)) -
  ...
  S1, per-observation virtual dispatch at [src/bartcore/facade.hpp:694-703](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/facade.hpp#L694-L703) against [docs/design/core-generalization.md:69-76](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/docs/design/core-generalization.md#L69-L76)'s
...
- **VD-G. Should the four C++ `default:` arms on a `ResponseFamily` switch go, so a 7th enumerator is a
  compile error rather than a silent gaussian?** DECIDES [src/bartcore/chain.hpp:766](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L766) (K-forest ctor ->
  GaussianResponse), [src/bartcore/chain.hpp:5033](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L5033) (latentScaleAnchor -> scaledResponseSd),
  [src/R_interface_bartcore.cpp:2298](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2298) (defaultNodeScale -> 0.5), [src/R_interface_bartcore.cpp:2842](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2842) (validateResponseSupport -> NO
  validation), plus the open-coded chain at [src/R_interface_bartcore.cpp:6254](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L6254) - all five verified present. The mutation leg's
  7th-enumerator probe found exactly three sites warn today; [src/R_interface_bartcore.cpp:2842](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface_bartcore.cpp#L2842)'s own comment enumerates the harm it
  ...
  name ([src/bartcore/chain.hpp:862](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/chain.hpp#L862)).
- **VD-F. Undocumented option vocabularies: keep-and-document, or delete?** DECIDES `monotone`'s `"inc"`,
  ...
  [R/model.R:559-562](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L559-L562) enumerates only the documented set) [E12]; `makeind(x, all=)` (verified inert -
  `body(makeind)` is `ignored <- all; makeModelMatrixFromDataFrame(x, TRUE)` - but [man/makeind.Rd:26](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/makeind.Rd#L26) DOES
...
- V `extract(type="trees")` omits the `chain` column on a single-chain fit where [man/bart.Rd:262](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L262) lists it
...
- V `setForestBasis` on an amplitude-free sampler says `forest index out of range` where
  [man/dbartsSampler-class.Rd:189](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L189) promises the `setForestWeights` wording. [M4]
- V [man/dbartsSampler-class.Rd:308](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L308) offers "the return of `storeState`" to `setState`, but it returns NULL
...
- V `names(fit)` lists NULL-valued `yhat.test`, `s.train`, `s.test`, so `nm %in% names(fit)` misleads. [M10]
  [man/bart.Rd:248](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L248) understates which generics stop on a stateless fit. [M6]
- V `defaultNodeScale` has no default arm, so `dbarts:::defaultNodeScale("hazard")` and `("student")` return
  ...
  [E19]
- V `resolveFamily` and `augmentationFamily` really do have disjoint vocabularies, but [R/augmentation.R:7](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/augmentation.R#L7)
...
- Reading-cost classes, all DEFER, fully enumerated in their leg files: reading-R's 14 duplication clusters;
  ...
  [R/diagnostics.R:4](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/diagnostics.R#L4)'s non-existent `R/zzz.R`; and the support-lib residue D1, D7, U5, U6, U7 - only U7's
  doc line (`--with-xint-size`, at [docs/design/kernel-vocabulary.md:26](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/docs/design/kernel-vocabulary.md#L26), absent from [configure.ac:21](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/configure.ac#L21)) is AGENT-FIX.
...
- S2 Rd- and comment-only: M3 ([man/dbartsSpec.Rd:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L40),[man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48)), M4 ([man/bart.Rd:153](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L153)), M5 ([man/bart.Rd:165](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L165)), M7
  ([man/bart.Rd:248](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L248)), M8 ([man/dbartsSampler-class.Rd:328](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L328)), minors M4-gen/M5-gen/M7-gen, U7's
  [docs/design/kernel-vocabulary.md:26](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/docs/design/kernel-vocabulary.md#L26) line, and M12's three "Not yet exposed" comments. Sonnet. No draws.
...
- S6 GROWS by one line, M16: `test-sampler-state-emptyLeafVeto.R` either rescales its fixture until it
  separates or drops its regression claim and points at [tests/cpp/test_moves.cpp:1212-1218](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L1212-L1218), which this
...
- NOT RE-PLANTED: mutation-B's equivalent-mutant claim R1 ([src/bartcore/moves.hpp:280](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/moves.hpp#L280), the dead birth-rejection
...
- **B8. `fitted()` and `residuals()` on an `rbart` fit SEGFAULT the R session when the random-effect array
  has no dimnames.** [R/generics.R:2040-2046](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L2040-L2046) (`fitted.rbart`, `type = "ev"`) reads `ranefNames <-
  ...
  array`). STRONGER THAN THE LEG REPORTED: leg D reached it only by mutating [R/bart.R:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L40) and called it
...
- **VD-I. `predict`'s `n.threads`: wire it, or drop the formal and say so on `bart.Rd` too?** DECIDES
  ...
  `n.threads` occurs exactly ONCE in the R5 `predict` method ([R/dbarts.R:1079](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L1079)) - in its own formal list -
  and the body's only `.Call` is `.Call(C_dbarts_bartcore_predict, ptr, x.test, offset.test)` against
  `DEF_FUNC("dbarts_bartcore_predict", bartcore_predict, 3)` ([src/R_interface.cpp:224](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/R_interface.cpp#L224)). `predict.bart`
  coerces `as.integer(n.threads)[1L]` ([R/generics.R:294](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L294)) and hands it to that method, which discards it.
  ...
  [man/dbartsSampler-class.Rd:152-157](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L152-L157) ALREADY discloses it - "Currently has no effect: `run` and `predict`
  both execute serially regardless of the value passed here ... reserved for a future per-call override."
  That Rd is honest and AGREES with the code. `man/bart.Rd` is the one that does not: [man/dbartsSampler-class.Rd:49](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L49) puts `n.threads`
  in `predict.bart`'s `\usage` while its only `\arguments` item, the shared `nthread, n.threads` at
  [man/dbartsSampler-class.Rd:149-151](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L149-L151), describes a live thread count ("Integer specifying how many threads to use") written for the
  ...
  [man/dbartsSampler-class.Rd:152-157](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L152-L157)'s disclosure into `bart.Rd`'s item, and make the coercion refuse a
...
- **CONFIRMED whole-suite, MAJOR stands (the planted defect survives all 167 files).**
  - **M14. `plot.pdbart` can render only the FIRST requested predictor.** [R/plot.R:219](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/plot.R#L219)'s `for (i in xind)`
    narrowed to `xind[1L]` -> SURVIVED. [inst/tinytest/test-pdbart.R:88-90](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-pdbart.R#L88-L90) states the claim in a comment ("the plot
  ...
  - **M15. The 3+-level factor refusal in the single-forest entries can be deleted.** [R/data.R:536-548](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L536-L548) ->
    SURVIVED. [inst/tinytest/test-factor-response.R:85-103](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-factor-response.R#L85-L103) is the file that exists to hold it - five `expect_error`s
    naming "multinomial" - and every one still passes, because the SECOND `stop()` at [R/data.R:549](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/data.R#L549) (the
  ...
  - **M16. `test-sampler-state-emptyLeafVeto.R` is not the regression its header says it is.** Line 10 reads
    "Regression for the -1e7 -> -HUGE_VAL fix."; reverting [src/bartcore/moves.hpp:120-123](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/moves.hpp#L120-L123)'s `-HUGE_VAL` to the pre-fix
    ...
    [tests/cpp/test_moves.cpp:1212-1218](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L1212-L1218) - and this pass proved it by planting the same mutation there:
    ...
    four assertions ([tests/cpp/test_moves.cpp:43](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L43), [tests/cpp/test_moves.cpp:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L48), [tests/cpp/test_moves.cpp:52](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L52), [tests/cpp/test_moves.cpp:56](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L56)) separate, or drop the claim and point at tests/cpp.
  - **M17. `samplePriorPredictive`'s sigma prior draw can be replaced by the point estimate.**
    [R/dbarts.R:836](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L836), `sqrt(df * sigest^2 * rawScale / rchisq(n, df))` -> `rep_len(sigest, n)` -> SURVIVED.
    [inst/tinytest/test-prior-predictive.R:104-111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-prior-predictive.R#L104-L111)'s (d) block asserts only `var(ppd.pinned) >= var(pinned1)`, which
  ...
  - **M18. `test-sampler-setData.R`'s ONE assertion is self-cancelling.** Quantizing the replacement data
    onto a single cut per column ([R/bartcore.R:441](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bartcore.R#L441)) -> SURVIVED: it compares `sd(rowMeans(samples1$train) -
...
- **NARROWED by the replant: the leg's file-level finding stands, the tree-level one does not.**
  - `gs1` (`setResponse(updateScale = TRUE)`'s R-layer refusal deleted) is KILLED whole-suite by
    ...
    REFUTED at tree scope; what survives is that [inst/tinytest/test-grouped-swap.R:64-74](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-grouped-swap.R#L64-L74), written to hold exactly it,
  ...
  - `se1` (`$sampleTreesFromPrior()` made a no-op) and `dcm2` (`validateXYOffset` returning NULL) are both
    ...
    `test-generics-sequentialExecution.R` is 2 assertions, one of them `expect_inherits`, and its [inst/tinytest/test-grouped-swap.R:42](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-grouped-swap.R#L42)
  ...
  - `x05`/`x03`/`x04` were never zero-killer: leg D's own run shows `test-xbart-oracle.R` catching each. The
    ...
    when data do not divide evenly by k" (verified at [inst/tinytest/test-grouped-swap.R:114](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-grouped-swap.R#L114)) asserts only `expect_inherits(xval, "array")`,
...
- [R/plotTree.R:9-35](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/plotTree.R#L9-L35) decodeCategoricalSplits' PADDING BRANCH IS DEAD CODE: skipping the decode and padding
  with "R" instead of "L" both leave the three categorical files green, including
  [inst/tinytest/test-data-categorical-declared.R:53](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-data-categorical-declared.R#L53)'s `nchar(directions) == 4L` on a factor whose 4th level is never
...
- [R/model.R:1554](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L1554) `resolvePriorScale`'s `prior.sd * k` conversion is unreached: every sampler in
  `test-calibration-prior-draws.R` spells `scale =`, never `sd =`. AGENT-FIX. [C 9]
- [R/generics.R:125](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L125) pointwiseLogLikelihood's zero-weight NaN flag can report -Inf instead; the file's
...
- [R/bart.R:2709](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2709) the burn side of `n.burn %/% n.thin` is unpinned on both `bart()` and `bart2()`;
  `test-control-valuesAreUsed.R`'s keepevery arm pins only the SAMPLE side. AGENT-FIX. [C 11]
- [R/model.R:1614-1627](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L1614-L1627) `student()`'s own `df <= 0.0` refusal is redundant with `dbartsStudentDist` S4
...
- Equivalent mutants, recorded so a later leg does not re-file them: [R/sliceSample.R:185](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/sliceSample.R#L185)'s upper clamp
