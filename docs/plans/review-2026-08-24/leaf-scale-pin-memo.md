...
- INTERNAL `forest.leaf.scale` ([src/bartcore/chain.hpp:633](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/chain.hpp#L633)) is computed ONCE at
...
- IN FORCE, response units: `prior.scale = leaf.scale * fitScale * sqrt(m)`
  ([src/bartcore/chain.hpp:3973](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/chain.hpp#L3973)), `fitScale` the transform's multiplier - `range_` under
  gaussian/t/aft/grouped ([src/bartcore/model.hpp:2920](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/model.hpp#L2920), 3926), 1 under the latent families.
...
replication (aft: censoring status is structural, [src/bartcore/model.hpp:3868](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/model.hpp#L3868); grouped:
setData refused, [src/R_interface_bartcore.cpp:4634](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/R_interface_bartcore.cpp#L4634)) fits under a different prior
from the one theta0 came from. `resolvedNodeScale` ([src/bartcore/chain.hpp:3963](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/chain.hpp#L3963)) is the pin:
...
- A pin held through `setData` WOULD change the model users get: `setData`
  re-anchors today (section 2), and [man/dbartsSampler-class.Rd:419](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/man/dbartsSampler-class.Rd#L419) plus dbarts.Rd's
...
- `setResponse(updateScale = TRUE)` keeps rescaling either way - its documented
  purpose ([man/dbartsSampler-class.Rd:144](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/man/dbartsSampler-class.Rd#L144), "should only be TRUE during burn-in") -
  ...
  `refuseGroupedScaleUpdate`, [src/R_interface_bartcore.cpp:2723](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/R_interface_bartcore.cpp#L2723)). Untouched here.
...
- Option A, default-off creation pin: bitwise-neutral. No equivalence scenario
  ...
  ([src/bartcore/chain.hpp:1208](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/chain.hpp#L1208)).
- Option A extended to `setData`: DRAW-MOVING on exactly one canonical
  scenario, `setdata` ([benchmarks/R/equivalence.R:139-146](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/benchmarks/R/equivalence.R#L139-L146), the only `$setData` caller;
...
([src/bartcore/chain.hpp:648](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/src/bartcore/chain.hpp#L648)), its reported-scale sigma prior is range-independent under an
explicit `sigma =` ([benchmarks/R/sbc.R:38-42](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/benchmarks/R/sbc.R#L38-L42)), and a zero-censoring control reduces bitwise
to the gaussian arm ([docs/design/survival.md:53-56](https://github.com/vdorie/dbarts/blob/658869ac6a90fc23dc9d0860e0aa0890e743c6d7/docs/design/survival.md#L53-L56)), the self-check to run first.
