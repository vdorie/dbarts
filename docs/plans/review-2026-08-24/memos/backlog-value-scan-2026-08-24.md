...
- bcf-naming-generalization ([[TODO:39@658869ac]]) 8215a53c + be1d06e4; two dead static_assert strings still
  read "BCF is a constant-leaf model" - sweep on next touch.
- blocked-jacobi-trees ([[TODO:80@658869ac]]) KILLED df13c04 + 77597cc.
- cheap-uniformity ([[TODO:84@658869ac]]) S3 06c0254 + S4 9929ede, ARC COMPLETE; sparse predict SHIPPED (the
  entry's "all open" means open for use).
- feature-matrix-prose-staleness ([[TODO:118@658869ac]]) 6d82ac86; new staleness found, sec 3.
- forest-ranef-interweaving ([[TODO:123@658869ac]]) NO-GO with a reopen clause.
- grow-from-root-default ([[TODO:145@658869ac]]) KILLED 2026-08-08.
- host-shell-read-guards ([[TODO:150@658869ac]]) OBVIATED; zero hostFor / $bc hits in R/.
- latent-family-weight-channel ([[TODO:164@658869ac]]) d0701a6a; its door is in flight, skipped.
...
- multinomial-counts-mutation ([[TODO:279@658869ac]]) complete; its doors in flight, skipped.
- r-c-division ([[TODO:327@658869ac]]) guide accepted, slate landed.
- rc-gate ([[TODO:336@658869ac]]) slate complete 2026-08-19; declaration VD-held.
- setpredictor-leafof-rebuild ([[TODO:415@658869ac]]) closed; test-bartcore-filtered-run ([[TODO:436@658869ac]]) e74380f7;
  x86-simd ([[TODO:502@658869ac]]) closed as a perf lever.

### Open

- NO-SURFACE, verified open and none of them adds or moves public surface:
  bcf-sigma-tail-mixing ([[TODO:58@658869ac]], [[bcf-sigma-residual.md:171-176@658869ac]] - a regime arising only from a
  stale build scale under setResponse(updateScale=FALSE)); correlated-outcomes ([[TODO:88@658869ac]] - AR-1 is
  an engine door, panel/ITS compose in the outer sampler today); gpu-bart ([[TODO:134@658869ac]], waits on
  frontier 4-5); grow-from-root ([[TODO:143@658869ac]], frontier 3.1 informed proposals); python-bindings
  ([[TODO:320@658869ac]], no python tree, two host contracts named); sbc-family-tiers ([[TODO:412@658869ac]], BUILT - open doors
  are the monotone arm, the heteroscedastic setState lift blocked by the same defect as
  shortlist 2, and full-R ladder re-runs); tree-mixing-proposals ([[TODO:441@658869ac]], research complete -
...
- POST-1.0 per standing calls, all verified: binary-kforest-k1-reachability ([[TODO:67@658869ac]], a designed
  refusal in spec.R; surface yes, a new shipped configuration);
  equivalence-harness-statistical-mode ([[TODO:96@658869ac]] - CONFIRMED including the awkward half:
  bcf-equivalence-6e3b9fb8.rds (Aug 16) predates the summaries [[bcf-equivalence.R:495-505@658869ac]]
  needs, and that path degrades loudly; gate infra); repo-modernization ([[TODO:410@658869ac]], not started -
  inst/NEWS.Rd, no NEWS.md, no @export); wave5-review-followups ([[TODO:466@658869ac]] - no vetoed-leaf counter
  exists in src/bartcore, so item 5's first half is open as a new but additive R-readable
  channel).
- gp-followups ([[TODO:127@658869ac]]). CONFIRMED: gp(columns, k, lengthscale, ...) takes a fixed positive
...
- group-by-exposure ([[TODO:137@658869ac]]). CONFIRMED: group.by is a formal on exactly three rbart surfaces
...
- integer-predictor-storage ([[TODO:153@658869ac]]). CONFIRMED absent: PredictorSource carries const double*
  denseValues only ([[src/bartcore/data.hpp:188@658869ac]]), no integer ColumnSourceKind ([[TODO:129-135@658869ac]]), bridge
...
- interaction-constraints ([[TODO:157@658869ac]]). CONFIRMED: shipped formal is interactions(max.order, groups,
...
- multiforest-mutation-gaps ([[TODO:208@658869ac]]). All four claims CONFIRMED. Flat C
  setPredictor/updatePredictor present and unguarded BY DESIGN with the rationale in place
  ([[src/C_interface.cpp:665-673@658869ac]], [[TODO:694-698@658869ac]]); monotone 1e-9 deliberate; BCF whole-data setData
  postponed, not raised. Per-forest row subsetting: value lifted, shape unresolved. DOOR (D1).
- negbin-real-dispersion ([[TODO:296@658869ac]]). CONFIRMED live: [[R/data.R:650-655@658869ac]] refuses real dispersion, and
  [[TODO:634-639@658869ac]] already records that admitting it is "a validation relaxation, not a signature
  change". DOOR (D2, with weighted-binary).
- ordinal-scan-missing-rows ([[TODO:305@658869ac]]). CONFIRMED live and exactly as described. Split side skips
  missing (`if (code == naCode) continue;`, [[scan.hpp:100@658869ac]]) and totals surviving bins
  ([[TODO:105-108@658869ac]]); the no-split term takes the FULL node stats ([[grow.hpp:183-193@658869ac]], fed by
...
- release-candidate-review ([[TODO:372@658869ac]]). All six VD forks executed (slice F 621da478, FX1-channel
  c3af16a1, FX2, L, P12, merge deferred); waves 0-5b landed; the remaining legs are in flight
  elsewhere. PROCESS.
- sparse-extensions ([[TODO:419@658869ac]]). CONFIRMED, both refusals live: rbart_vi at [[R/rbart.R:302-307@658869ac]],
  linear/gp leaf covariates at [[R/model.R:215-220@658869ac]] and [[TODO:257-263@658869ac]] (engine reason
...
- survival-followups ([[TODO:427@658869ac]]). CONFIRMED: expandDiscreteTimeHazard ([[R/dbarts.R:121-129@658869ac]]) has no
  entry-time argument and starts every subject at period 1 ([[TODO:143-144@658869ac]]). It is INTERNAL, so the
...
- variance-forest-mutation-routing ([[TODO:456@658869ac]]). Three doors, all CONFIRMED, not the same kind. (a)
  setState variance COLUMN-MASK gap, LIVE and silent: columnMaskSubtreeIsValid ([[tree.hpp:536@658869ac]])
  has five call sites, all mean-forest ([[chain.hpp:3191@658869ac]], [[TODO:3379@658869ac]], [[TODO:3400@658869ac]], [[TODO:3442@658869ac]], [[TODO:3530@658869ac]]);
  stateIsValid's variance branch ([[TODO:3231-3275@658869ac]]) checks well-formedness, positivity and occupancy
  but never the mask, and rebuildVarianceForest ([[TODO:4285-4316@658869ac]]) does not either; the one variance
  mask check ([[TODO:3387-3403@658869ac]]) is reached from the warm-start pre-flight ([[sampler.hpp:918@658869ac]]), not
  ...
  and (c).
- weighted-binary ([[TODO:498@658869ac]]). CONFIRMED live: probit refuses weights outright ([[R/spec.R:52-58@658869ac]]),
  logistic refuses non-integer ([[TODO:60-67@658869ac]]). DOOR (D2).
- release block ([[TODO:509-550@658869ac]]). PROCESS, VD-triggered; 11 workflow files exist, registration waits
...
1. Heteroscedastic loglik and PPD are silently wrong. NOT IN TODO. A variance-forest fit
   ...
   took at FX1 and FX2.
2. Variance-forest setState column-mask gap ([[TODO:456@658869ac]]a). Public route: $setState /
...
3. ordinal-scan-missing-rows ([[TODO:305@658869ac]], evidence in sec 1). SURFACE: draw-law change on the
...
4. dbartsData(bases =) equal-count ambiguity. NOT IN TODO; scoped out of S13
   ([[bart2-argument-consolidation.md:1935-1940@658869ac]]). dbarts()'s formula path now requires a
   ...
   ([[R/data.R:1067@658869ac]]) while its own x/y path checks full length and subsets ([[TODO:1165@658869ac]]). The same
...
6. group-by-exposure ([[TODO:137@658869ac]]). SURFACE: a new group.by formal on bart2()/dbarts(), spelling
...
7. survival left truncation ([[TODO:427@658869ac]]). SURFACE: a new entry= formal on dbarts()/bart2() for
...
8. sparse-extensions, rbart_vi and linear-leaf-on-sparse ([[TODO:419@658869ac]]). SURFACE: two refusals
...
10. interaction-constraints formal heredity ([[TODO:157@658869ac]]). SURFACE: a fourth interactions()
    ...
    cost.
11. gp-followups sampled lengthscales ([[TODO:127@658869ac]]). SURFACE: lengthscale accepts a prior, plus a
...
- D1, per-forest row subsetting ([[TODO:208@658869ac]]). DECIDE: does a forest seeing fewer rows get a MASK
...
- D2, the approximate-Polya-Gamma posture ([[TODO:296@658869ac]] + [[TODO:498@658869ac]], one decision). DECIDE: does dbarts
...
- STALE PREMISE, [[TODO:265-267@658869ac]]. The sampler$data@x dimnames-drop limitation is FIXED, not
  ...
  argument.
- STALE PROSE, feature-matrix.md [f19] ([[TODO:671-675@e8fcf8be]]) and its Gaps student line ([[TODO:1039@e8fcf8be]]) still say
...
- STALE ROW, docs/design/INDEX.md lists nameable-calibration.md as PARTIAL with the flat-C
  ...
  calls the arc COMPLETE; source is that doc's own Status line ([[nameable-calibration.md:3-4@658869ac]]).
- STALE ANCHORS, [[bcf-bartcause-relocation.md:1255-1295@658869ac]] cites [[TODO:80-143@658869ac]] and [[TODO:497-500@658869ac]] for
...
- Forest 1's sd and update.amplitude have no formula-term spelling
  ([[bart2-argument-consolidation.md:1935-1937@63df524e]]), the recorded cost of the XOR against a forests
