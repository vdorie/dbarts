...
## Citations of the tour by line
    ...
    [[docs/plans/review-2026-08-24/memos/prerc-lens2-backlog.md:73@ecdfb945]]   -> tour:290
    [[docs/plans/review-2026-08-24/memos/prerc-lens3-external.md:49@ecdfb945]]  -> tour:463-467
...
| 169 | "`stateFormatVersion` is 3 (`[[src/R_interface_bartcore.cpp:6380@ae5b91d8]]`)" | STALE-FALSE | `([[src/R_interface_bartcore.cpp:6446@3080a9c5]])` |
| 228 | "`setWeights`/`setSigma` refused by name (`[[src/R_interface_bartcore.cpp:2773@ae5b91d8]]`, [[src/R_interface_bartcore.cpp:2898@ae5b91d8]])" | STALE-FALSE | `[[src/R_interface_bartcore.cpp:2791@3080a9c5]]`, `[[src/R_interface_bartcore.cpp:2928@3080a9c5]]` |
| 272 | "DART is refused by name (`[[R/bart.R:901@ae5b91d8]]`)" | STALE-FALSE | `[[R/bart.R:902@3080a9c5]]` |
| 298 | "`hurdleLogLik` (`[[R/generics.R:2045@ae5b91d8]]`)" | STALE-FALSE | `[[R/generics.R:2344@3080a9c5]]` |
| 327-331 | "`heteroscedasticScale` (`[[R/generics.R:32@ae5b91d8]]`) ... in `pointwiseLogLikelihood` ([[R/generics.R:95@ae5b91d8]]) and, via `ppdNoiseScale` ([[R/generics.R:2754@ae5b91d8]]), in `sampleFromPPD` ([[R/generics.R:2785@ae5b91d8]])" | STALE-FALSE | `[[R/generics.R:32@3080a9c5]]` and `[[R/generics.R:95@3080a9c5]]` hold; `ppdNoiseScale` is `[[R/generics.R:3115@3080a9c5]]`, `sampleFromPPD` `[[R/generics.R:3146@3080a9c5]]` |
| 338 | "(`[[src/R_interface_bartcore.cpp:7118@ae5b91d8]]`, [[src/R_interface_bartcore.cpp:7433@ae5b91d8]])" | STALE-FALSE | `[[src/R_interface_bartcore.cpp:7184@3080a9c5]]`, `[[src/R_interface_bartcore.cpp:7499@3080a9c5]]` ([[docs/design/feature-matrix.md:1027@52c10e02]] already carries these) |
...
| 478-490 | Stop 6 entry map ("`R_interface_bartcore.cpp` is 7,759 lines", `_create` [[src/R_interface_bartcore.cpp:3489@ae5b91d8]] ... guards [[src/R_interface_bartcore.cpp:2265@ae5b91d8]] ...) | STALE-FALSE | 7,825 lines. `bartcore_create` [[src/R_interface_bartcore.cpp:3541@3080a9c5]], `_createDataHandle` [[src/R_interface_bartcore.cpp:3565@3080a9c5]], `_createFromHandle` [[src/R_interface_bartcore.cpp:3619@3080a9c5]], `_createBCF` [[src/R_interface_bartcore.cpp:3791@3080a9c5]]; `_run` [[src/R_interface_bartcore.cpp:4307@3080a9c5]], `_runWithCallback` [[src/R_interface_bartcore.cpp:4551@3080a9c5]], `_growFromRoot` [[src/R_interface_bartcore.cpp:4632@3080a9c5]]; `_setOffset` [[src/R_interface_bartcore.cpp:4649@3080a9c5]], `_setResponse` [[src/R_interface_bartcore.cpp:4669@3080a9c5]], `_setSigma` [[src/R_interface_bartcore.cpp:4693@3080a9c5]], `_setData` [[src/R_interface_bartcore.cpp:4700@3080a9c5]], `_setWeights` [[src/R_interface_bartcore.cpp:4935@3080a9c5]]; `_setPredictor` [[src/R_interface_bartcore.cpp:5119@3080a9c5]], `_updatePredictor` [[src/R_interface_bartcore.cpp:5167@3080a9c5]], `_setActiveRows` [[src/R_interface_bartcore.cpp:4074@3080a9c5]]; `_setForestBasis` [[src/R_interface_bartcore.cpp:3981@3080a9c5]], `_getForestAmplitudes` [[src/R_interface_bartcore.cpp:4118@3080a9c5]], `_getForestVariableCounts` [[src/R_interface_bartcore.cpp:4280@3080a9c5]]; `_getCalibration` [[src/R_interface_bartcore.cpp:4205@3080a9c5]], `_setCalibration` [[src/R_interface_bartcore.cpp:4260@3080a9c5]]; `_storeState` [[src/R_interface_bartcore.cpp:5684@3080a9c5]], `_setState` [[src/R_interface_bartcore.cpp:5689@3080a9c5]], `_installForests` [[src/R_interface_bartcore.cpp:5702@3080a9c5]]; `_predict` [[src/R_interface_bartcore.cpp:5837@3080a9c5]], `_predictPerForest` [[src/R_interface_bartcore.cpp:5938@3080a9c5]], `_getTrees` [[src/R_interface_bartcore.cpp:6022@3080a9c5]], `_getLatents` [[src/R_interface_bartcore.cpp:6171@3080a9c5]]. Guards: `refusedAmplitudeFamilyReason` [[src/R_interface_bartcore.cpp:2266@3080a9c5]], `refuseMultiForestMutation` [[src/R_interface_bartcore.cpp:2618@3080a9c5]], `refuseMultiForestResponseMutation` [[src/R_interface_bartcore.cpp:2647@3080a9c5]], `refuseBinaryWeightChange` [[src/R_interface_bartcore.cpp:2791@3080a9c5]], `refuseUndefinedTestFits` [[src/R_interface_bartcore.cpp:2890@3080a9c5]], `refusePinnedSigmaChange` [[src/R_interface_bartcore.cpp:2928@3080a9c5]], and NEW `refuseNonBinaryMask` [[src/R_interface_bartcore.cpp:2946@3080a9c5]] (shared with the flat entry since 9df0cb50). |
| 498 | "`refusePinnedSigmaChange`'s own comment ([[src/R_interface_bartcore.cpp:2885-2897@9df0cb50]])" | STALE-FALSE | `([[src/R_interface_bartcore.cpp:2915-2927@9df0cb50]])` |
...
| 675-676 | "`[[R/dbarts.R:1398@fcbbc478]]` -> bridge [[src/R_interface_bartcore.cpp:4022@fcbbc478]] -> `Chain::setActiveRows` [[chain.hpp:1666@fcbbc478]] -> [[facade.hpp:368@fcbbc478]]" | STALE-FALSE | bridge is `[[src/R_interface_bartcore.cpp:4074@3080a9c5]]` (`[[src/R_interface_bartcore.cpp:4022@3080a9c5]]` is `bartcore_setForestWeights`); facade is `[[facade.hpp:370@fcbbc478]]`. [[chain.hpp:1666@fcbbc478]] holds. |
...
| 947-950 | "feature-matrix.md - ... a Gaps section ([[docs/design/feature-matrix.md:924@23b9cde7]])" | STALE-FALSE | `([[docs/design/feature-matrix.md:929@23b9cde7]])` |
...
| 211-215 | "inst/tinytest/test-capi.R drives only the `\"\"`/`\"probit\"` tokens plus grouped ([[inst/tinytest/test-capi.R:697@ae5b91d8]]) and heteroscedastic ([[inst/tinytest/test-capi.R:222@ae5b91d8]]) by control attribute, and BCF ([[inst/tinytest/test-capi.R:1356@ae5b91d8]])" | STALE-FALSE | `grouped ([[inst/tinytest/test-capi.R:785@52c10e02]]) and heteroscedastic ([[inst/tinytest/test-capi.R:803@52c10e02]]) ... and BCF ([[inst/tinytest/test-capi.R:1475@52c10e02]])`. The claim itself (logistic, aft, ordinal, nbinom reachable and untested through dbarts.h) still holds. |
