...
([src/bartcore/moves.hpp:55-58](https://github.com/vdorie/dbarts/blob/39fa379a442555257bd0fb9970a86ef77cca92cb/src/bartcore/moves.hpp#L55-L58) returns first today) - a masked bench-sampler arm was called
for.

The empty-leaf veto slice added a per-leaf rank loop to
`logLikelihoodForBranch` ([src/bartcore/moves.hpp:67-96](https://github.com/vdorie/dbarts/blob/39fa379a442555257bd0fb9970a86ef77cca92cb/src/bartcore/moves.hpp#L67-L96)) that runs for every
...
([src/bartcore/model.hpp:729-771](https://github.com/vdorie/dbarts/blob/39fa379a442555257bd0fb9970a86ef77cca92cb/src/bartcore/model.hpp#L729-L771) at base) re-derived the SAME list into
