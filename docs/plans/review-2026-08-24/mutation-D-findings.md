...
1. MAJOR  [src/bartcore/moves.hpp:120-123](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/src/bartcore/moves.hpp#L120-L123)  resolveVetoRank's `-HUGE_VAL` can be replaced by
   ...
   reached. [tests/cpp/test_moves.cpp:1212-1218](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L1212-L1218) pins `currentLogL == -HUGE_VAL` directly, so
   ...
   assertion at [tests/cpp/test_moves.cpp:43-48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/tests/cpp/test_moves.cpp#L43-L48) actually separates, or drop the regression claim from the header and
   point it at tests/cpp.  VD-judgement

2. MAJOR  [R/xbart.R:367-371](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/xbart.R#L367-L371), [inst/tinytest/test-xbart-method.R:114-132](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-xbart-method.R#L114-L132)  the k-fold remainder distribution
   ...
   `expect_inherits(xval, "array")`. Only [inst/tinytest/test-xbart-oracle.R:141](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-xbart-oracle.R#L141) catches it.
   SHOULD EXIST  [inst/tinytest/test-xbart-method.R:132](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-xbart-method.R#L132), a fold-size oracle rather than a class check:
   `expect_equal(xbart(x, y, method = "k-fold", n.test = 5, n.reps = 1L,
   loss = function(y.test, s, w) length(y.test), ...), 24 / 5)`.  agent-fix

3. MAJOR  [R/xbart.R:712](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/xbart.R#L712) and [R/xbart.R:731](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/xbart.R#L731), test-xbart-loss.R  the file whose subject is the custom
   ...
   SHOULD EXIST  [inst/tinytest/test-xbart-loss.R:41](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-xbart-loss.R#L41), a constant-loss identity
   (`expect_equal(as.vector(xbart(..., loss = function(a, b, c) 42)), rep(42, ...))`) and a
   mad() value oracle mirroring [inst/tinytest/test-xbart-oracle.R:63-70](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-xbart-oracle.R#L63-L70).  agent-fix

4. MAJOR  [R/dbarts.R:836](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/dbarts.R#L836), [inst/tinytest/test-prior-predictive.R:104-111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-prior-predictive.R#L104-L111)  samplePriorPredictive's sigma
   ...
   SHOULD EXIST  [inst/tinytest/test-prior-predictive.R:111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-prior-predictive.R#L111), at the pinned control seed
...
5. MAJOR  [R/utility.R:797-816](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/utility.R#L797-L816), test-predict-sparse.R  the sparse test column's level-recode
...
6. MINOR  test-rbart-multithreaded.R (1 assertion, `expect_inherits(..., "rbart")`)  forcing
   ...
   independent by design ([inst/tinytest/test-rng.R:133-135](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-rng.R#L133-L135) says so). Nothing in the half can observe a lost
...
7. MINOR  [R/model.R:1614-1627](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L1614-L1627)  `student()`'s own `df <= 0.0` refusal is dead: deleting it
   leaves all 51 green because `newValidated` runs dbartsStudentDist validity
   ([R/A_class.R:223](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/A_class.R#L223)), whose message also contains "positive finite". test-robust-errors.R
   [R/A_class.R:28-31](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/A_class.R#L28-L31) pins the S4 validity, not the constructor. A redundancy, not a coverage hole.
   defer

8. MINOR  [R/bartcore.R:441](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bartcore.R#L441) (setData), test-sampler-setData.R  quantizing the replacement data
...
9. MINOR  [R/model.R:378-380](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L378-L380)  the uniform-split-probability canonicalization to `numeric()` is
   unreached by test-sampler-splitProbabilities.R: with `if (FALSE)` all 51 stay green,
   because its three `length(splitProbabilities) == 0L` assertions ([R/model.R:21-41](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/model.R#L21-L41)) take the earlier
...
10. MINOR  [R/rbart.R:1201](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/rbart.R#L1201) vs [R/rbart.R:1269](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/rbart.R#L1269)  the two arms of rbart_vi's `$varprobs` assembly are
    separately unpinned: [inst/tinytest/test-rbart-options.R:167-168](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/inst/tinytest/test-rbart-options.R#L167-L168) exercises the DART report at
...
11. MINOR  [R/sliceSample.R:185](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/sliceSample.R#L185)  dropping the upper-boundary clamp on the stepping-out
...
One, and it is a robustness gap rather than a live defect. [R/generics.R:2040-2046](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/generics.R#L2040-L2046)
...
REPRODUCTION: in [R/bart.R:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L40), `colnames(res) <- dimnames(samples)[[1L]]` -> `NULL`; install;
