...
matching [man/bart2.Rd:237](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L237)'s own statement of the same restriction. Agrees.
...
- **CONTRADICTS**: [man/dbartsSpec.Rd:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L40), "Both entry points call the same
...
- **Internally inconsistent, same file**: [man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48) groups
...
- **AGREES**: [man/rbart.Rd:94-95](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/rbart.Rd#L94-L95) already documents "[the survival response]
...
- **AGREES**: [man/bart2.Rd:306](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart2.Rd#L306), "\[the forest()\ term route\] is the only
...
differently for the identical input, contradicting [man/dbartsSpec.Rd:40](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L40)'s
...
declares. Also see the [man/dbartsSpec.Rd:48](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSpec.Rd#L48) inconsistency in section 3.
...
enters only through the formula" - a real, and correctly documented ([man/rbart.Rd:95](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/rbart.Rd#L95)),
...
**F9. `bart()`'s by-name own-class-family refusal ([man/bart.Rd:16](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/bart.Rd#L16): "naming
...
`"twopart"` is documented ([man/dbarts.Rd:111](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbarts.Rd#L111), bart2.Rd) to resolve and print as
...
```
Root cause: `bartOwnClassFamilies` ([R/bart.R:2587-2592](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/R/bart.R#L2587-L2592)) is the literal
...
census - [man/dbartsSampler-class.Rd:351](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L351) documents in detail which of the
...
- **pdbart/pd2bart are covered by the class x generic existence table but
  ...
  or BCF sampler's method census ([man/dbartsSampler-class.Rd:351](https://github.com/vdorie/dbarts/blob/b102e17cc7226338e7c7b26f73eedae617c8026f/man/dbartsSampler-class.Rd#L351)'s specific
