...
- REAL, high: grouped tau slice sampler step-out is UNCAPPED in
  BOTH directions ([src/bartcore/model.hpp:2299-2301](https://github.com/vdorie/dbarts/blob/efd1d24b8723a87250db3b82a2a61f5cdc30609a/src/bartcore/model.hpp#L2299-L2301); only shrinkage has the
...
- REAL, high (headline): chi-k Gibbs runaway - chi()'s scale=Inf
  DEFAULT ([R/model.R:451](https://github.com/vdorie/dbarts/blob/efd1d24b8723a87250db3b82a2a61f5cdc30609a/R/model.R#L451), verified) is an improper prior; when
