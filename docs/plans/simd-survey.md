...
- Dispatched today ([src/misc/simd.c:212-417](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/simd.c#L212-L417)): partition (permutation, integer-exact),
...
- Elementwise + permutation kernels are **bitwise-identical across ISAs** by
  ...
  two-pointer permutation exactly ([src/bartcore/tree.hpp:626-628](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/tree.hpp#L626-L628) "bitwise identical to the
...
- The hot REDUCTIONS that determine draws - leaf sufficient statistics
  (misc_compute*SufficientStatisticsFast, [src/misc/moments.c:311-416](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/moments.c#L311-L416)) and the sigma-draw
  SSR (misc_computeSumOfSquaredResiduals, [src/misc/moments.c:2768](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/moments.c#L2768)/2789) - are kept
  **SCALAR and UNDISPATCHED** on purpose. Comment [src/misc/moments.c:307-310](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/moments.c#L307-L310) even
...
1. Residual roll ([src/bartcore/chain.hpp:728-786](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L728-L786)): 3 fused elementwise loops, HAND-WRITTEN in
   the header (not misc). `resid[i]=y-total+oldFits` / `resid[i]+=oldFits-prevFits`
   / `total[i]=y-resid+lastFits`.
2. setNodeAverages -> computeLeafStats over every leaf ([src/bartcore/tree.hpp:492-521](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/tree.hpp#L492-L521)): a full
   ...
   !hasVectorParams = TRUE for the constant leaf ([src/bartcore/chain.hpp:365](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L365), [src/bartcore/chain.hpp:747](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L747)).
3. Fit scatter (sampleParametersAndSetFits, [src/bartcore/chain.hpp:2076-2129](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2076-L2129);
   setTreeFitsFromParameters [src/bartcore/chain.hpp:2035](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2035)): per leaf, misc_setVectorToConstant (root,
...
(orphanChildren, [src/bartcore/tree.hpp:792-802](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/tree.hpp#L792-L802)). So the O(n)-per-tree passes above dominate
for large n.
Once per sweep (not per tree): SSR for sigma ([src/bartcore/chain.hpp:908](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L908)), reduction, scalar.
...
### #1  Fused residual-roll kernel family  ([src/bartcore/chain.hpp:728-736](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L728-L736), 748-750, 780-786; grow twin [src/bartcore/chain.hpp:976-984](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L976-L984), 1008-1009)
...
5. Why CRAN can't get it: not the compiler's fault on shape - it vectorizes
   ...
   hand-fused to save a memory pass (comment [src/bartcore/chain.hpp:726](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L726) "One fused pass").
...
(a) misc_setIndexedVectorToConstant ([src/misc/linearAlgebra.c:168](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/linearAlgebra.c#L168)) - the fit SCATTER of a
    constant to a leaf's member indices; used every sweep in the fit-scatter pass
    ([src/bartcore/chain.hpp:2048](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2048), [src/bartcore/chain.hpp:2125](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2125)). **Never entered the dispatch table** (x86-simd.md).
...
### #3  Leaf sufficient-statistic gather+reduce  ([src/misc/moments.c:311-416](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/moments.c#L311-L416), via setNodeAverages/computeLeafStats)
...
### #C  Cut-scan histogram  (unresolved: [src/bartcore/scan.hpp:61-144](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/scan.hpp#L61-L144), histogramDenseCutScan + scanOrdinalCuts)
...
2. Frequency: **COLD in the default sampler.** Only caller is growTreeFromRoot
   ([src/bartcore/grow.hpp:118](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/grow.hpp#L118)), i.e. the OPT-IN grow-from-root WARM START
...
### #D  SSR for the sigma draw  ([src/misc/moments.c:2768](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/moments.c#L2768)/2789, [src/bartcore/chain.hpp:908](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L908), [src/bartcore/model.hpp:1763](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/model.hpp#L1763))
...
([src/misc/moments.c:1330](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/misc/moments.c#L1330)). BUT these dispatched Mean/Variance reductions are **NOT in the
...
- REGRESSION as shipped: misc has NO u8 SIMD partition kernel, so u8 dense
  ordinal columns take the SCALAR partition ([src/bartcore/tree.hpp:713-722](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/tree.hpp#L713-L722)), while u16 columns
