...
| split-probability and proposal-probability sum-to-one checks ([src/R_interface_bartcore.cpp:1158](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1158), [src/R_interface_bartcore.cpp:1330](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1330), [R/A_class.R:402](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/A_class.R#L402)) | 1e-10 | IS an almost-equal predicate at unit scale, hand-picked | UNIFY at S3 (VD 2026-08-10) |

## Binding decisions inherited (do not reopen)

1. **[src/bartcore/model.hpp:166](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/model.hpp#L166) hardening**: `logIntegratedLikelihood`'s guard becomes
...
6. **No `dbarts.h` symbol in this arc.** The flat API has no BCF creation entry
   ...
   `docs/plans/archive/c-api-growth.md` at S3.
...
- Sigma df: a per-forest weight must NOT reach `numPositiveWeights_`, and by
  ...
  scores `combinedFits`. See `docs/plans/archive/sigma-df-zero-weights.md` for the
...
- Design docs: `docs/design/bcf.md` (the glue and multiplier), `docs/design/
  ...
  plans: `docs/plans/archive/forest-combiner.md` (the mandated BCF gate set),
...
- **The mandated BCF oracle set** (`docs/plans/archive/forest-combiner.md` step 4;
  `docs/plans/archive/bcf-b-ridge.md`: these MUST STAY EXACT): `bcf-exact.R` quick AND
...
2. Docs: `docs/design/bcf.md` (the multiplier and glue section; and bump its
   ...
   `multiforest-mutation-gaps`; `docs/plans/archive/c-api-growth.md` (the reservation:
...
5. **Sum-to-one unification (VD 2026-08-10: unify).** The three hand-picked
   ...
   [src/R_interface_bartcore.cpp:1158](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1158) (rule proposal probabilities), [src/R_interface_bartcore.cpp:1330](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1330)
   (split probabilities), [R/A_class.R:402](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/A_class.R#L402) (validity) - move to the
...
[src/R_interface_bartcore.cpp:1158](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1158)/[src/R_interface_bartcore.cpp:1330](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1330) pre-edit, [R/A_class.R:402](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/A_class.R#L402); the
shared constant sumToOneTolerance = 0x1p-26 lands at [R/A_class.R:63](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/A_class.R#L63)) with band-edge
...
docs/plans/archive/c-api-growth.md reservation above), LANDED at dbarts-h-reshape
