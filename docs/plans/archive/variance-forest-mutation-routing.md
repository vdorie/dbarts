...
post-mutation data, per docs/plans/archive/post-mutation-assertions.md) - the only test
...
docs/plans/archive/sampletreesfromprior-midchain.md pattern - return every variance
...
- **setState column-mask check for variance trees** (found at S5,
  ...
  `stateIsValid`'s variance branch ([src/bartcore/chain.hpp:3341](https://github.com/vdorie/dbarts/blob/c95a5e83a720327dc25c7a50b79864365404e532/src/bartcore/chain.hpp#L3341)) and as
  `rebuildVarianceForest`'s backstop ([src/bartcore/chain.hpp:4377](https://github.com/vdorie/dbarts/blob/c95a5e83a720327dc25c7a50b79864365404e532/src/bartcore/chain.hpp#L4377)).
