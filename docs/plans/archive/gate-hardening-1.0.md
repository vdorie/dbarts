...
1. Poison 13 - BCF a-glue prior precision ([src/bartcore/chain.hpp:2049](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/chain.hpp#L2049) drops
...
2. Poison 16 - GP nugget drops /w_i ([src/bartcore/model.hpp:721](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L721)): caught only by
...
4. Poison 15 - linear ridge drops sigma^2 ([src/bartcore/model.hpp:304](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L304), score side
...
6. Poison 8 - chi-k shape mislabel ([src/bartcore/model.hpp:1729](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L1729), shape
...
- Poison-15 sensitivity tuning (marginal-side ridge poison only; the
  draw at [src/bartcore/model.hpp:341](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L341) stays clean): the poison mostly reweights tree
...
Fail-on-poisoned proof (poison 15: [src/bartcore/model.hpp:304](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L304)
...
Poison 16 ([src/bartcore/model.hpp:721](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L721) `noise = residualVariance / w` -> drops / w):
  wtgp 39 summaries, max |z| = 24.93, 29 with |z| > 3,
  26 with |z| > 4 <- FAIL (worst: vprop.2 z=24.93, k.mean z=-20.31,
  fhat.test.5 z=-18.52, ...) exit 1

Poison 12 ([src/bartcore/model.hpp:2334](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L2334) `weightScratch[j] += w` -> `+= 1.0`):
...
Poison 8 ([src/bartcore/model.hpp:1729](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/model.hpp#L1729) shape `0.5 (M + nu)` -> `0.5 (M + 2 nu - 1)`):
...
Fail-on-poisoned proof (poison 13: [src/bartcore/chain.hpp:2049](https://github.com/vdorie/dbarts/blob/c01447ae7e50bf4e38a94c1c14182bc2561640e5/src/bartcore/chain.hpp#L2049)
