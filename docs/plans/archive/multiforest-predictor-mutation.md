...
5. **The window contradicted a settled ruling. UPHELD.** Not reopened; see
   ...
   S0 (`docs/plans/archive/bcf-public-surface.md:286-289`) pins the BCF refusals this
...
5. **Close `stateIsValid`'s variance occupancy gap** (adjudication 4): the variance
   ...
   item is re-homed to `docs/plans/archive/variance-forest-mutation-routing.md` as
...
2. `docs/design/model-space-survey.md` secs 4-5; `docs/design/heteroscedastic.md`;
   ...
   landing rule.
3. `docs/plans/archive/c-api-growth.md`: record that this arc added NO X-list entry and
