...
- Global width today: [src/bartcore/data.hpp:19](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L19) (uint16_t, "matches the
  classic engine"), one flat codes vector ([src/bartcore/data.hpp:139](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L139)); kernels typed
  on the single misc_xint_t ([src/include/misc/partition.h:14-15](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/include/misc/partition.h#L14-L15)).
- Default n.cuts = 100 ([R/dbarts.R:17](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/dbarts.R#L17)); u8 with reserved NA 0xFF caps
...
4. ColumnStore: per-column width tag + byte-strided storage; accessors
   ...
   already leave the reserved code free ([src/bartcore/data.hpp:24](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L24) pattern).
