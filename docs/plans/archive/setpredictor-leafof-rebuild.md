...
status: CLOSED 2026-08-05 (memo executed under VD's proceed-at-
        ...
        docs/plans/archive/constant-leaf-fits.md compare record)
agent: opus
...
- docs/plans/archive/constant-leaf-fits.md: the leafOf/muByTree design, the
...
refuses it on znver2, and docs/plans/archive/simd-flag-multiversioning.md already
