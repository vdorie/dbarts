...
1. R NOTE "no visible global function definition for 'dbinom'"
   (pointwiseLogLikelihood, [R/generics.R:54](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/generics.R#L54)). dbinom sits beside dnorm
...
2. Compiled-code NOTE "Found '___stderrp', possibly from 'stderr'"
   ...
   session R_init_dbarts ([src/R_interface.cpp:297-298](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface.cpp#L297-L298)) UNCONDITIONALLY
...
- [src/R_interface_bartcore.cpp:1237](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1237), [src/R_interface_bartcore.cpp:1294](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1294), [src/R_interface_bartcore.cpp:1470](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1470) missing field
...
- [src/misc/moments.c:1102](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/misc/moments.c#L1102) unused parameter 'i' [-Wunused-parameter].
...
- [tests/cpp/test_scan.cpp:34](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/tests/cpp/test_scan.cpp#L34) 'lwz2'/'rwz2' set but not used
...
1. `lorax` - 2 ERRORs, GENUINE 1.0-0 BREAK. It calls
   ...
   [R/data.R:255](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/data.R#L255)), i.e. silently fit levels as the numbers 0/1/2; 1.0-0's
...
2. `insight` - 1 ERROR, GENUINE 1.0-0 BREAK. Its tests call
   ...
   (old [R/data.R:202](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/data.R#L202)) and silently dropped those rows; 1.0-0 passes NAs
   through ([R/data.R:766](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/data.R#L766), deliberate, comment records the change) and
