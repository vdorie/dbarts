...
- drawForestGlue(f) ([src/bartcore/combiner.hpp:645-659](https://github.com/vdorie/dbarts/blob/23fff839be41e117712cf6ee9b73daab5b8576c8/src/bartcore/combiner.hpp#L645-L659)) forms C_if =
  log sum_{j != f} exp(f_ij) via otherCategoryMargin
  ([src/bartcore/combiner.hpp:775-784](https://github.com/vdorie/dbarts/blob/23fff839be41e117712cf6ee9b73daab5b8576c8/src/bartcore/combiner.hpp#L775-L784)), O(K) exps per call -> O(nK^2) per sweep.
- The interleaving contract (comment at [src/bartcore/combiner.hpp:638-644](https://github.com/vdorie/dbarts/blob/23fff839be41e117712cf6ee9b73daab5b8576c8/src/bartcore/combiner.hpp#L638-L644)): when
