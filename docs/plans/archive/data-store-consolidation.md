...
3. Build-reset boilerplate restated per builder (~20 field resets x3
   at [src/bartcore/data.hpp:646-674](https://github.com/vdorie/dbarts/blob/ff958921849c64c415e6b6ae42cf8e8a19ddaa29/src/bartcore/data.hpp#L646-L674), 702-739, 974-1021; test resets x4): 
...
5. isView conflates provenance with capability (view == no-raw ==
   refuse-mutation, [src/bartcore/data.hpp:129-133](https://github.com/vdorie/dbarts/blob/ff958921849c64c415e6b6ae42cf8e8a19ddaa29/src/bartcore/data.hpp#L129-L133)); split before any aliased
   sharing (data-ownership open plan 4) lands.
6. DataHandle gathers ALL raw columns unconditionally
   ([src/R_interface_bartcore.cpp:1891-1896](https://github.com/vdorie/dbarts/blob/ff958921849c64c415e6b6ae42cf8e8a19ddaa29/src/R_interface_bartcore.cpp#L1891-L1896)): ~400MB at n=1e6 p=50 that a
...
7. Linear-leaf u_ is column-major against per-member row access
   ([src/bartcore/model.hpp:389](https://github.com/vdorie/dbarts/blob/ff958921849c64c415e6b6ae42cf8e8a19ddaa29/src/bartcore/model.hpp#L389), [src/bartcore/model.hpp:408](https://github.com/vdorie/dbarts/blob/ff958921849c64c415e6b6ae42cf8e8a19ddaa29/src/bartcore/model.hpp#L408)): row-major fits the gather; linear leaf only.
