...
- dbarts.h FROZEN; the internal .Call + facade BCF surface UNCHANGED. This is an
  ...
  forestTotalFits ([src/bartcore/facade.hpp:139-147](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/facade.hpp#L139-L147)) and Sampler's fan-out ([src/bartcore/sampler.hpp:1000](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/sampler.hpp#L1000)-
...
- The Forest split already shipped (forest-split-bcf.md): Chain holds
  ...
  selector/keepTrees/columnMask ([src/bartcore/chain.hpp:271-326](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L271-L326)). The combiner does NOT touch
...
- Chain members to reparent ([src/bartcore/chain.hpp:2472-2476](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2472-L2476)): forests_ stays; bcf_
  (std::unique_ptr<BCFState>) becomes combiner_ (std::unique_ptr<ForestCombiner
  <L>>). BCFState ([src/bartcore/chain.hpp:361-369](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L361-L369): z, a/b0/b1, aVariance, priors, updateA/B,
...
- Two sweep call sites duplicate the BCF branch and MUST both route through the
  combiner: run() ([src/bartcore/chain.hpp:733-847](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L733-L847): per-forest formForestResponse at 740,
  combinedFits at 831, drawGlue+interweave at 844-847) and growForestFromRoot()
  ([src/bartcore/chain.hpp:995-1064](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L995-L1064), the same branch). The default single-forest body of each
...
- Per-forest reporting addressing (storeSample, [src/bartcore/chain.hpp:2366-2456](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2366-L2456)): trainingFits
  ...
  setState glue (2/(de)serialize a/aVariance/b0/b1, [src/bartcore/chain.hpp:1695-1701](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L1695-L1701), 1863-
...
- BCF-construction helpers stay in the Chain BCF constructor (not the combiner):
  ...
  ([src/bartcore/chain.hpp:528-546](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L528-L546)). Construction wires combiner_ = a BCFForestCombiner built
  from BCFSpec; the combiner holds the borrowed z and the glue state thereafter.
- GroupedResponse ([src/bartcore/model.hpp:2639](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/model.hpp#L2639)) is a ResponseModel decorator: it subtracts
...
test-bcf.R's "default neutrality" echo ([inst/tinytest/test-bcf.R:222](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/inst/tinytest/test-bcf.R#L222)) is a within-session pair,
...
4. Reporting, serialization, and mutation through the combiner (engine, BYTE-
   ...
   AND installForest (the warm-start glue restore, [src/bartcore/chain.hpp:1863-1867](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L1863-L1867) - the
