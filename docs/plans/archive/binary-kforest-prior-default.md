...
`docs/plans/archive/multiforest-extension-surface.md` and repeated here) measured the
...
attribute. `$getForestAmplitudes` ([R/dbarts.R:1450](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L1450)) returns DRAWS.
...
under a gaussian response ([inst/tinytest/test-bcf-creation.R:51](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L51), [inst/tinytest/test-bcf-creation.R:103](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L103), [inst/tinytest/test-bcf-creation.R:321](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L321), [inst/tinytest/test-bcf-creation.R:400](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L400),
[inst/tinytest/test-bcf-creation.R:713](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L713), [inst/tinytest/test-bcf-creation.R:836](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L836); [inst/tinytest/test-forest-basis-r5.R:199](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L199)), and every latent-family
...
and [inst/tinytest/test-bcf-family.R:109-113](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-family.R#L109-L113) pins `1.0 * s / (0.674 * c)` with the `1.0`
...
- **(1b) Move to 1 in EVERY family.** Cost: re-records
  ...
  [docs/design/bcf.md:272-274](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/docs/design/bcf.md#L272-L274) states dbarts reproduces, and turns
...
- **(3b) FIVE new fields on `ForestCalibration`, surfaced at all three
  ...
  **A spec echo is a LIE after a state install, and the fix is a truthfulness
  ...
  `installForest` ([src/bartcore/chain.hpp:3235](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3235)) and the restore path
  ([src/bartcore/chain.hpp:3323](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3323)) each execute `if (fs.leafScale > 0.0) forest.leaf.scale =
  ...
  ([src/bartcore/chain.hpp:3246](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3246), [src/bartcore/chain.hpp:3355](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3355)), which overwrites `glue_.prior[f].variance` from
  `state.amplitudeVariances[f]` ([src/bartcore/combiner.hpp:1044-1045](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/combiner.hpp#L1044-L1045)).
  Neither `$setState` ([R/dbarts.R:1580](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L1580), `refuseHostMutation` only) nor
  `$installTrees` ([R/dbarts.R:1612](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L1612)) carries a BCF refusal, `glueIsValid`
  checks widths and totals only, and [inst/tinytest/test-forest-basis-r5.R:110-136](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L110-L136)
  ...
  1. **The amplitude columns follow the state.** Both install sites update
     ...
     an EXISTING base virtual, [src/bartcore/combiner.hpp:693](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/combiner.hpp#L693), already called from
     [src/bartcore/chain.hpp:2809](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L2809), so no new virtual and Fork 3b's whole reason survives).
  ...
  2. **The two map-decomposition columns carry a truthfulness bit.**
     ...
     ([src/bartcore/chain.hpp:934-945](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L934-L945)). `node.scale.factor` and `node.scale.divisor` report
...
- **No `DBARTS_C_API_MINOR` bump and no hash re-bake.** `dbarts_apiHash()` is
  ...
  "after 1.0-0" and we are before it. [inst/tinytest/test-capi.R:59](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-capi.R#L59)'s literal hash pin
...
The mandate, verified verbatim at `docs/plans/archive/multiforest-extension-surface.md`
...
- **The data route.** `dbartsData(x, y, bases = list(b))` - `validateForestBases`
  ([R/data.R:635-668](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/data.R#L635-L668)) imposes no length floor, `R/spec.R`'s
...
- **The forests route.** `dbarts(x, y, forests = list(forest(basis = ~z)))`
  does NOT reach that error. `forestBasisDeclarations` ([R/model.R:689-692](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/model.R#L689-L692))
  returns NULL on `length(forests) < 2L`, so [R/dbarts.R:542-561](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L542-L561) never sets
  ...
  `firstForest$n.trees`/`interactions`/`blocks` ([R/spec.R:217-226](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L217-L226)). **The
  declared basis is SILENTLY DROPPED and an ordinary single-forest model is
  fit.** Same on `dbartsSpec` ([R/spec.R:653-664](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L653-L664), the same helper).
...
1. **Drop `forestBasisDeclarations`' `length(forests) < 2L` floor to
   ...
   `resolveForests`' existing refusal - so [inst/tinytest/test-bcf-creation.R:713](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L713)
   ...
   afterwards `hasBasis` is TRUE so [R/model.R:849](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/model.R#L849)'s branch is skipped and the
   ...
   already carries K >= 2 bases: [R/spec.R:405-410](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L405-L410) replaces `data@bases` with
...
- `docs/design/bcf.md`: the two "median 2 sd(y)" statements
  ([R/spec.R:94](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L94), [R/spec.R:272-274](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L272-L274)) gain the latent-family qualifier; `sd.control` /
...
- `docs/design/feature-matrix.md`: per-landing check, and it is NOT vacuous at
  ...
  `[f16]` (body from [R/spec.R:368](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L368) at tip `ffb9959c`) enumerates what
...
1. `src/bartcore/chain.hpp`: `ForestCalibration` gains
   ...
   the two state-install sites ([src/bartcore/chain.hpp:3235](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3235) and [src/bartcore/chain.hpp:3323](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3323)): the
...
5. **[inst/tinytest/test-calibration-midchain.R:41-58](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-calibration-midchain.R#L41-L58)**: the shipped pins
...
6. **`inst/tinytest/capi/consumer.c` plus `inst/tinytest/test-capi.R`**: a NEW
   partial-`structSize` leg. The existing one ([inst/tinytest/capi/consumer.c:807](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/capi/consumer.c#L807)) sets
...
7. **`docs/design/feature-matrix.md` `[f16]`**, the `nameable calibration`
   footnote, whose body begins at [inst/tinytest/capi/consumer.c:368](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/capi/consumer.c#L368) at tip `ffb9959c` (re-derived at the
...
1. `inst/tinytest/test-bcf-family.R`, beside the existing anchor block (it
   ...
   EXTENDS the `1.0 * s / (0.674 * ...)` assertion at [inst/tinytest/capi/consumer.c:109-113](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/capi/consumer.c#L109-L113) whose literal
...
2. `inst/tinytest/test-forest-basis-r5.R`, in the `probitForests()` block
   ([inst/tinytest/capi/consumer.c:335-372](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/capi/consumer.c#L335-L372)): the same fixture, then `$setForestBasis(2, 7 * zBasis)`, then
...
3. `tests/cpp`, a new `testBCFCalibrationMap` (natural home:
   ...
   block, and [tests/cpp/test_sampler.cpp:5982-6009](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/tests/cpp/test_sampler.cpp#L5982-L6009) a BCF calibration READER block that
...
5. `inst/tinytest/test-bcf-creation.R`: transport pins that
   ...
   [inst/tinytest/test-bcf-creation.R:400](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L400) (`forest(sd = 3.5)` into `params[[1]][7]`) and
   [inst/tinytest/test-forest-basis-r5.R:196-205](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L196-L205) (the `params[[f]][6:7]` ridge derivation),
   both of which are gaussian - under a latent family for the first time.

### What S2 adds on top

- The K-invariance assertion. [inst/tinytest/test-bcf-family.R:118-125](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-family.R#L118-L125) currently asserts
...
- **F6 (S1).** A flat-C caller with a PRE-S1 `structSize` - set to
  ...
  pre-`leafModel` one at [inst/tinytest/capi/consumer.c:924-931](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/capi/consumer.c#L924-L931) - still reads the EIGHT original fields and
...
6. **The census's K = 1 statement is right about one route and wrong about the
   ...
   opening `forestBasisDeclarations` ([R/model.R:689-692](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/model.R#L689-L692), floor
   `length(forests) < 2L`), [R/dbarts.R:542-561](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L542-L561) and [R/spec.R:206-226](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/spec.R#L206-L226): that
...
`resolveForests` returns at [R/model.R:811](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/model.R#L811) on `forests = NULL` and so cannot
see the `dbartsData(bases = )` route. Re-tracing the OTHER route by opening
`forestBasisDeclarations` ([R/model.R:689-692](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/model.R#L689-L692)) shows it does not reach the
...
`< 1L` (verified not to disturb [inst/tinytest/test-bcf-creation.R:713](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-bcf-creation.R#L713)'s existing refusal,
...
[inst/tinytest/test-calibration-midchain.R:41-58](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-calibration-midchain.R#L41-L58)'s `c(2L, 7L)` and exact
...
pre-`leafModel` leg at [inst/tinytest/capi/consumer.c:924-931](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/capi/consumer.c#L924-L931). Both are listed in "Shipped-surface deltas" as
...
through `[f16]`, whose body was re-derived at tip `ffb9959c` ([inst/tinytest/test-calibration-midchain.R:368](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-calibration-midchain.R#L368)) rather
...
paths: `installForest` ([src/bartcore/chain.hpp:3235](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3235)) and the restore path ([src/bartcore/chain.hpp:3323](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L3323)) each
...
overwrites `glue_.prior[f].variance` ([src/bartcore/combiner.hpp:1044-1045](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/combiner.hpp#L1044-L1045)); neither
mutator carries a BCF refusal ([R/dbarts.R:1580](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L1580), [R/dbarts.R:1612](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/dbarts.R#L1612)) and
[inst/tinytest/test-forest-basis-r5.R:110-136](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L110-L136) already drives `setState` on a K-forest
...
BCF c(2L, 7L) at [inst/tinytest/test-forest-basis-r5.R:375](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L375) and the multinomial c(1L, 7L) at [inst/tinytest/test-forest-basis-r5.R:391](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L391), moved with
...
never cleared -> test-forest-basis-r5 [inst/tinytest/test-forest-basis-r5.R:453](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L453), [inst/tinytest/test-forest-basis-r5.R:454](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L454), [inst/tinytest/test-forest-basis-r5.R:456-461](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L456-L461) move (the
two NaN columns and the non-computable anchor); F8(b) cleared on ANY
install, the bitwise comparison dropped -> [inst/tinytest/test-forest-basis-r5.R:468](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L468), [inst/tinytest/test-forest-basis-r5.R:469](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L469) (forest 1's
columns surviving a foreign install) and [inst/tinytest/test-forest-basis-r5.R:508](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L508), [inst/tinytest/test-forest-basis-r5.R:509](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L509), [inst/tinytest/test-forest-basis-r5.R:511-518](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L511-L518) (the
self-restore arm) move; F8(c) setForestBasis's re-imposition removed ->
[inst/tinytest/test-forest-basis-r5.R:484](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L484), [inst/tinytest/test-forest-basis-r5.R:485](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L485), [inst/tinytest/test-forest-basis-r5.R:487-494](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L487-L494) move; F8(d) adoptInstalledAmplitudePriors made a
no-op -> [inst/tinytest/test-forest-basis-r5.R:475](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-forest-basis-r5.R#L475) moves, the donor's 0.125 read back as the recipient's
0.5. F6 in two arms, since its two halves fail differently: (i)
DBARTS_HAS_FIELD's >= weakened to > inside the calibration FILL ->
test-capi.R's own three sites - none placeable at this sha (unresolved: [inst/tinytest/test-capi.R:963-965](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-capi.R#L963-L965), unresolved: [inst/tinytest/test-capi.R:1001](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-capi.R#L1001) and the flat-C BCF leg, unresolved: [inst/tinytest/test-capi.R:1123-1125](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/inst/tinytest/test-capi.R#L1123-L1125)) - move;
