...
reserved 2026-08-10 (docs/plans/archive/zero-weight-exactness.md S2 adding the
...
`docs/plans/archive/multiforest-predictor-mutation.md` (SL through S4) widened
...
`docs/plans/archive/multinomial-counts-mutation.md` (S1-S5) added a counts mutation
...
3. **SUPERSEDED.** Whatever tagged struct the reshape adopts must PRESERVE
   ...
   `docs/plans/archive/multiforest-mutation-gaps.md`) - the reshape is exactly where a
...
`docs/plans/archive/dbarts-h-reshape.md` S1 items 7-8 (`docs/plans/nameable-calibration.md`
