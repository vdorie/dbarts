...
accepted predictor mutation (assignIntoPredictorSource, [R/mixedMatrix.R:273](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/mixedMatrix.R#L273)) -
...
- The engine keeps NO predictor matrix. The only owned raw is the
  leaf-covariate gather ([src/bartcore/data.hpp:193](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/src/bartcore/data.hpp#L193) gatheredRawColumns, populated by
...
- Off-hot-path raw consumers take raw AT CALL TIME from the live R slot:
  setCutPoints ([R/bartcore.R:318](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L318)), setState ([R/dbarts.R:1089](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/dbarts.R#L1089), [R/dbarts.R:1113](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/dbarts.R#L1113)), getTrees
  saved-tree replay ([R/dbarts.R:1243](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/dbarts.R#L1243)), all via rawPredictorMatrix(data@x)
  ([R/utility.R:371](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/utility.R#L371)). PROT_DATA is the create-time GC anchor for the flat-C
...
- data@x for a frame fit is a dbartsMixedMatrix dense flavor: a per-column
  list ([R/mixedMatrix.R:1-20](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/mixedMatrix.R#L1-L20)). Accepted mutations keep it CURRENT via
  assignIntoPredictorSource. extract(sampler, "predictors") reads it
  ([R/generics.R:823](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/generics.R#L823)) - already container-authoritative, already current.
- The interim copy, per site:
  - full-column updatePredictor ([R/bartcore.R:176](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L176)): assignIntoPredictorSource
  ...
  - per-observation partial ([R/bartcore.R:94](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L94)) and jointly
    ([R/updatePredictorPerObservationJointly.R:88](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/updatePredictorPerObservationJointly.R#L88)): the inherent O(n) merge
    (old-at-!installed, new-at-installed) - no EXTRA copy beyond it.
  - full-MATRIX setPredictor ([R/bartcore.R:123-129](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L123-L129)): already a pointer swap
    (`sampler$data@x <- x`), essentially reference-install already.
  - test predictor column update ([R/bartcore.R:353](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L353)): copy-modifies the x.test
...
- WHICH object mutates: the R5 sampler's data@x slot is reassigned to a
  ...
  [inst/tinytest/test-sampler-predictors.R:61-67](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/inst/tinytest/test-sampler-predictors.R#L61-L67) stays green, no assertion change).
...
- The engine's per-observation session ([src/bartcore/sampler.hpp:912](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/src/bartcore/sampler.hpp#L912)
  ...
  bridge ([src/R_interface_bartcore.cpp:2296](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/src/R_interface_bartcore.cpp#L2296)) returns the `installed` LGLSXP mask
  unchanged; the R5 partial path returns it ([R/bartcore.R:100](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L100)). Plan 3 keeps
...
- The jointly path ([src/bartcore/facade.hpp:325](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/src/bartcore/facade.hpp#L325) updatePredictorPerObservationJointly, one
  shared column across samplers, index-aligned) keeps its per-sampler
  write-back loop ([R/updatePredictorPerObservationJointly.R:87](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/updatePredictorPerObservationJointly.R#L87)); each sampler
...
([R/bartcore.R:353](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L353)). There is no reference-install win to take: x.test stays a
...
stays pure R over the container ([R/generics.R:823](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/generics.R#L823)) and is already current for
...
1. Reference-install helper + full-column and full-matrix rewire (R).
   ...
   updatePredictor column branch ([R/generics.R:176](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/generics.R#L176)) and the full-matrix branch ([R/generics.R:123](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/generics.R#L123))
...
2. Per-observation partial + jointly rewire (R). [R/bartcore.R:94](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L94) and
   [R/updatePredictorPerObservationJointly.R:87](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/updatePredictorPerObservationJointly.R#L87) install by reference; the
...
3. Comments + extract Rd + data@x contract (R + docs). Strike the "interim
   of design plans 1-2 / until plan 3" comments ([R/bartcore.R:92](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L92), [R/bartcore.R:172](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/bartcore.R#L172),
   [R/updatePredictorPerObservationJointly.R:84](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/updatePredictorPerObservationJointly.R#L84), [R/mixedMatrix.R:265](https://github.com/vdorie/dbarts/blob/f7efebf482c0a69b2648dfca0ad01e6d0a0f451c/R/mixedMatrix.R#L265)) for the
