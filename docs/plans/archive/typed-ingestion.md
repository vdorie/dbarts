...
copies ([src/bartcore/chain.hpp:459](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/chain.hpp#L459)/644/682). 7 ColumnStore builders; 8 facade
...
written ONLY by buildMixed ([src/bartcore/data.hpp:884](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/data.hpp#L884)) / buildTestMixed ([src/bartcore/data.hpp:1030](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/data.hpp#L1030)) -
...
NULL-currentPredictors funnel ([R/dbarts.R:1241](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/R/dbarts.R#L1241)/[R/dbarts.R:1399](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/R/dbarts.R#L1399) -> the bridge,
unresolved: [src/R_interface_bartcore.cpp:4146](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/R_interface_bartcore.cpp#L4146)). NOT reachable before 2a. Pure dgCMatrix (ownedCsc*) and
...
([tests/cpp/test_model.cpp:3040](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/tests/cpp/test_model.cpp#L3040), an expected test change, folded in). The
...
1. Engine: buildMixed copies its dense block into a new
   ...
   per-observation IRT path, [src/bartcore/sampler.hpp:1352](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/sampler.hpp#L1352) - one cell, not a
...
2. tests/cpp: mutate a dense-backed column of a mixed store, then
   ...
   ([tests/cpp/test_model.cpp:3040-3043](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/tests/cpp/test_model.cpp#L3040-L3043), rawColumn(0) == denseSource.data())
...
1. Engine, view + builders: define PredictorSource with a
   ...
   to the view (createDataHandle, [src/R_interface_bartcore.cpp:2549](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/R_interface_bartcore.cpp#L2549),
   and Sampler::setData, [src/bartcore/sampler.hpp:947](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/sampler.hpp#L947)). buildTest and
...
2. Engine, SamplerOptions: the 8 typed ingestion fields collapse to
   ...
   (sampler.hpp, and the Chain copies at [src/bartcore/chain.hpp:459](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/chain.hpp#L459)/644/682).
3. Engine, test + mutation entrances: SamplerBase keeps ONE virtual
   ...
   values + k * n ([src/bartcore/sampler.hpp:1157](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/sampler.hpp#L1157)/1209/1228/1265). Facade
...
4. Bridge: ParsedData carries one PredictorSource (plus one for the
   ...
   bartcore_setData:3284 (slice-0 memory safety). [src/bartcore/facade.hpp:556](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/facade.hpp#L556)'s
   pure-CSC predicate is RE-DERIVED, not renamed - a bare dgCMatrix
   now carries a ~j map, so the old spelling goes false (the
   per-column check at [src/bartcore/facade.hpp:565](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/src/bartcore/facade.hpp#L565) happens to preserve the outcome, but
...
6. tests/cpp: collapsed builders bit-identical to the ones replaced -
   ...
   [tests/cpp/test_model.cpp:2189](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/tests/cpp/test_model.cpp#L2189) fixture shape; buildFromCsc is deleted in
...
7. tinytest: the door's acceptance (whole-matrix setPredictor over a
   ...
   [inst/tinytest/test-data-sparse.R:133-137](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/inst/tinytest/test-data-sparse.R#L133-L137) and [inst/tinytest/test-data-mixed.R:171-179](https://github.com/vdorie/dbarts/blob/3d1224662db39e8134e045902888865a47d07364/inst/tinytest/test-data-mixed.R#L171-L179) flipped
