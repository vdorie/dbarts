...
- Design docs: `docs/design/bcf.md`, `docs/design/forest-combiner.md`,
  ...
  `docs/plans/archive/forest-combiner.md` (the mandated BCF oracle set),
  `docs/plans/archive/zero-weight-exactness.md`, `docs/plans/archive/c-api-growth.md`.
...
1. **Widen** `dbarts_sampler_setResponse` to
   ...
   (the `dbarts_results` precedent in `docs/plans/archive/c-api-growth.md`, where a
...
2b. **Guard `dbarts_sampler_predict` and `dbarts_sampler_setTestPredictors`
   ...
   `refuseMultiForestMutation` ([src/C_interface.cpp:306](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L306)). This is NOT two lines.
...
`docs/design/public-surface.md`; `docs/plans/archive/c-api-growth.md` (the reshape
...
- `bcf-public-surface`: replace the entry with the landing record - plan doc
  ...
  and the naming VD chose. Correct its own stale anchor [R/bartcore.R:536](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/bartcore.R#L536) to
...
- `multiforest-predictor-mutation`: its two anchors are STALE -
  [src/R_interface_bartcore.cpp:1909-1923](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1909-L1923) is now
  `refuseMultiForestTransactionalUpdate`, and [src/bartcore/chain.hpp:1484](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L1484) is now
  `Chain::revalidateTrees`. Also strike "The BCF half is only consumable behind
  bcf-public-surface" once this arc lands.
- `docs/design/model-space-survey.md` D3: same stale [R/bartcore.R:536](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/bartcore.R#L536); mark
...
5. **The critique's A8 first item is OVERTURNED.** It reported citation drift on
   [src/bartcore/combiner.hpp:636](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/combiner.hpp#L636)`/445/250` -> "live 637/446/251". At b374d9e those three
...
the landing commits and corrects its stale [R/bartcore.R:536](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/bartcore.R#L536) anchor to [R/bartcore.R:629](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/R/bartcore.R#L629)
...
relocation arc's plan is `docs/plans/archive/bcf-bartcause-relocation.md`, which carries
...
amended. Full landing notes: `docs/plans/archive/bcf-bartcause-relocation.md`,
Landing notes.
