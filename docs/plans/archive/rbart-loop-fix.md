...
- The loop: [R/rbart.R:490-529](https://github.com/vdorie/dbarts/blob/5274c685c1bf469018e0c4e0fca4adada712013c/R/rbart.R#L490-L529) (one run(0L, 1L) per kept sample at
  [R/rbart.R:505](https://github.com/vdorie/dbarts/blob/5274c685c1bf469018e0c4e0fca4adada712013c/R/rbart.R#L505), ranef/tau draws between, offset reinstalled through the
  mutation surface); the warm-up sweeps at [R/rbart.R:775](https://github.com/vdorie/dbarts/blob/5274c685c1bf469018e0c4e0fca4adada712013c/R/rbart.R#L775) and [R/rbart.R:809](https://github.com/vdorie/dbarts/blob/5274c685c1bf469018e0c4e0fca4adada712013c/R/rbart.R#L809) stay as-is.
...
- Bridge RNG sync: bartcore_run wraps GetRNGstate/PutRNGstate
  ([src/R_interface_bartcore.cpp:975-982](https://github.com/vdorie/dbarts/blob/5274c685c1bf469018e0c4e0fca4adada712013c/src/R_interface_bartcore.cpp#L975-L982)). An R closure drawing from
...
- The per-sample bookkeeping the loop does R-side (assignInPlace
  slices at [src/R_interface_bartcore.cpp:529](https://github.com/vdorie/dbarts/blob/5274c685c1bf469018e0c4e0fca4adada712013c/src/R_interface_bartcore.cpp#L529) and kin) moves into the closure unchanged.
