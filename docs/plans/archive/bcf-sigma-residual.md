...
([src/bartcore/chain.hpp:329-330](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L329-L330)); both forests start all-zero fits (buildBCFForest,
[src/bartcore/chain.hpp:2095-2096](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L2095-L2096)); sigma_ = initialSigma() = sigest/range ([src/bartcore/chain.hpp:468](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L468),
[src/bartcore/model.hpp:1908](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/model.hpp#L1908)). Across SBC reps the sampler is reused: sampleTreesFromPrior /
sampleNodeParametersFromPrior redraw only the forests ([src/bartcore/chain.hpp:899-957](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L899-L957)) and
setResponse(updateScale=FALSE) reuses the fixed build scale ([src/bartcore/model.hpp:1936-1946](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/model.hpp#L1936-L1946))
...
- a*mu AMPLITUDE is correct by sweep ~10 for every a0 (a0=6: amuSd 1.13@sw10 vs
  ...
  ~a0 in one conjugate drawGlue ([src/bartcore/chain.hpp:2147-2157](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L2147-L2157)); the a-ridge move then just
...
- (a) a-init: opt-in possible (default a=1 preserved). Smallest diff: BCFSpec
  gains aInit ([src/bartcore/chain.hpp:314](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L314)), BCFState init reads it ([src/bartcore/chain.hpp:482-487](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L482-L487)),
  bridge bcfParams grows to 9 ([src/R_interface_bartcore.cpp:1202](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/R_interface_bartcore.cpp#L1202), [src/R_interface_bartcore.cpp:1228-1241](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/R_interface_bartcore.cpp#L1228-L1241)),
  bartcoreBCFSampler gains a.init ([R/bartcore.R:419](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/R/bartcore.R#L419)). Data-dependent init is
...
- (c) longer burn: changes NO draw law -- more of the same chain. Smallest
  ...
  thinned ([src/bartcore/chain.hpp:642](https://github.com/vdorie/dbarts/blob/7e5b46a02e6cfc2eeda381272344e94e102b52f0/src/bartcore/chain.hpp#L642) totalIterations = (burn + samples) * thin). Plus a
