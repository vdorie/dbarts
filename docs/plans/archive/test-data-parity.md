...
rng: neutral, EVERY step. Test data never enters a draw: tree proposals and
  ...
  ([src/bartcore/chain.hpp:2396-2410](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2396-L2410)). Storage and codes may move; no draw can. Gate:
...
- dbarts.h is FROZEN and its test entries are DENSE double* by signature:
  dbarts_sampler_setTestPredictors ([inst/include/dbarts/dbarts.h:185](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/inst/include/dbarts/dbarts.h#L185)), _predict (197),
...
- The engine keeps test raw only where a leaf model reads it. Linear/gp leaves
  gather standardized test covariates (uTest_, [src/bartcore/model.hpp:266](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/model.hpp#L266), [src/bartcore/model.hpp:669](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/model.hpp#L669)) via
  rawTestColumn ([src/bartcore/data.hpp:247](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L247)); a sparse-BACKED test column REFUSES the leaf
...
- Views DENSIFY. buildFromParent gathers a fold's test rows through the
  storage-aware codeAt ([src/bartcore/data.hpp:859-864](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L859-L864)) into dense codes; a fold has no
  external x.test (createFromParent, [src/R_interface_bartcore.cpp:1532-1690](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/R_interface_bartcore.cpp#L1532-L1690), takes
...
- Codes are identical across storage. A dense factor and a sparseFactor of the
  ...
  reference level's ACTUAL level-order code (quantizeCscColumn, [src/bartcore/data.hpp:514](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L514),
...
- Test storage today ([src/bartcore/data.hpp:184-193](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L184-L193)): numTestObservations, ownedTestValues
...
- buildTest ([src/bartcore/data.hpp:750](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L750)) copies the dense raw and quantizes every column into
...
- Descent reads a materialized row: findBottomNodeForRow(data, xt) indexes
  xt[rule.variableIndex] ([src/bartcore/tree.hpp:846](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/tree.hpp#L846)); its six call sites pass data_.testRow(i)
  ([src/bartcore/chain.hpp:1107](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L1107), [src/bartcore/chain.hpp:1120](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L1120), [src/bartcore/chain.hpp:1137](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L1137), [src/bartcore/chain.hpp:2144](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2144), [src/bartcore/chain.hpp:2176](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2176), [src/bartcore/chain.hpp:2216](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L2216)). A sparse test column has no
...
- Training container the test side mirrors: ColumnStore per-column dense codes,
  SparseColumnData rank bitmap ([src/bartcore/data.hpp:95-108](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/data.hpp#L95-L108)), cscSlices for re-quantize
...
- R: @x.test is matrixOrNULL ([R/A_class.R:402](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/A_class.R#L402)), validity ncol==ncol(x)
  (469-487). validateXTest ([R/data.R:38-126](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/data.R#L38-L126)) densifies sparse-factor test columns
  (densifySparseFactorColumns, [R/utility.R:420](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/utility.R#L420) - the interim this plan retires)
  then builds a dense code matrix over the TRAINING levels
  (mapFactorColumnsToTrainingLevels [R/utility.R:437](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/utility.R#L437), makeCategoricalModelMatrix
  274). The training container is assembled by assembleMixedMatrix
  ([R/mixedMatrix.R:115](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/mixedMatrix.R#L115): dense list + dgCMatrix + map + sparse metadata);
...
1. Typed per-column test store + storage-aware descent (engine; dense input,
   ...
   Change findBottomNodeForRow to descend via testCodeAt ([src/bartcore/tree.hpp:846](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/tree.hpp#L846)) and its
   ...
   unchanged; buildTest/rawTestColumn contracts updated ([tests/cpp/test_data.cpp:258-267](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/tests/cpp/test_data.cpp#L258-L267),
...
3. Ingest a test container (R + bridge). @x.test accepts a dbartsMixedMatrix
   ...
   test-side gate ([inst/tinytest/test-sparse-factor.R:282-322](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/inst/tinytest/test-sparse-factor.R#L282-L322), sparse-cat x.test ==
...
4. setTestPredictor / setTestOffset container mutation (R + bridge).
   ...
   ([R/bartcore.R:326](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L326), [R/bartcore.R:602](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L602)) routes a frame/sparse test set through the step-3
   ...
   values, [R/bartcore.R:326-359](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L326-L359)) stays unchanged on a dense-matrix x.test:
...
- THE TEST-FIT ORACLE (sufficiency): for any dataset expressible both ways, the
  ...
  to the dense-matrix / densified x.test - [inst/tinytest/test-sparse-factor.R:282-322](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/inst/tinytest/test-sparse-factor.R#L282-L322) extended
...
([inst/tinytest/test-sparse-factor.R:282-322](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/inst/tinytest/test-sparse-factor.R#L282-L322) extended to resident storage, plus new
