...
follow-up the C7 landing filed (docs/plans/archive/multinomial.md C7 scope-narrowings;
...
- The current refusal: the multinomial branch rejects a formula or dbartsData
  outright ([R/bart.R:466-470](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/bart.R#L466-L470), "supports the matrix interface only this arc") and
...
- The standard formula parse ([R/data.R:454-522](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/data.R#L454-L522)): model.frame -> `model.response(
...
- Family is NEVER auto-detected for multinomial: dbarts() resolves "auto" ->
  probit for a 0/1 response ([R/dbarts.R:285-294](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/dbarts.R#L285-L294)) and multinomial is not in its
  family list; bart2 dispatches multinomial only on the EXPLICIT family =
  "multinomial" ([R/bart.R:429](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/bart.R#L429)). A multi-level factor LHS under "auto" stays
  gaussian/probit as today - Q1.
- predict.bartMultinomial ([R/generics.R:467-492](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/generics.R#L467-L492)) codes newdata through
...
- packageMultinomialResults ([R/bart.R:770-814](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/bart.R#L770-L814)) and shapeMultinomialChannel
...
Extend the multinomial branch ([R/bart.R:429](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/bart.R#L429)) to accept a formula:
...
1. Remove the 466-470 refusal. When `formula` is a formula (or a one-sided
   ...
   term labels (the [R/data.R:498-509](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/data.R#L498-L509) recipe).
...
C2. Docs + Rd. Update man/bart2.Rd (the formula interface now supports family =
   ...
   defined); mark landed in docs/plans/archive/multi-forest-models.md and the TODO; this
...
- Q1 (auto-detect a multi-level factor LHS as multinomial?). RECOMMEND NO - keep
  ...
  to probit under the binary path ([R/dbarts.R:285-294](https://github.com/vdorie/dbarts/blob/6a48351bd533cfc8a652abb0f183ab48478b0247/R/dbarts.R#L285-L294)), and silently routing a
