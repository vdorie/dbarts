...
3. **A category offset enters the raw fits BEFORE the softmax, never after the
   ...
   `refuseMultiForestMutation` ([src/C_interface.cpp:330](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L330)), NOT
   `refuseMultiForestTestOffset`, which is R-bridge-only
   ([src/R_interface_bartcore.cpp:2345](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L2345), called at [src/R_interface_bartcore.cpp:3959](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3959) and [src/R_interface_bartcore.cpp:3988](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3988)). Both refuse
...
- Live bridge entries (`R_interface_bartcore.cpp` at f737702), since the
  multiforest arc moved every one of them: `setTreatment` [src/R_interface_bartcore.cpp:3295](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3295),
  `setForestWeights` [src/R_interface_bartcore.cpp:3319](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3319), `setOffset` [src/R_interface_bartcore.cpp:3782](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3782), `setResponse` [src/R_interface_bartcore.cpp:3800](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3800),
  `setSigma` [src/R_interface_bartcore.cpp:3825](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3825), `setData` [src/R_interface_bartcore.cpp:3832](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3832), `setTestOffset` [src/R_interface_bartcore.cpp:3951](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3951),
  `setTestPredictorAndOffset` [src/R_interface_bartcore.cpp:3974](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L3974), `setWeights` [src/R_interface_bartcore.cpp:4037](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L4037), `setControl` [src/R_interface_bartcore.cpp:4059](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L4059),
  `setModel` [src/R_interface_bartcore.cpp:4089](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L4089), `setPredictor` [src/R_interface_bartcore.cpp:4195](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L4195), `predict` [src/R_interface_bartcore.cpp:4884](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L4884) (whose offset guard
  now lives in the shared `predictFromSource` [src/R_interface_bartcore.cpp:4785](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L4785), predicate unchanged:
  `offset != NULL && numLocations > 1`). Every multinomial combiner anchor is
  intact, line-shifted: `drawForestGlue` [src/R_interface_bartcore.cpp:800](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L800) (`lastF_ = f` [src/R_interface_bartcore.cpp:833](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L833)),
  `formForestResponse` [src/R_interface_bartcore.cpp:854](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L854), `combinedFits` [src/R_interface_bartcore.cpp:870](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L870), `combinedTestFits` [src/R_interface_bartcore.cpp:885](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L885),
  `blendSoftmax` [src/R_interface_bartcore.cpp:995](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L995), `counts_` [src/R_interface_bartcore.cpp:1018](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1018), `trials_` [src/R_interface_bartcore.cpp:1019](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1019), the per-sweep scratch
  [src/R_interface_bartcore.cpp:1020-1025](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L1020-L1025), `ForestCombiner::supportsResponseMutation` [src/R_interface_bartcore.cpp:427](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L427). The
...
- **A mutation-time `totalFits` writer the original reading predates.**
  `Chain::revalidateTrees` / `rebuildFitsFromParameters` ([src/bartcore/chain.hpp:1572-1830](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L1572-L1830),
...
- `combinedFits()` is called THREE times per recorded sweep-equivalent, and
  still exactly three at f737702: [src/bartcore/chain.hpp:1125](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L1125) post-forest-loop
  (pre-`afterCombine`), [src/bartcore/chain.hpp:4368](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L4368) inside `storeSample` (which runs AFTER
  `afterCombine`), and [src/bartcore/chain.hpp:1443](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L1443) in `growForestFromRoot`. Any per-column
  lazy refresh scheme leaves the last category stale at all three.
  `combinedTestFits` has one call site, [src/bartcore/chain.hpp:4405](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L4405).
...
- `predictFromSavedSampleMulti` and `predictFromCurrentTreesMulti`
  ([src/bartcore/chain.hpp:2282](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L2282) / [src/bartcore/chain.hpp:2310](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L2310)) build their own raw slab and call
...
2. `raw_` is maintained ONLY under an offset, as
   ...
   **The full-rematerialization pair is load-bearing for a second reason the
   ...
   ([src/bartcore/chain.hpp:1572-1830](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L1572-L1830)) rewrite `totalFits` at PREDICTOR-MUTATION time,
...
1. Engine: `ForestCombiner::setCounts` base virtual (inert) plus the
   ...
   already is K for multinomial ([src/bartcore/facade.hpp:42-44](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/facade.hpp#L42-L44)) and 1 for every additive
...
5. **Message repair (B3): the response conduit.** The guard is no longer an
   ...
   updateScale)` ([src/R_interface_bartcore.cpp:2483](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L2483), declared in
   `R_interface_bartcore_common.hpp`), and the FLAT C entries call the same
   helper ([src/C_interface.cpp:206](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L206) / [src/C_interface.cpp:226](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L226) / [src/C_interface.cpp:238](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L238)). So the repair goes inside the
   ...
   [src/C_interface.cpp:231-282](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L231-L282), which pins `setResponse` at both `updateScale`, `setOffset` at
...
arm at [src/C_interface.cpp:298-310](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L298-L310)), so the new `supportsCountsMutation` field is not optional
...
1. Engine: `rawTest_` and `rawTestFits` inside `combinedTestFits`; the
   ...
   (`predictFromSavedSampleMulti` [src/bartcore/chain.hpp:2282](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L2282), `predictFromCurrentTreesMulti`
   [src/bartcore/chain.hpp:2310](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/bartcore/chain.hpp#L2310) - both now `template <typename Columns>` over a borrowed predictor
...
2. Bridge: `bartcore_setCategoryTestOffset`; the creation-side test-offset lift
   ...
   ([src/C_interface.cpp:330](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/C_interface.cpp#L330)) - the R-bridge-only `refuseMultiForestTestOffset`
   ([src/R_interface_bartcore.cpp:2345](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L2345)) is the guard this slice conditions, not the
...
2. Re-record to `multinomial-equivalence-<hash>.rds`; mark
   ...
   absent.
3. Re-pin the three CI legs in `.github/workflows/equivalence.yaml` - [src/R_interface_bartcore.cpp:61](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L61)
   (gaussian, `equivalence-a825263.rds --strict-coverage`), [src/R_interface_bartcore.cpp:87](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L87) (bcf,
   `bcf-equivalence-a825263.rds`), [src/R_interface_bartcore.cpp:113](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L113) (multinomial) - so the multinomial line
...
[src/R_interface_bartcore.cpp:5239](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L5239) - predict's missing-offset refusal
...
the [src/R_interface_bartcore.cpp:5239](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/src/R_interface_bartcore.cpp#L5239) predicate fix + pin; bartcoreForestFits reports
...
[.github/workflows/equivalence.yaml:113](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/.github/workflows/equivalence.yaml#L113) re-pinned, [.github/workflows/equivalence.yaml:61](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/.github/workflows/equivalence.yaml#L61)/[.github/workflows/equivalence.yaml:87](https://github.com/vdorie/dbarts/blob/4c018187036ff83eddde8308f243ed6584268004/.github/workflows/equivalence.yaml#L87) correctly untouched.
...
clear ([inst/tinytest/test-multinomial-r5-surface.R:296](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/inst/tinytest/test-multinomial-r5-surface.R#L296)) never sweeps after.
