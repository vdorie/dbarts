...
1. **The b-ridge fork is DISSOLVED - there is no fork.** It was to be put on
   ...
   RESOLVED (`docs/plans/archive/bcf-sigma-residual.md:2-6`, `INDEX.md:20`; no `TODO`
...
repo:** `docs/plans/archive/bcf-ridge-interweaving.md:494-499`, from the arc that BUILT
