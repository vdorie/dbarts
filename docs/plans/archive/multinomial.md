...
- The combiner landed in chain.hpp beside Forest<L>: ForestCombiner<L> base
  ([src/bartcore/chain.hpp:394-439](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L394-L439)) and BCFForestCombiner<L> (447-...). The virtuals a second
  ...
  at [src/bartcore/chain.hpp:963](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L963) with the partially-updated forests_), combinedFits (405),
...
- The single n-vector combined output, the seam the design note flags
  ...
  returns const double* ([src/bartcore/chain.hpp:2498](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L2498), single-forest arm 2499-2500 returns the
  ...
  n x numSamples ([src/R_interface_bartcore.cpp:1987](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/R_interface_bartcore.cpp#L1987)) and testFits as nTest x numSamples
  (1996). refreshLatents/drawSigma take one location ([src/bartcore/chain.hpp:1054-1065](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L1054-L1065)) - but
...
- Per-forest fits already reach K forests generically: getForestFits(forest) ->
  ...
  numForests() ([src/R_interface_bartcore.cpp:1924-1938](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/R_interface_bartcore.cpp#L1924-L1938); [src/bartcore/facade.hpp:146](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/facade.hpp#L146)). The
  BCF-shaped reporting (NaN-flag the scalar train/test channels, expose per-forest
  fits) is the precedent multinomial reuses ([src/bartcore/chain.hpp:2537-2554](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L2537-L2554),
  bcf-testfits-guard).
- The PG sampler: ext_rng_simulatePolyaGamma(rng, psi) draws PG(1, psi)
  (Devroye, [src/external/random.c:581](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/external/random.c#L581)); LogisticResponse::refreshLatents sums
  lround(w_i) draws and forms working response (y-0.5)/omega - offset
  ([src/bartcore/model.hpp:2231-2244](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/model.hpp#L2231-L2244)). MultinomialForestCombiner's per-category draw is this,
...
- Creation mirrors BCF: [R/bartcore.R:482](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/R/bartcore.R#L482) bartcoreBCFSampler packs a params vector
  + moderators, calls C_dbarts_bartcore_createBCF ([src/R_interface_bartcore.cpp:1879](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/R_interface_bartcore.cpp#L1879)),
  which builds a BCFSpec ([src/bartcore/chain.hpp:348](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L348)) and calls createBCFSampler
  ([src/bartcore/facade.hpp:499](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/facade.hpp#L499), single ConstantGaussianLeaf instantiation). The multinomial
  analog: bartcoreMultinomialSampler + C_dbarts_bartcore_createMultinomial +
  MultinomialSpec + createMultinomialSampler.
- ResponseModel is per-observation-single-location ([src/bartcore/model.hpp:1788](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/model.hpp#L1788)); multinomial
  ...
  computeLogLikelihood ([src/bartcore/chain.hpp:2586-2593](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L2586-L2593)) and cannot see the K-blend, so
  logLikelihoodIsDefined() = false is BCF's exact choice ([src/bartcore/chain.hpp:638](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L638)). The
  combiner owns the K interleaved PG draws, the per-forest working responses, and
  the level-centering move.
- State: the by-name block reader ([src/R_interface_bartcore.cpp:3317](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/R_interface_bartcore.cpp#L3317)
...
- Single-forest AND BCF hot paths pay nothing new. The location-count is 1 for
  ...
  single-forest arm ([src/bartcore/chain.hpp:2498-2501](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L2498-L2501)) stays the bare forests_[0].totalFits
...
C1. Extract combiner.hpp (pure motion; NEUTRAL). Move Forest<L>, ForestResponse,
   ...
   restoreGlue take ChainStateData& ([src/bartcore/chain.hpp:247](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L247)), BCFForestCombiner holds
...
C2. Location-count on the combined-output/reporting seam + the multi-forest
   ...
   ([src/R_interface_bartcore.cpp:2218](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/R_interface_bartcore.cpp#L2218), which guards only refuseViewSampler at 2221),
...
C4. The multinomial model, one gated commit. Sub-parts:
   ...
   to formForestResponse, called at forest k's turn [src/bartcore/chain.hpp:963](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L963) with the
   ...
   benign recorded exception, [src/bartcore/chain.hpp:610](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L610)). formForestResponse(k, ...) then forms
   ...
   response_->computeLogLikelihood(forest.totalFits..., [src/bartcore/chain.hpp:2586-2593](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L2586-L2593)) - ONE
   ...
   pi*sqrt(3) ~ 5.44 ([R/dbarts.R:401](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/R/dbarts.R#L401), [R/xbart.R:262](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/R/xbart.R#L262); pi/sqrt(3) ~ 1.81 is the WIDENING
   FACTOR over probit's 3.0, [R/dbarts.R:394-395](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/R/dbarts.R#L394-L395); negative-binomial.md confirms
   ...
   combiner branch (formForestResponse [src/bartcore/chain.hpp:1222-1227](https://github.com/vdorie/dbarts/blob/6fa909e7911511b81b32504638b0c0b3469e0024/src/bartcore/chain.hpp#L1222-L1227), drawGlue/afterCombine
