...
sdModerate * s / 0.674)` ([src/bartcore/chain.hpp:475](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L475)). buildBCFForest sets `k = 1`,
`updateK = false`, `useDart = false`, and
`leaf.scale = nodeScale / sqrt(numTrees)` ([src/bartcore/chain.hpp:2079-2083](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2079-L2083)). So with
`nodeScale_tau = sdModerate * s / 0.674` (s = scaledResponseSd,
[src/bartcore/chain.hpp:473](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L473); sdModerate default 1, kHalfNormalMedian = 0.674):
...
[src/bartcore/chain.hpp:558](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L558), but on forests_[1]). Keep the general `(k/scale)^2` form in
...
([src/bartcore/chain.hpp:2024](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2024), same rule as mu). So the free tau parameters are the
...
a-move does: `treeFits[t][indices[node.begin]]` ([src/bartcore/chain.hpp:549](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L549)).

### 1.2 The b prior -- a PLAIN Gaussian, NO auxiliary (contrast a)

drawGlue, [src/bartcore/chain.hpp:2162-2175](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2162-L2175). Unlike a (half-Cauchy via the inverse-gamma
...
prior with NO scale-mixture auxiliary:
    ...
    bPriorVariance = 0.5  (fixed; BCFState [src/bartcore/chain.hpp:313](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L313), [src/bartcore/chain.hpp:327](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L327); spec 480).

They are drawn JOINTLY in drawGlue (one `if (bcf_->updateB)` block,
[src/bartcore/chain.hpp:2162](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2162)): each is an independent conjugate normal from its own arm's
rows -- b0 from control rows (z=0), b1 from treated rows (z=1):
    ...
    b1 ~ N(n1/p1, 1/p1),  same over treated rows ([src/bartcore/chain.hpp:2163-2174](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2163-L2174)).
...
([src/bartcore/chain.hpp:2127-2128](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2127-L2128) combinedFits, 2136-2140 drawGlue; bcf.md). The mu forest
...
- **All-treated or all-control data**: if every z=1 (no control rows), b0 has
  ...
  (p0=1/sB2, n0=0, [src/bartcore/chain.hpp:2173](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2173)). b0 then multiplies tau only over control
...
- **1e-9 multiplier floor** (formForestResponse, [src/bartcore/chain.hpp:2114](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2114)): floors
...
- **updateB gating**: the move CHANGES b0, b1; gate on `bcf_->updateB` (the
  drawGlue-B guard, [src/bartcore/chain.hpp:2162](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2162)). If b is pinned the ridge is absent and the
...
Required:
- `bcf_->b0 *= 1.0/c;  bcf_->b1 *= 1.0/c`         ([src/bartcore/chain.hpp:324](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L324))
- `forests_[1].treeFits *= c` over all `n*T_tau` entries -- MANDATORY: next
  ...
  `forests_[1].treeFits.data()`, length `n*T_tau` ([src/bartcore/chain.hpp:572](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L572) analogue).
...
- this sweep's saved TAU tree slot was flattened with PRE-move leaf values; after
  ...
  trees by c ([src/bartcore/chain.hpp:588-597](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L588-L597) analogue, `node.variable == invalidVariable`),
...
([src/bartcore/chain.hpp:541-553](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L541-L553)). Cost O(Lt + total tau nodes).

Recording note: storeSample records `scale*(a mu + b_z tau)+shift`
([src/bartcore/chain.hpp:2195-2197](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/src/bartcore/chain.hpp#L2195-L2197)) which is INVARIANT -> trainingFits unaffected.
...
- `bcf-exact.R`, `bcf-exact-weak.R` MUST STAY EXACT: they match posterior
  ...
  move leaves unchanged. The three modes ([benchmarks/R/bcf-exact.R:16-18](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/benchmarks/R/bcf-exact.R#L16-L18), 379-413) are the
  clean gate:
    ...
    mode 2b (updateA=F, updateB=T): b-move ACTIVE (the b-move's headline gate) --
            ...
            with tau scale" ([benchmarks/R/bcf-exact.R:34](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/benchmarks/R/bcf-exact.R#L34)) is the very ridge this move
...
b-move for the sigma flag.
  ...
  2. The b-move itself: KEEP the derivation on the shelf as a SEPARATE,
     ...
     (exactly what the a-move is for the prognostic ridge; [benchmarks/R/bcf-exact.R:34](https://github.com/vdorie/dbarts/blob/9cebb35221ff0d932f126c1a8f710eb464fbc608/benchmarks/R/bcf-exact.R#L34) notes
