...
3. Exact-posterior gate, benchmarks/R/bcf-exact.R, following
   ...
   analog, [benchmarks/R/logistic-reference.R:63](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/benchmarks/R/logistic-reference.R#L63)); the joint space is the product.
...
- The engine mechanism is BUILT and proven. data-ownership-4 step 2
  ...
  moderatorsExpr argument parsed at [src/R_interface_bartcore.cpp:1339](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/R_interface_bartcore.cpp#L1339)-
...
- What does NOT exist yet, and is assigned here by data-ownership-4 Q2:
  (a) any user-facing `moderators` surface - [R/bartcore.R:485](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L485) passes a
...
- The BCF user surface is INTERNAL. bartcoreBCFSampler
  ([R/bartcore.R:453](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L453)) is the sole entry; it is unexported (not in
...
- Forest-addressed queries are partial. bartcore_getForestFits
  ([src/R_interface_bartcore.cpp:1653](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/R_interface_bartcore.cpp#L1653), R helper bartcoreForestFits) reads
  fits for any forest index via forestTotalFits; but getTrees/varcount
  address forest 0 only (getTrees at [src/R_interface_bartcore.cpp:3907](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/R_interface_bartcore.cpp#L3907) loops sampler.numTrees()
...
C1. The `moderators` argument on bartcoreBCFSampler (R only). Add
    `moderators = NULL` to bartcoreBCFSampler ([R/bartcore.R:453](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L453)).
    Default NULL = all columns = today's byte-for-byte draw (the
    literal NULL placeholder at [R/bartcore.R:485](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/R/bartcore.R#L485) is replaced by the resolved
...
- The step-3 interim "both forests read the full store (the moderator
  ...
  Landing above, [src/bartcore/chain.hpp:471](https://github.com/vdorie/dbarts/blob/4a52176065a83f73248b4334217683a8e9c10491/src/bartcore/chain.hpp#L471)) is DISCHARGED: data-ownership-4 step 2
