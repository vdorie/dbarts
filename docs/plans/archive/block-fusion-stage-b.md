...
(AtomMap::buildAggregateWrite, [src/bartcore/chain.hpp:798-806](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L798-L806)): an atom is one leaf, its
...
flag as the master enable of `useAtomSuffstatSource` ([src/bartcore/chain.hpp:379-382](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L379-L382)); add a
runtime `std::size_t blockSize` per Forest (next to `numTrees`, [src/bartcore/chain.hpp:261](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L261)),
...
([src/bartcore/chain.hpp:771](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L771)) becomes a block loop over `ceil(numTrees / blockSize)` blocks,
...
(`aCacheBypass = true`, `trackAtomOf = false`, [src/bartcore/chain.hpp:754-755](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L754-L755), and the inert
S carry note [src/bartcore/chain.hpp:821-825](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L821-L825)) becomes conditional on blockSize: OFF at
...
buffer exists ([src/bartcore/atoms.hpp:53-56](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L53-L56), 74-75). b>1 needs the owned atom-ordered buffer:
...
- `atomOf` (obs -> atom, [src/bartcore/atoms.hpp:61](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L61), `trackAtomOf`): the move bookkeeping that
  lets a split/merge find an observation's atom in O(1). Required at b>1.
- the cross-sweep A cache ([src/bartcore/atoms.hpp:98-142](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L98-L142), `aCacheBypass`): at b>1 the joint
...
- the S carry ([src/bartcore/atoms.hpp:72](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L72), `setInBlockFits`): S(c) = sum over block trees of
...
generalizes the landed b=1 kernels: splitAtom ([src/bartcore/atoms.hpp:479-565](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L479-L565)), mergeAtoms
...
leafTuple SoA ([src/bartcore/atoms.hpp:66](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L66)) widens from one int per atom to b ints per atom.
The atom member partition still reuses the tree's OWN partitionChildren over the
owned buffer (design 5.2, [src/bartcore/atoms.hpp:497](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L497), 772); no second partitioner is forked.
...
- O_i = F_i - sum_{t in block} treeFits[t*n + i], where F is the running
  ...
  current per block instead of rebuilt once per sweep at [src/bartcore/chain.hpp:843-851](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L843-L851)).
...
existing setTreeFitsFromParameters [src/bartcore/chain.hpp:2105](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L2105) b times). Maintain a running
...
([src/bartcore/chain.hpp:843-851](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L843-L851)) so the sigma/SSR draw ([src/bartcore/chain.hpp:865-866](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L865-L866)) and refreshLatents
([src/bartcore/chain.hpp:856](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L856)) read the residual materialized EXACTLY from treeFits (design 3.7),
...
([src/bartcore/chain.hpp:774-787](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L774-L787)) and the post-loop total rebuild ([src/bartcore/chain.hpp:843-851](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L843-L851)). The b=1
...
- SUFFSTAT (3.1, replaces the per-tree buildAggregateWrite gather): iterate the
  ...
  constant-leaf consumer reads ([src/bartcore/atoms.hpp:365-382](https://github.com/vdorie/dbarts/blob/071fa859d35c76ddbf8667f2a88430f7f7e62b6f/src/bartcore/atoms.hpp#L365-L382), writeNodeCaches). Feed the
  UNCHANGED model.hpp math: logIntegratedLikelihood ([src/bartcore/model.hpp:109-122](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/model.hpp#L109-L122)) and
  drawFromPosterior ([src/bartcore/model.hpp:128-143](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/model.hpp#L128-L143)) are byte-for-byte the same functions of
  the suffstat.
- DROP Q (fact 1.2): sumWeightedResponseSq cancels in every move ratio and is
  ...
  reads it ([src/bartcore/model.hpp:146-153](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/model.hpp#L146-L153)) but the centeredSumOfSquares term is additive over
...
- DRAW (3.2): drawFromPosteriorForNode reads the node cache, so
  sampleParametersAndSetFits ([src/bartcore/chain.hpp:2146-2206](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L2146-L2206)) is UNCHANGED -- one standard
...
misc_computeIndexedSufficientStatisticsFast ([src/misc/moments.c:334](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/misc/moments.c#L334)) is a plain mod-5 +
stride-5 loop, NOT SIMD-dispatched (only the mean/variance helpers dispatch,
[src/misc/moments.c:1330](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/misc/moments.c#L1330)+). The per-atom (A, G) already come from that scalar kernel, so
...
misc_stat_setSIMDInstructionSet ([src/misc/moments.c:1330](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/misc/moments.c#L1330)) -- scalar / SSE2 / AVX2 / NEON
...
- Add `std::size_t blockSize = 1` to Forest; the n-adaptive default rule (returns
  1 for now, so nothing changes yet). Rewrite run()'s tree loop ([src/bartcore/chain.hpp:771](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L771))
  ...
  [src/bartcore/chain.hpp:754-755](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L754-L755)) conditional on blockSize.
...
- Block-entry O/g/G/A/S seed and block-exit scatter + F update (section 3),
  ...
  ([src/bartcore/chain.hpp:774-787](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L774-L787)) and post-loop rebuild ([src/bartcore/chain.hpp:843-851](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/src/bartcore/chain.hpp#L843-L851)).
...
axis ([benchmarks/R/bench-sampler.R:67-69](https://github.com/vdorie/dbarts/blob/3137e17a563eeb5879a248ab9bc71a4101101da1/benchmarks/R/bench-sampler.R#L67-L69)), and the current speed baseline
