...
- No-ops: R/dbarts.R:1012-1018; callers all internal
  (R/bart.R:469,491,494,634,656,659; R/partialDependence.R:17,208,439;
  R/rbart.R:762,826). No revdep dependency - dbarts controls both ends.
...
- Offset sync: testUsesRegularOffset flips implicitly - construction
  sets it (R/data.R:175-254), setOffset re-propagates when TRUE
  (R/bartcore.R:175-240), any explicit setTestOffset/
  setTestPredictorAndOffset breaks the link (R/dbarts.R:662-745).
