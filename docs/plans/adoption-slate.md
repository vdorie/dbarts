...
was discharged: `extract.bart` ([R/generics.R:211](https://github.com/vdorie/dbarts/blob/70b30c18a8a8e1c3568d59ca327f5b9e04fdde23/R/generics.R#L211)) reads `object$yhat.train` /
...
([R/generics.R:1449](https://github.com/vdorie/dbarts/blob/70b30c18a8a8e1c3568d59ca327f5b9e04fdde23/R/generics.R#L1449)) takes `type = "predictors"` only and returns the design
...
- The identity helper cannot hold the expectations: `tinytest::expect_*` is
  ...
  `tinytest::expect_identical` in [inst/tinytest/test-mutate-sparse-valued.R:48](https://github.com/vdorie/dbarts/blob/70b30c18a8a8e1c3568d59ca327f5b9e04fdde23/inst/tinytest/test-mutate-sparse-valued.R#L48) is
...
- (4) Drop both guards so a gaussian run writes through the unallocated
  ...
  "runtime error: store to null pointer of type 'double'" at [src/bartcore/chain.hpp:5054](https://github.com/vdorie/dbarts/blob/70b30c18a8a8e1c3568d59ca327f5b9e04fdde23/src/bartcore/chain.hpp#L5054) -
