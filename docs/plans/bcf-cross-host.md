...
Spec: docs/plans/prerc-surface-freeze.md D7 ([docs/plans/prerc-surface-freeze.md:72-80](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/docs/plans/prerc-surface-freeze.md#L72-L80)) and its Sequencing
line ([docs/plans/prerc-surface-freeze.md:100](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/docs/plans/prerc-surface-freeze.md#L100)). TODO `bcf-baseline-cross-host` ([TODO:33-34](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/TODO#L33-L34)), which absorbs
the cross-host half of `equivalence-harness-statistical-mode`
([TODO:66-73](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/TODO#L66-L73)). D7 is the last open pre-RC item (`rc-gate`, [TODO:188](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/TODO#L188)).
...
`recordChannels` ([benchmarks/R/bcf-equivalence.R:412-424](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L412-L424)) writes seven
channels plus a derived `summaries`; five scenarios append a verdict at
the call sites ([benchmarks/R/bcf-equivalence.R:291](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L291), [benchmarks/R/bcf-equivalence.R:312](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L312), [benchmarks/R/bcf-equivalence.R:338](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L338), [benchmarks/R/bcf-equivalence.R:369](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L369), [benchmarks/R/bcf-equivalence.R:392](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L392)). Nine names in all. Shapes
and storage modes below are the recorded file's, not inferred:

| channel | shape | type | source | draws axis | kind |
| --- | --- | --- | --- | --- | --- |
| `mu` | 200 x 1 | double | `bartcoreForestFits(bc, 0)` [benchmarks/R/bcf-equivalence.R:414](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L414) | no | continuous |
| `tau` | 200 x 1 | double | `bartcoreForestFits(bc, 1)` [benchmarks/R/bcf-equivalence.R:415](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L415) | no | continuous |
| `glue` | 3 x 1 | double | `bartcoreForestAmplitudes` [benchmarks/R/bcf-equivalence.R:416](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L416) | no | continuous |
| `sigma` | 40 | double | `result$sigma` [benchmarks/R/bcf-equivalence.R:417](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L417) | YES | continuous |
| `train` | 200 x 40 | double | `result$train` [benchmarks/R/bcf-equivalence.R:418](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L418) | YES | continuous |
| `varcount` | 4 x 2 x 40 | integer | `result$varcount` [benchmarks/R/bcf-equivalence.R:419](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L419) | YES | combinatorial |
| `varcount.tau` | 4 x 1 | integer | `bartcoreForestVariableCounts(bc, 1)` [benchmarks/R/bcf-equivalence.R:420](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L420) | no | combinatorial |
...
Draws-axis (gated) is exactly `statChannels` ([benchmarks/R/bcf-equivalence.R:113](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L113)): `sigma`, `train`,
...
([benchmarks/R/bcf-equivalence.R:89-97](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L89-L97)) builds `y` through `sin(pi * x[, 1])`, and `sin` is platform
...
- `forestFits` is NOT a channel of this harness. It is
  multinomial-equivalence.R's name for the same quantity ([benchmarks/R/bcf-equivalence.R:119-122](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L119-L122)); bcf
  records the two forests separately as `mu` and `tau` ([benchmarks/R/bcf-equivalence.R:130-131](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/bcf-equivalence.R#L130-L131)). Drop
...
- `varcount` is DRAWS-axis, 4 x 2 x 40, in `statChannels` since the
  ...
  forests' tree structure ([benchmarks/R/bcf-equivalence.R:20-24](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/bcf-equivalence.R#L20-L24)). The intended name is `varcount.tau`,
  the 4 x 1 cumulative final-state query at [benchmarks/R/bcf-equivalence.R:136](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/bcf-equivalence.R#L136) - which the TODO's own
  garbled parenthesis ([TODO:84](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/TODO#L84) pre-collapse) listed on both sides of its
...
([benchmarks/R/equivalence.R:34-35](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/equivalence.R#L34-L35)). Parsed position-independently and
...
passed the flag. Landed as `compareCrossHost` ([benchmarks/R/equivalence.R:224-226](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/equivalence.R#L224-L226)), called from the
compare loop only when `crossHost` is set ([benchmarks/R/equivalence.R:793](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/equivalence.R#L793)):
...
equivalence.R's z is over 20 INDEPENDENT SEEDS ([benchmarks/R/equivalence.R:1433](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/equivalence.R#L1433):
`colMeans` of a seeds x summaries matrix). bcf's `drawSummary`
([benchmarks/R/equivalence.R:118-123](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/equivalence.R#L118-L123)) reduces over 40 AUTOCORRELATED draws of a single chain, and
`n` in the Welch denominator ([benchmarks/R/equivalence.R:514](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/benchmarks/R/equivalence.R#L514)) is that 40. Measured on the recorded
...
structure, changes `settingsList()` ([benchmarks/R/equivalence.R:424-434](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L424-L434)), invalidates every
existing bcf and multinomial baseline through the settings guard
([benchmarks/R/equivalence.R:458-472](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L458-L472)), and multiplies runtime by the seed count. Additive by rule,
...
-Inf and `n.fail` is 0 ([benchmarks/R/equivalence.R:519-528](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L519-L528)), so the run prints `max |z| = -Inf` and
exits 0. Today `mu`/`tau` catch that through `pointMismatch` ([benchmarks/R/equivalence.R:548-555](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L548-L555));
...
The bitwise-clean branch at [benchmarks/R/equivalence.R:492-496](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L492-L496) prints `identical (all %d channels:
...
`lapply(ch[statChannels], drawSummary)` ([benchmarks/R/equivalence.R:138](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L138)) - for each of `sigma`,
...
are derivable element for element. The loud degrade at [benchmarks/R/equivalence.R:503-510](https://github.com/vdorie/dbarts/blob/3ee6f23ecbfa0a5f677a3d2629227a6d53ca71be/benchmarks/R/equivalence.R#L503-L510)
...
standing same-host gate, which is bitwise 12/12 and returns at [benchmarks/R/equivalence.R:490-497](https://github.com/vdorie/dbarts/blob/3ee6f23ecbfa0a5f677a3d2629227a6d53ca71be/benchmarks/R/equivalence.R#L490-L497)
...
[src/bartcore/combiner.hpp:334-335](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/bartcore/combiner.hpp#L334-L335) (`bPriorVariance`, `sdModerate`) are DEAD on the R
path. `expandForestSpecs` returns early when `spec.forests` is non-empty
([src/bartcore/combiner.hpp:362](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/bartcore/combiner.hpp#L362)), and the bridge fills it unconditionally
([src/R_interface_bartcore.cpp:2157](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/R_interface_bartcore.cpp#L2157)), reading the live values out of the
R-side vector instead: `forest.nodeScaleFactor = params[3]` ([src/R_interface_bartcore.cpp:2174](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/R_interface_bartcore.cpp#L2174)) and
`amplitudePriorVariance = params[5]` ([src/R_interface_bartcore.cpp:2175](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/R_interface_bartcore.cpp#L2175)), fed by
`sd.moderate`/`b.prior.variance` at [R/bartcore.R:787-788](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/R/bartcore.R#L787-L788). Mutating the
header defaults changes nothing any scenario runs.

- D-1', ZERO-RNG, on a gated channel's own write path.
  [src/bartcore/chain.hpp:5290-5291](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/bartcore/chain.hpp#L5290-L5291), inside `storeSample`'s
  ...
  (leaving the offset add at [src/bartcore/chain.hpp:5294](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/bartcore/chain.hpp#L5294) in place; `totalFits` is the same
  array `results.forestFits` copies at [src/bartcore/chain.hpp:5351-5355](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/bartcore/chain.hpp#L5351-L5355)). Consumes no RNG,
...
- D-2, FLAG IS LOAD-BEARING. The same mutated build, cross-host, WITHOUT
  ...
  statistical fallback) <- FAIL` ([src/bartcore/chain.hpp:551-555](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/bartcore/chain.hpp#L551-L555)) on every scenario - the ULP
...
- D-4, STREAM-PERTURBING. [src/R_interface_bartcore.cpp:2174](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/src/R_interface_bartcore.cpp#L2174), scoped to
  the treatment forest: `forest.nodeScaleFactor = (f == 1 ? 1.2 : 1.0) *
  params[3];` (equivalently `sd.moderate = 1.2` at [R/bartcore.R:748](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/R/bartcore.R#L748)).
...
carries `bcf-equivalence` ([R/bartcore.R:64-89](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/R/bartcore.R#L64-L89)) and `multinomial-equivalence`
([R/bartcore.R:91-116](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/R/bartcore.R#L91-L116)) jobs on `ubuntu-latest`, i.e. x86_64 Linux, against
...
([R/bartcore.R:28-35](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/R/bartcore.R#L28-L35)), does not ignore `benchmarks/**`, and a push run executes the
...
- `exact-gates.yaml`: one step after the gates loop running
  ...
  guard ([R/bartcore.R:458-472](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/R/bartcore.R#L458-L472)) refuses to compare against a quick run. Cost:
...
- `equivalence.yaml`: add `--cross-host` at [.github/workflows/equivalence.yaml:88-89](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/.github/workflows/equivalence.yaml#L88-L89) and [.github/workflows/equivalence.yaml:115-116](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/.github/workflows/equivalence.yaml#L115-L116). Zero
...
1. `--cross-host` is `setdiff`ed off `args` before `mode` is read
   ([benchmarks/R/equivalence.R:34-35](https://github.com/vdorie/dbarts/blob/736bfb0571e06455ae8555519113c535b48946d5/benchmarks/R/equivalence.R#L34-L35) pattern). Absent, `crossHost` is FALSE and
...
6. FOUR-PLACE OBLIGATION, one commit (the 9a20bb4a precedent, which
   ...
   - `.github/workflows/equivalence.yaml`[benchmarks/R/equivalence.R:89](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/benchmarks/R/equivalence.R#L89) AND the new exact-gates step
     from section 5 - the re-record now has TWO workflow pins, not one.
   - `TODO` ledger line.
   - FORWARD-facing docs pins only: `docs/design/feature-matrix.md`[docs/design/feature-matrix.md:647](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/docs/design/feature-matrix.md#L647)
     (the `masked` scenario pin) and [f39] at [docs/design/feature-matrix.md:786-789](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/docs/design/feature-matrix.md#L786-L789). Leave the
     historical landing records that name 6e3b9fb8 as a fact about a past
     tip - `docs/design/empty-leaf-veto.md`[docs/design/empty-leaf-veto.md:329](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/docs/design/empty-leaf-veto.md#L329),
     `docs/design/multinomial-mutation-arc.md`[docs/design/multinomial-mutation-arc.md:648](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/docs/design/multinomial-mutation-arc.md#L648) and [docs/design/multinomial-mutation-arc.md:1066](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/docs/design/multinomial-mutation-arc.md#L1066) - check each
...
8. Outside the four places: `docs/plans/review-2026-08-24/gate-ledger.md`
   ...
   ([docs/plans/review-2026-08-24/gate-ledger.md:111](https://github.com/vdorie/dbarts/blob/23b9cde7b3632f649d1cfbc0f61e56a7e488a7d0/docs/plans/review-2026-08-24/gate-ledger.md#L111)) at the time this checklist was
...
Consumer impact: NONE. `benchmarks/` is `.Rbuildignore`d ([.Rbuildignore:18](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/.Rbuildignore#L18)) and ships
...
gated ([benchmarks/R/multinomial-equivalence.R:98](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/multinomial-equivalence.R#L98)), `forestFits`, `varcount`, `accepted`, `installed` exempt
([benchmarks/R/multinomial-equivalence.R:96-97](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/multinomial-equivalence.R#L96-L97) plus the call-site appends), same compare-loop shape
([benchmarks/R/multinomial-equivalence.R:595-646](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/multinomial-equivalence.R#L595-L646)), and its baseline already carries `summaries`. `equivalence.R`
needs NOTHING: its scenarios record a single seeds x summaries matrix and
its verdicts ride into that matrix (`recordVerdict`, [benchmarks/R/equivalence.R:1057-1058](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/equivalence.R#L1057-L1058), [benchmarks/R/equivalence.R:1665](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/equivalence.R#L1665)),
...
- [benchmarks/README.md:55-56](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/README.md#L55-L56) says "Baselines are RNG- and
  ...
  extend the [benchmarks/README.md:59-66](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/README.md#L59-L66) statistical paragraph with the tier-2 weakness in one
  sentence.
- The Welch z at [benchmarks/R/bcf-equivalence.R:508-513](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/bcf-equivalence.R#L508-L513) (and
  [benchmarks/R/multinomial-equivalence.R:600-605](https://github.com/vdorie/dbarts/blob/5a3bc276693514ca8e59956e5d174df58d11aa49/benchmarks/R/multinomial-equivalence.R#L600-L605)) does `sa$mean - sb$mean` with no
...
- `TODO`: close `equivalence-harness-statistical-mode` ([TODO:308](https://github.com/vdorie/dbarts/blob/a16d703c50f149b93047e399ec3a009568957ce4/TODO#L308)) at this
  landing - both REMAINING clauses are discharged - and reduce
  `bcf-baseline-cross-host` ([TODO:33-34](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/TODO#L33-L34)) to the RC-tip re-record. `rc-gate`
  ([TODO:188](https://github.com/vdorie/dbarts/blob/cbb1cb974b495bab6fbf7f4c2b67ac5e76d8b07f/TODO#L188)) follows.
...
Discrimination probes, all run on the box. D-1' ([src/bartcore/chain.hpp:5291](https://github.com/vdorie/dbarts/blob/2518a0b5d4e44675efcb965c9c5caf9904c659ea/src/bartcore/chain.hpp#L5291), a
...
([src/R_interface_bartcore.cpp:2174](https://github.com/vdorie/dbarts/blob/2518a0b5d4e44675efcb965c9c5caf9904c659ea/src/R_interface_bartcore.cpp#L2174), `sdModerate` x1.2 scoped to forest 1)
...
shift and [docs/plans/review-2026-08-24/gate-ledger.md:111](https://github.com/vdorie/dbarts/blob/2518a0b5d4e44675efcb965c9c5caf9904c659ea/docs/plans/review-2026-08-24/gate-ledger.md#L111). Door: a seeds-axis re-record,
post-RC.
