...
`docs/plans/bcf-bartcause-relocation.md`:1252-1258, "whether `bart2` reaches a
...
N4. Re-litigating `docs/plans/interface-review.md`'s T1-T11.
...
- **`test`: REFUSED by name, decided by measurement, not open.** MEASURED(r3
  ...
  `docs/plans/bcf-bartcause-relocation.md`:1274-1276 records as "A test
...
(`docs/plans/bcf-bartcause-relocation.md`:1271-1273), which this arc does not
