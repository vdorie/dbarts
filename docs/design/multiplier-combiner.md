...
`ForestSpec::amplitudePriorScale` (src/R_interface_bartcore.cpp:2203) and
derives `forest.ridge = forest.amplitudePriorScale > 0.0` (:2204). So every
...
`forest.ridge = false` (R_interface_bartcore.cpp:2189) - forests 2..K are
...
src/R_interface_bartcore.cpp:4011-4014).
