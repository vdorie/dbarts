...
`ForestSpec::amplitudePriorScale` (src/R_interface_bartcore.cpp:2210) and
derives `forest.ridge = forest.amplitudePriorScale > 0.0` (:2212). So every
...
`forest.ridge = false` (R_interface_bartcore.cpp:2212) - forests 2..K are
...
src/R_interface_bartcore.cpp:4025-4027).
