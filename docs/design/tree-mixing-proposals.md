...
| outer composition, arbitrary block, user-driven | `dbartsSampler$setOffset` (`R/dbarts.R:1316`), and `dbarts_sampler_setOffset` in the shipped C API (`dbarts.h:744`) | shipped, supported |
