...
- Chain holds exactly one `response_` and one `sigma_`. Heteroscedastic's
  ...
  ([`Chain::varianceForest_`](../../src/bartcore/chain.hpp)) rather than through a combiner at all. The Chain
...
- `ChainStateData`'s glue fields were BCF-shaped (a/aVariance/b0/b1). RESOLVED
  ...
  2)` both carrying four amplitudes ([`ChainStateData::amplitudeWidths`](../../src/bartcore/combiner.hpp), [`ChainStateData::amplitudes`](../../src/bartcore/combiner.hpp)) - and the four named
  scalars survive only as a hand-written K = 2 reading, non-authoritative
  ([`ChainStateData::a`](../../src/bartcore/combiner.hpp), [`ChainStateData::aVariance`](../../src/bartcore/combiner.hpp), [`ChainStateData::b0`](../../src/bartcore/combiner.hpp), [`ChainStateData::b1`](../../src/bartcore/combiner.hpp)). The bullet's CONCLUSION is what the arc vindicated and it stands:
  ...
  ([`ForestCombiner::glueIsValid`](../../src/bartcore/combiner.hpp), [`AmplitudeForestCombiner::glueIsValid`](../../src/bartcore/combiner.hpp)),
  the layout check `stateIsValid`
  ([`Chain::stateIsValid`](../../src/bartcore/chain.hpp)) routes
...
width: `setForestBasis` ([`AmplitudeForestCombiner::setForestBasis`](../../src/bartcore/combiner.hpp)), the amplitude trio
`totalAmplitudes`/`numForestAmplitudes`/`amplitudes`
([`ForestCombiner::totalAmplitudes`](../../src/bartcore/combiner.hpp), [`ForestCombiner::numForestAmplitudes`](../../src/bartcore/combiner.hpp), [`ForestCombiner::amplitudes`](../../src/bartcore/combiner.hpp)), and a ragged
glue wire block ([`ForestCombiner::serializeGlue`](../../src/bartcore/combiner.hpp), [`ForestCombiner::restoreGlue`](../../src/bartcore/combiner.hpp), [`ForestCombiner::glueIsValid`](../../src/bartcore/combiner.hpp)). The math is docs/design/multiplier-combiner.md's
...
`glueIsValid` ([`ForestCombiner`](../../src/bartcore/combiner.hpp)). Every one of them follows one rule, and
...
- (ii) Non-Gaussian, PARTLY. The K-forest constructor no longer hardcodes the
  ...
  `family_ = spec.family` ([`Chain::Chain`](../../src/bartcore/chain.hpp)), so a binary amplitude coupling
  is a shipped shape. What does not generalize is the rest: aft, ordinal and
  nbinom are refused at the factory ([`createAmplitudeSampler`](../../src/bartcore/facade.hpp)), each wanting a block
  ...
  ([`createAmplitudeSampler`](../../src/bartcore/facade.hpp)), so the leaf type is fixed whatever the family. That
  remainder is M4.4.
...
(S1-S4; recorded at [D1. Multi-forest transactional and per-observation predictor mutation, fixed n](model-space-survey.md#d1-multi-forest-transactional-and-per-observation-predictor-mutation-fixed-n)). Every one of
