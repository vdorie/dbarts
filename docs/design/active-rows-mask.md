...
its leaf occupancy and its fitted value ([`setActiveRows`](../../R/dbarts.R),
...
([`Chain::setActiveRows`](../../src/bartcore/chain.hpp)). It refuses when the family
...
the base
(["active-row masking is not implemented for this response family"](../../src/R_interface_bartcore.cpp)).
...
([`ResponseModel::setActiveRows`](../../src/bartcore/model.hpp)). A zeroed precision
...
([`GaussianResponse::setActiveRows`](../../src/bartcore/model.hpp)).
...
([`TResponse::setActiveRows`](../../src/bartcore/model.hpp)).

Probit carries no user weights, so the mask *is* the precision vector
([`ProbitResponse::workingWeights`](../../src/bartcore/model.hpp)). Ordinal serves it
...
([`OrdinalResponse::setActiveRows`](../../src/bartcore/model.hpp)). The cutpoint
...
full-data one ([`AFTResponse::setActiveRows`](../../src/bartcore/model.hpp)).
...
([`MultinomialResponse::supportsActiveRows`](../../src/bartcore/model.hpp),
[`MultinomialForestCombiner::setActiveRows`](../../src/bartcore/combiner.hpp)). An
inactive row's K interleaved Polya-Gamma draws are skipped
([`drawForestGlue`](../../src/bartcore/combiner.hpp)) and its composed precision is
...
([`ForestCombiner::setActiveRows`](../../src/bartcore/combiner.hpp)) and picks the mask
...
variance surface ([`formMeanWeights`](../../src/bartcore/chain.hpp)).
...
setter refuses on
([`Chain::supportsActiveRows`](../../src/bartcore/chain.hpp)), so the advertised
capability and the refusal cannot disagree, and
[`Sampler::setActiveRows`](../../src/bartcore/sampler.hpp) fans out to every chain
