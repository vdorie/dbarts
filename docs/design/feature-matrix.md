...
`equivalence-643fb617.rds` (50 scenarios), `bcf-equivalence-643fb617.rds` (12 scenarios) and
`multinomial-equivalence-643fb617.rds` (11 scenarios), all in benchmarks/baselines/MANIFEST.
