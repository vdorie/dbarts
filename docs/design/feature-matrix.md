...
Anchors are verified BY CONTENT against the tree at 52c10e02 - the cited line
...
| hurdle | Hurdle / two-part semicontinuous (R-side composition, bart.R:2304) |
...
|---|---|---|---|---|---|---|
| gaussian | S bart.R:2901 | S bart.R:694 | S dbarts.R:377 | S rbart.R:49 | S xbart.R:26 | S CAPI:678 |
| student | S bart.R:2756 | S bart.R:708 | S dbarts.R:364 | M rbart.R:56 | M xbart.R:2-33 | S RIB:2549-2557 [f2] |
| probit | S bart.Rd:82 | S bart.R:695 | S dbarts.R:378 | S data.R:675 | S xbart.R:26 | S CAPI:676 |
...
| aft | S bart.R:2759 [f1] [f5] | S bart.R:697 | S dbarts.R:380 | S rbart.R:49 | M xbart.R:26 | S CAPI:679 |
...
| bcf | - [f1] | S R/formulaTerms.R (ingestFormulaTerms) [f7] | S dbarts.R:370 | R rbart.R:56 | M | S CAPI:699-721 |
...
RIB:2266, called from both creation routes at RIB:2319 and RIB:3229) and at
...
|---|---|---|---|---|---|---|---|
| gaussian | S MOD:2815 | S MOD:2895 | S MOD:2895 | S RIB:5119, 5270 | S MOD:2864 | S RIB:4693 | S RIB:4788, 4854 |
| student | S MOD:4110 | S MOD:4117 | S MOD:4117 | S RIB:5119 | S MOD:4134 | S RIB:4693 | S RIB:4788 |
| probit | S MOD:3110 | S MOD:3116 | - [f9] | S RIB:5119 | R RIB:2791 | R RIB:2928 | S RIB:4788 |
| logistic | S MOD:3585 | S MOD:3608 | - [f9] | S RIB:5119 | S MOD:3600 [f10] | R RIB:2928 | S RIB:4788 |
| ordinal | S MOD:3247 | S MOD:3255 | - [f9] | S RIB:5119 | R RIB:2791 | R RIB:2928 | S RIB:4788 |
| nbinom | S MOD:4405 | S MOD:4412 | - [f9] | S RIB:5119 | R RIB:2791 | R RIB:2928 | S RIB:4788 |
| multinom | - dbarts.R:1371 [f11] | - [f11] | - [f11] | - [f11] | - [f11] | - [f11] | - [f11] |
| aft | S MOD:3869 | S MOD:3882 | S MOD:3882 | S RIB:5119 | R RIB:2791 | S RIB:4693 | S RIB:4788 |
| hazard | S MOD:3110 [f6] | S MOD:3116 | - [f9] | S RIB:5119 | R RIB:2791 | R RIB:2928 | S RIB:4788 |
| hurdle | - [f12] | - [f12] | - [f12] | - [f12] | - [f12] | - [f12] | - [f12] |
| bcf | S CH:1068 [f48] | S CH:1068 [f48] | R bartcore.R:407, 428 [f48] | S RIB:5119, 5270 | S RIB:4935 [f48] | S RIB:4693 [f48] | R RIB:2890 [f49] |
| grouped | S MOD:4788 [f13] | S MOD:4799 | R RIB:2737 [f13] | S RIB:5119 | S MOD:4818 [f14] | S RIB:4693 [f14] | S RIB:4788 |
| hetero | S RIB:2706 | S RIB:2706 | R RIB:2706 | S RIB:5119, 5270 | S RIB:4935 | R RIB:2928 | S RIB:4788 |

`setData` (whole-data replacement, n free) is single-forest and dense-store
only (RIB:4704-4705) and is refused for grouped (RIB:4706) and aft (RIB:4699);
...
|---|---|---|---|---|---|
| gaussian | S sampler.Rd:177, MOD:2790 [f17] | S MOD:2875 | - RIB:6173 [f18] | S generics.R:72 | S dbarts.R:1793, 1753 [f16] |
| student | S MOD:4090-4097 [f17] | S MOD:4145 | S MOD:4157 | S generics.R:118 [f19] | S dbarts.R:1793, 1753 [f16] |
| probit | R RIB:2763 | S MOD:3100 | S MOD:3136 | S generics.R:127 | S dbarts.R:1793, 1753 [f16] |
| logistic | R RIB:2767 [f20] | S MOD:3570 | S MOD:3628 | S generics.R:127 | S dbarts.R:1793, 1753 [f16] |
| ordinal | R RIB:2540 | S MOD:3232 | S MOD:3277 | S generics.R:1425 | S dbarts.R:1793, 1753 [f16] |
| nbinom | R RIB:2546 | S MOD:4385 | S MOD:4438 | S generics.R:1741 | S dbarts.R:1793, 1753 [f16] |
| multinom | R RIB:3298 | S COM:1686 [f21] | M MOD:3716 [f22] | S generics.R:1096 | R [f23] |
| aft | R RIB:2536 | S MOD:3851 | S MOD:3912 | S generics.R:132 | S dbarts.R:1793, 1753 [f16] |
| hazard | R RIB:2759 [f6] | S MOD:3100 [f6] | S MOD:3136 | S generics.R:127 [f24] | S dbarts.R:1793, 1753 [f6] |
| hurdle | R bart.R:1155 | - [f12] | - [f12] | S generics.R:2300 [f25] | - [f12] |
| bcf | S COM:841, 887-891 [f17] [f48] | S MOD:2875, CH:4040 [f26] | S CH:1714 [f18] | M generics.R:72 | R [f23] |
| grouped | S MOD:4668-4690 | S MOD:4832 [f27] | S MOD:4841 | S generics.R:2802 | S MOD:4863 [f27] |
...
| nbinom | R spec.R:509 | M RIB:3069 [f31] | S CH:585 | R bart.R:631 | R bart.R:631 |
| multinom | R bart.R:906 | M RIB:1906 [f32] | R bart.R:902 [f33] | R bart.R:631 | R bart.R:631 |
...
| hurdle | R spec.R:509 [f34] | M | S bart.R:2346, 2355 [f35] | R bart.R:631 | R bart.R:631 |
| bcf | R FAC:874 [f48] | R RIB:2342 | R spec.R:651-652 | S SAM:1029 [f36] | S CH:1990 [f36] |
...
shared `refuseBartRedirectedFamily`/`bartRedirectedFamilies` (bart.R:2699,
2686, called from `bart()` at bart.R:2768): four bart2-own-class tokens -
...
attribute on the model SEXP (RIB:2549-2557, gaussian-only gate) and refused for
...
(RIB:462), nbinom `bartcore.dispersion` (RIB:476), grouped `bartcore.groups`
(RIB:1909), heteroscedastic `bartcore.variance` (RIB:1999). The header's
`family` documentation (CAPI:744-754, on `dbarts_sampler_create`; NOT
...
same public dispatch every family uses, `bartcore_create` (RIB:3541), whose
multinomial arm is `createMultinomialDataHolder` (RIB:3507); the dedicated
...
(`enforceBinaryWeightPolicy` RIB:2759) holds on every mutation conduit too, and
...
dbarts.R:449 and `bart2Hurdle` (bart.R:2304) composes two ordinary `bart2()`
fits - an occupancy probit (bart.R:2346) and a lognormal positive part
(bart.R:2355) - glued at report time. The channel questions resolve on the
...
the same call (C_interface.cpp:614, 636). setData stays refused.
...
`$setActiveRows` (dbarts.R:1398) and the bridge entry (RIB:4074). S2 landed at
...
per-observation channel, `bartcore_setForestWeights` (RIB:4034-4037) - see
[f21] for the full statement. The bridge's active-row refusal (RIB:4084) no
...
(`inst/tinytest/test-capi.R:1401-1446` pins a genuine mask, an all-ones
...
`dbartsSampler$getCalibration`/`$setCalibration` dbarts.R:1793, 1753; bridge
...
below zero and warns that zeros are ignored; bridge RIB:4955). The conditionals
...
channel, `bartcore_setForestWeights` (RIB:4034-4037), naming the model reason
...
`dbartsSpec()`'s BCF composition (spec.R:670, the `"a named 'prior.scale'"`
entry of the `unsupported` vector; the non-default-`k` entry sits at
spec.R:658), the engine's own
BCF-composition gate (`refuseUnsupportedAmplitudeComposition`, RIB:2316), and
the multinomial forest builder (`buildMultinomialSampler`, RIB:3333). S2
...
(RIB:4272) - is what the unexported `dbarts:::bartcoreSetForestPriorScale`
...
supports `extract(type = "loglik")` directly: `hurdleLogLik` (generics.R:2344)
...
(generics.R:2300). This is NOT the sum of the two components' own loglik
...
than unbuilt: `setForestWeights` (RIB:4022) already expresses it - though note
...
RIB:4205, `bartcore_setCalibration` RIB:4260), not by a hetero-specific gate.
...
replaces row by row"), with a `createHolder` backstop (RIB:3081) closing the
...
[f32] No surface at all: `applyGroupAttribute` (RIB:1906) is called from exactly
one site, RIB:3058, on the single-forest holder path, so `bartcore.groups` is
...
(RIB:3333-3400) copies only power/base/proposal-probability fields, so a DART
...
(bart.R:902), matching BCF's own named refusal (spec.R:652,
...
(bart.R:2346, 2355), so a user's `variance =` is forwarded to BOTH - including
...
mechanism above and the Rd text, at bart2.Rd:284 and dbarts.Rd:111.

[f35] `dart` is forwarded to both components (bart.R:2346, 2355), each of
...
RIB:2266, `createAmplitudeSampler` FAC:868-889 - the last sitting directly
...
(`refuseBinaryWeightChange` RIB:2791, `refusePinnedSigmaChange` RIB:2928). The
shared `enforceBinaryWeightPolicy` (RIB:2759) refuses a probit weight outright
...
the bridge's `refuseMultiForestResponseMutation` (RIB:2647) keys on `numForests
...
replay (`bartcore_predictPerForest` RIB:5938,
...
refused through `refuseUndefinedTestFits` (RIB:2890) because the blend
...
**ordinal.** No `xbart()` or `rbart_vi()` reach (both refused at data.R:631 as
unsupported response shapes). Grouped ordinal is a recorded unbuilt door
(RIB:3064). `warm.start` and `n.grow.sweeps` unbuilt for the arc (bart.R:631).
...
Pointwise loglik (`ordinalLogLik`, generics.R:1488) is no longer a gap - built,
though untested beyond the shape checks in test-ordinal.R.

**nbinom.** As ordinal, plus: no `bart()` token, no `xbart()` token, no
`rbart_vi()` token. Grouped nbinom a recorded unbuilt door (RIB:3069). Header
...
(`negbinLogLik`, generics.R:1778) is no longer a gap.
...
loglik (`multinomialLogLik`, generics.R:1131) is no longer a gap - it scores
...
generics.R:2344) is no longer a gap.
