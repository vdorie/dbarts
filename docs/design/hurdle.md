...
- Combined prediction / reporting / state serialization. Pure packaging convenience,
  ...
  [`packageMultinomialResults`](../../R/bart.R), [`packageNegbinResults`](../../R/bart.R)). The engine route would instead DOUBLE the state wire format
...
- **Reuses the heteroscedastic nullable-second-object precedent as far as it goes.** A
  ...
  [`varianceForest_`](../../src/bartcore/chain.hpp)), null off hurdle so the single-forest path is byte-neutral by
...
- **The fit object + generics.** A dedicated class `bartHurdle` (the bartMultinomial /
  bartNegbin idiom, [`packageMultinomialResults`](../../R/bart.R), [`packageNegbinResults`](../../R/bart.R)) holding the two component fits (or their packaged
