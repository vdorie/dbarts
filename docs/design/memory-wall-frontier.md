...
[`rollTreeResidual`](../../src/bartcore/chain.hpp), [`finalizeTotalFits`](../../src/bartcore/chain.hpp)). What survives as the latency-bound hotspot is now a SINGLE shape:
the random suffstat GATHER treeY[indices[k]] over each tree's shuffled per-tree
index buffer ([`misc_computeIndexedSufficientStatisticsFast`](../../src/misc/moments.c);
[`computeLeafStats`](../../src/bartcore/tree.hpp); plus the two move-phase child-suffstat gathers). The docs' old
...
- uint8/uint16 compacted leafOf (systems lens): shallow trees rarely exceed 255
  ...
  that doc.)
- Software prefetch the surviving shuffled gathers ([`misc_computeIndexedSufficientStatisticsFast`](../../src/misc/moments.c)):
  ...
  Falsifier: sweep D.
- Wider gather MLP ([`misc_computeIndexedSufficientStatisticsFast`](../../src/misc/moments.c)): 8-10-wide unroll + 2-4 accumulator banks to
