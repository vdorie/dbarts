...
/// window (0.57, 0.54, 0.49 at widths 1, 2, 4 for n = 500; 0.47, 0.43, 0.39
/// at n = 2000) and nothing is bought back - per-point effective sample size
/// falls with width at n = 500 and is unordered at n = 2000. Nothing breaks
