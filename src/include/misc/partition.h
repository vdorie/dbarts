...
// pointer yet.
misc_size_t misc_partitionIndicesSparse(const uint64_t* restrict bits, const uint32_t* restrict wordRanks, const misc_xint_t* restrict nzCodes, misc_xint_t zeroCode, misc_xint_t cut, misc_index_t* restrict indices, misc_size_t length);
