...
#define DEF_FUNC(_N_, _F_, _A_) { _N_, std::bit_cast<DL_FUNC>(&_F_), _A_ }
  ...
  static R_CallMethodDef R_callMethods[] = {
    ...
    DEF_FUNC("dbarts_updatePredictorInPlace", updatePredictorInPlace, 3),
    DEF_FUNC("dbarts_updatePredictorPerObservationJointly", updatePredictorPerObservationJointly, 3),
...
#define DEF_FUNC(_N_, _F_) { _N_, std::bit_cast<DL_FUNC>(&_F_) }
  ...
  static C_CallMethodDef C_callMethods[] = {
    ...
    DEF_FUNC("updatePredictorInPlace", dbarts_updatePredictorInPlace),
    DEF_FUNC("updatePredictorPerObservationJointly", dbarts_updatePredictorPerObservationJointly),
