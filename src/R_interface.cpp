...
bool compareExternalPointers(const SEXP& lhs, const SEXP& rhs) {
  return R_ExternalPtrAddr(const_cast<SEXP>(lhs)) <
         R_ExternalPtrAddr(const_cast<SEXP>(rhs));
}
...
static SEXP finalize(void) {
  ...
  pthread_mutex_lock(&fitMutex);
#endif
  for (PointerSet::iterator it = activeFits->begin();
       it != activeFits->end();) {
    SEXP fitExpr = *it;
    BARTFit* fit = static_cast<BARTFit*>(R_ExternalPtrAddr(fitExpr));
#ifdef THREAD_SAFE_UNLOAD
...
namespace {
  ...
  static SEXP getXAddress(SEXP obj)
  {
    ...
    if (fit == NULL) Rf_error("dbarts_getXAddress called on NULL external
pointer");
...
/*  void R_unload_dbarts(DllInfo* info)
  ...
  ) { BARTFit* fit = *it; deleteFit(fit); PointerSet::iterator prev = it;
      ++it;
      activeFits->erase(prev);
    }
    pthread_mutex_unlock(&fitMutex);
...
static R_CallMethodDef R_callMethods[] = {
  ...
  DEF_FUNC("dbarts_getTrees", getTrees, 6),
  ...
  DEF_FUNC(
    "dbarts_updatePredictorPerObservation",
    updatePredictorPerObservation,
    3
  ),
  DEF_FUNC(
    "dbarts_updatePredictorPerObservationJointly",
...
static C_CallMethodDef C_callMethods[] = {
  ...
  DEF_FUNC(
    "initializeCGMPriorFromOptions",
    dbarts_initializeCGMPriorFromOptions
  ),
  ...
  DEF_FUNC(
    "initializeNormalPriorFromOptions",
    dbarts_initializeNormalPriorFromOptions
  ),
  DEF_FUNC("invalidateNormalPrior", dbarts_invalidateNormalPrior),

  DEF_FUNC("createChiHyperprior", dbarts_createChiHyperprior),
  DEF_FUNC(
    "createChiHyperpriorFromOptions",
    dbarts_createChiHyperpriorFromOptions
  ),
  DEF_FUNC("destroyChiHyperprior", dbarts_destroyChiHyperprior),
  DEF_FUNC(
    "initializeChiHyperpriorFromOptions",
    dbarts_initializeChiHyperpriorFromOptions
  ),
  ...
  DEF_FUNC(
    "createFixedHyperpriorFromOptions",
    dbarts_createFixedHyperpriorFromOptions
  ),
  DEF_FUNC("destroyFixedHyperprior", dbarts_destroyFixedHyperprior),
  DEF_FUNC(
    "initializeFixedHyperpriorFromOptions",
    dbarts_initializeFixedHyperpriorFromOptions
  ),
  ...
  DEF_FUNC(
    "createChiSquaredPriorFromOptions",
    dbarts_createChiSquaredPriorFromOptions
  ),
  DEF_FUNC("destroyChiSquaredPrior", dbarts_destroyChiSquaredPrior),
  DEF_FUNC(
    "initializeChiSquaredPriorFromOptions",
    dbarts_initializeChiSquaredPriorFromOptions
  ),
  ...
  DEF_FUNC("getTreesCountingData", dbarts_getTreesCountingData),
